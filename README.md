...
* [Bit](https://github.com/teambit/bit) ⭐ 18,471 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-03 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,961 | 🐛 142 | 🌐 JavaScript | 📅 2026-09-03 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,023 | 🐛 609 | 🌐 JavaScript | 📅 2026-08-30 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,308 | 🐛 610 | 🌐 JavaScript | 📅 2026-09-02 - Next-generation ES6 module bundler.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,807 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-03 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,672 | 🐛 252 | 🌐 TypeScript | 📅 2026-09-03 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,471 | 🐛 188 | 🌐 TypeScript | 📅 2026-09-03 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,905 | 🐛 273 | 🌐 JavaScript | 📅 2026-09-03 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
...
* [Sinon.JS](https://github.com/sinonjs/sinon) ⭐ 9,757 | 🐛 61 | 🌐 JavaScript | 📅 2026-09-03 - Test spies, stubs, and mocks for JavaScript.
...
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,580 | 🐛 186 | 🌐 TypeScript | 📅 2026-09-03 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,537 | 🐛 256 | 🌐 TypeScript | 📅 2026-09-03 - Headless Chrome Node.js API by official Google Chrome team.
* [phantomjs](https://github.com/ariya/phantomjs) ⚠️ Archived - Scriptable Headless WebKit.
* [karma](https://github.com/karma-runner/karma) ⭐ 11,964 | 🐛 402 | 🌐 JavaScript | 📅 2026-06-10 - Spectacular Test Runner for JavaScript.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,835 | 🐛 292 | 🌐 TypeScript | 📅 2026-09-03 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,233 | 🐛 1,417 | 🌐 JavaScript | 📅 2026-09-03 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,304 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,496 | 🐛 135 | 🌐 JavaScript | 📅 2026-09-03 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,443 | 🐛 5 | 🌐 Rust | 📅 2026-09-03 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,655 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-03 - High-standards, strict & opinionated code quality tool, aiming to keep only good parts of the language.
...
* [vue](https://github.com/vuejs/vue) ⭐ 211,624 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,480 | 🐛 1,162 | 🌐 C++ | 📅 2026-09-03 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,005 | 🐛 1,150 | 🌐 TypeScript | 📅 2026-09-03 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 88,030 | 🐛 1,051 | 🌐 JavaScript | 📅 2026-09-03 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,807 | 🐛 333 | 🌐 JavaScript | 📅 2026-09-03 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,851 | 🐛 42 | 🌐 JavaScript | 📅 2026-09-03 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,901 | 🐛 4 | 🌐 HTML | 📅 2026-09-03 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,189 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-26 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,635 | 🐛 838 | 🌐 TypeScript | 📅 2026-09-03 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,572 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-03 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,108 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-02 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [mithril.js](https://github.com/lhorie/mithril.js) ⭐ 14,497 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13 - Mithril is a client-side MVC framework (Light-weight, Robust, Fast).
* [Blockly](https://github.com/google/blockly) ⭐ 13,547 | 🐛 381 | 🌐 JavaScript | 📅 2026-09-03 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,231 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 8,125 | 🐛 146 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
* [marionette](https://github.com/marionettejs/backbone.marionette) ⭐ 7,035 | 🐛 37 | 🌐 JavaScript | 📅 2026-08-20 - A composite application library for Backbone.js that aims to simplify the construction of large scale JavaScript applications.
* [Drawflow](https://github.com/jerosoler/Drawflow) ⭐ 6,111 | 🐛 272 | 🌐 JavaScript | 📅 2024-10-19 - This allow you to create data flows easily and quickly.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 73,064 | 🐛 550 | 🌐 TypeScript | 📅 2026-09-03 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,148 | 🐛 151 | 🌐 JavaScript | 📅 2026-09-03 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,967 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-02 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,613 | 🐛 136 | 🌐 JavaScript | 📅 2026-09-03 - CMS with content editing and essential services.
...
* [handlebars.js](https://github.com/handlebars-lang/handlebars.js) ⭐ 18,670 | 🐛 117 | 🌐 JavaScript | 📅 2026-06-24 - An extension to the Mustache templating language.
* [mustache.js](https://github.com/janl/mustache.js) ⭐ 16,722 | 🐛 122 | 🌐 JavaScript | 📅 2024-06-14 - Minimal templating with {{mustaches}} in JavaScript.
* [marko](https://github.com/marko-js/marko) ⭐ 14,411 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-03 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 115,079 | 🐛 381 | 🌐 JavaScript | 📅 2026-09-03 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,604 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,676 | 🐛 588 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,227 | 🐛 1,526 | 🌐 TypeScript | 📅 2026-09-03 - Enterprise Charts.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 26,013 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-03 - A framework for building 3D games with HTML 5 and WebGL.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,283 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,197 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-02 - A fully featured graph theory library.
...
* [two.js](https://github.com/jonobr1/two.js) ⭐ 8,654 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-01 - A renderer agnostic two-dimensional drawing api for the web.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,544 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-21 - A next-generation declarative infographic visualization engine.
...
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,107 | 🐛 77 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,369 | 🐛 47 | 🌐 JavaScript | 📅 2026-09-03 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,035 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-03 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,440 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-03 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
* [Frappe Datatable](https://github.com/frappe/datatable) ⭐ 1,332 | 🐛 62 | 🌐 JavaScript | 📅 2026-07-22 - Frappe DataTable is a simple, modern and interactive datatable library for displaying tabular data.

## Editors

* [quill](https://github.com/quilljs/quill) ⭐ 47,323 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
...
* [trix](https://github.com/basecamp/trix) ⭐ 20,006 | 🐛 185 | 🌐 JavaScript | 📅 2026-09-03 - A rich text editor for everyday writing. By Basecamp.
...
* [Summernote](https://github.com/summernote/summernote) ⭐ 11,840 | 🐛 120 | 🌐 JavaScript | 📅 2026-04-15 - Super simple WYSIWYG editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,818 | 🐛 411 | 🌐 JavaScript | 📅 2026-09-03 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,299 | 🐛 113 | 🌐 JavaScript | 📅 2026-09-03 - JavaScript PDF generation.
...
* [diff2html](https://github.com/rtfpessoa/diff2html) ⭐ 3,401 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-08 - Git diff output parser and pretty HTML generator.
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,231 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-02 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,278 | 🐛 105 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,704 | 🐛 181 | 🌐 TypeScript | 📅 2026-08-08 - A reactive programming library for JavaScript.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,664 | 🐛 1,315 | 🌐 JavaScript | 📅 2026-09-01 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 47,914 | 🐛 69 | 🌐 JavaScript | 📅 2026-09-02 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,645 | 🐛 1,005 | 🌐 TypeScript | 📅 2026-08-30 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,450 | 🐛 180 | 🌐 JavaScript | 📅 2026-08-09 - Luxon is a library for working with dates and times in JavaScript.
...
* [URI.js](https://github.com/medialize/URI.js/) ⭐ 6,230 | 🐛 104 | 🌐 JavaScript | 📅 2023-08-27 - JavaScript URL mutation library.
...
* [pouchdb](https://github.com/pouchdb/pouchdb) ⭐ 17,603 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-02 - Javascript db inspired by Apache CouchDB to run well within the browser.
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,552 | 🐛 595 | 🌐 TypeScript | 📅 2026-08-28 - Dexie.js is a wrapper library for indexedDB.
...
* [NeDB](https://github.com/louischatriot/nedb) ⭐ 13,535 | 🐛 209 | 🌐 JavaScript | 📅 2025-05-15 - Embedded Persistent database for Browsers, nw\.js, electron.
...
* [sql.js](https://github.com/kripken/sql.js) ⭐ 134 | 🐛 0 | 📅 2020-03-10 - SQLite compiled to JavaScript through Emscripten.
...
* [TinyColor](https://github.com/bgrins/TinyColor) ⭐ 5,248 | 🐛 106 | 🌐 JavaScript | 📅 2024-06-26 - Fast, small color manipulation and conversion for JavaScript.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,624 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-02 - internationalisation (i18n) with JavaScript the easy way.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,354 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-03 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,191 | 🐛 92 | 🌐 JavaScript | 📅 2026-09-03 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,257 | 🐛 155 | 🌐 TypeScript | 📅 2026-09-03 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,475 | 🐛 218 | 🌐 TypeScript | 📅 2026-09-02 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,985 | 🐛 3 | 🌐 Vue | 📅 2026-09-03 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,999 | 🐛 62 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native JavaScript code with zero dependencies.
...
* [workly](https://github.com/pshihn/workly) ⭐ 1,876 | 🐛 8 | 🌐 JavaScript | 📅 2022-07-20 - A really simple way to move a function or class to a web worker.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,990 | 🐛 97 | 🌐 JavaScript | 📅 2026-08-30 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,771 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [SpinKit](https://github.com/tobiasahlin/SpinKit) ⭐ 19,333 | 🐛 11 | 🌐 CSS | 📅 2020-08-01 - A collection of loading indicators animated with CSS.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,737 | 🐛 494 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,701 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,812 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-03 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,740 | 🐛 104 | 🌐 TypeScript | 📅 2026-09-03 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,251 | 🐛 911 | 🌐 JavaScript | 📅 2026-08-24 - A framework for easily creating beautiful presentations using HTML.
...
* [slick](https://github.com/kenwheeler/slick) ⭐ 28,547 | 🐛 1,317 | 🌐 JavaScript | 📅 2026-08-01 - The last carousel you'll ever need.
...
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,405 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-03 - An extensible low level carousel for the web, written in TypeScript.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,625 | 🐛 1,132 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,552 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-03 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [dropzone](https://github.com/enyo/dropzone) ⭐ 18,379 | 🐛 151 | 🌐 JavaScript | 📅 2026-08-30 - Dropzone is an easy to use drag'n'drop library. It supports image previews and shows nice progress bars.
...
* [SweetAlert](https://github.com/t4t5/sweetalert) ⭐ 22,259 | 🐛 199 | 🌐 TypeScript | 📅 2023-04-15 - An awesome replacement for JavaScript's alert.
...
* [Magnific-Popup](https://github.com/dimsemenov/Magnific-Popup) ⭐ 11,313 | 🐛 678 | 🌐 JavaScript | 📅 2024-06-08 - Light and responsive lightbox script with focus on performance.
...
* [lightGallery](https://github.com/sachinchoolur/lightGallery) ⭐ 7,054 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-03 - A customizable, modular, responsive, lightbox gallery plugin for jQuery.
...
* [fullPage](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,398 | 🐛 129 | 🌐 JavaScript | 📅 2026-03-17 - A simple and easy to use plugin to create fullscreen scrolling websites (also known as single page websites).
...
* [Dragula](https://github.com/bevacqua/dragula/) ⭐ 22,135 | 🐛 159 | 🌐 JavaScript | 📅 2024-06-07 - Drag and drop so simple it hurts.
* [touchemulator](https://github.com/hammerjs/touchemulator) ⭐ 406 | 🐛 17 | 🌐 JavaScript | 📅 2022-11-17 - Emulate touch input on your desktop.

## Maps

* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,564 | 🐛 567 | 🌐 JavaScript | 📅 2026-09-01 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,649 | 🐛 1,655 | 🌐 JavaScript | 📅 2026-09-03 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,520 | 🐛 164 | 🌐 C | 📅 2026-09-03 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,872 | 🐛 671 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,920 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-02 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [ractive-player](https://github.com/ysulyma/ractive-player) ⭐ 814 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-02 - A library for making interactive videos in React.js.
...
* [FitText.js](https://github.com/davatron5000/FitText.js) ⭐ 6,713 | 🐛 28 | 🌐 HTML | 📅 2020-12-02 - A jQuery plugin for inflating web type.
* [Lettering.js](https://github.com/davatron5000/Lettering.js) ⭐ 5,334 | 🐛 16 | 🌐 JavaScript | 📅 2020-07-27 - A lightweight, easy to use JavaScript `<span>` injector for radical Web Typography.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 28,212 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,199 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,973 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-02 - A new and improved version of particles.js with bug fixes and many new features.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,988 | 🐛 776 | 🌐 TypeScript | 📅 2026-09-03 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 142,073 | 🐛 3,306 | 🌐 JavaScript | 📅 2026-09-03 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,168 | 🐛 392 | 🌐 TypeScript | 📅 2026-09-03 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 62,262 | 🐛 93 | 🌐 TypeScript | 📅 2026-09-03 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,815 | 🐛 531 | 🌐 TypeScript | 📅 2026-09-03 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,940 | 🐛 441 | 🌐 JavaScript | 📅 2026-09-03 - React-based static site generator.
...
* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,159 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-03 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,502 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-03 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,594 | 🐛 2,586 | 🌐 TypeScript | 📅 2026-09-02 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,645 | 🐛 625 | 🌐 TypeScript | 📅 2026-09-03 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,670 | 🐛 1,998 | 🌐 TypeScript | 📅 2026-09-03 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,370 | 🐛 1,085 | 🌐 TypeScript | 📅 2026-09-03 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,475 | 🐛 171 | 🌐 JavaScript | 📅 2026-09-03 MongoDB object modeling designed to work in an asynchronous environment.
...
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,196 | 🐛 171 | 🌐 TypeScript | 📅 2026-08-31 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,200 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-03 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,206 | 🐛 200 | 🌐 TypeScript | 📅 2026-09-03 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
* [ws](https://github.com/websockets/ws) ⭐ 22,800 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-13 Simple to use, blazing fast and thoroughly tested WebSocket client and server for Node.js.

## Generative AI

* [KaibanJS](https://github.com/kaiban-ai/KaibanJS) ⭐ 1,472 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-15 - KaibanJS is an open-source framework browser-compatibility of orchestration of multi-agent ai systems using a Kanban-inspired architecture.
* [liter-llm](https://github.com/xberg-io/liter-llm) ⭐ 252 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - Universal LLM API client for 142+ providers with a unified interface and streaming, via a JavaScript/TypeScript binding over a Rust core.

## Misc

* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,604 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,406 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-03 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,107 | 🐛 428 | 🌐 TypeScript | 📅 2026-09-03 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,864 | 🐛 485 | 🌐 TypeScript | 📅 2026-09-03 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,796 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [Functional-Light JavaScript](https://github.com/getify/Functional-Light-JS) ⭐ 16,737 | 🐛 27 | 🌐 JavaScript | 📅 2023-12-26 - Pragmatic, balanced FP in JavaScript.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 502,656 | 🐛 105 | 📅 2026-09-02
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,478 | 🐛 90 | 📅 2026-08-20
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,454 | 🐛 25 | 📅 2026-03-23
...
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,652 | 🐛 90 | 📅 2025-07-20
