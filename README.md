...
* [Bit](https://github.com/teambit/bit) ⭐ 18,457 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-21 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [RequireJS](https://github.com/requirejs/requirejs) ⭐ 12,915 | 🐛 289 | 🌐 JavaScript | 📅 2025-11-30 - A file and module loader for JavaScript.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,971 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-21 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,021 | 🐛 601 | 🌐 JavaScript | 📅 2026-08-20 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,307 | 🐛 606 | 🌐 JavaScript | 📅 2026-08-21 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,324 | 🐛 349 | 🌐 JavaScript | 📅 2026-08-14 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,506 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-20 - TypeScript-first schema validation with built-in static type inference.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,470 | 🐛 179 | 🌐 TypeScript | 📅 2026-08-21 - Painless JavaScript Unit Testing.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,481 | 🐛 258 | 🌐 TypeScript | 📅 2026-08-21 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,903 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-21 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,958 | 🐛 334 | 🌐 JavaScript | 📅 2026-05-25 - UI automated testing framework based on node.js and selenium webdriver.
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,818 | 🐛 291 | 🌐 TypeScript | 📅 2026-08-21 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,208 | 🐛 1,422 | 🌐 JavaScript | 📅 2026-08-20 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,279 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,468 | 🐛 127 | 🌐 JavaScript | 📅 2026-08-21 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,377 | 🐛 6 | 🌐 Rust | 📅 2026-08-21 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,354 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,379 | 🐛 1,071 | 🌐 C++ | 📅 2026-08-21 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,004 | 🐛 1,164 | 🌐 TypeScript | 📅 2026-08-19 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,981 | 🐛 1,085 | 🌐 JavaScript | 📅 2026-08-21 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,811 | 🐛 410 | 🌐 JavaScript | 📅 2026-08-21 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,826 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-21 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,867 | 🐛 1 | 🌐 HTML | 📅 2026-08-19 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,151 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,618 | 🐛 835 | 🌐 TypeScript | 📅 2026-08-21 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,567 | 🐛 266 | 🌐 TypeScript | 📅 2026-08-21 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,096 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
* [Million](https://github.com/aidenybai/million) ⭐ 17,671 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-20 - <1kb compiler-focused virtual DOM. It's fast!
...
* [riot](https://github.com/riot/riot) ⭐ 14,912 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-06 - React-like library, but with very small size.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,523 | 🐛 344 | 🌐 JavaScript | 📅 2026-08-21 - A library that adds a visual code editor to web and mobile apps by Google.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 8,107 | 🐛 146 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Drawflow](https://github.com/jerosoler/Drawflow) ⭐ 6,104 | 🐛 272 | 🌐 JavaScript | 📅 2024-10-19 - This allow you to create data flows easily and quickly.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 72,990 | 🐛 535 | 🌐 TypeScript | 📅 2026-08-21 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,853 | 🐛 122 | 🌐 JavaScript | 📅 2026-08-21 - simple, powerful publishing platform.
...
* [marko](https://github.com/marko-js/marko) ⭐ 14,407 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-21 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [doT](https://github.com/olado/doT) ⭐ 5,042 | 🐛 31 | 🌐 JavaScript | 📅 2023-11-02 - The fastest + concise JavaScript template engine for nodejs and browsers.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,657 | 🐛 379 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,513 | 🐛 23 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,654 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,111 | 🐛 1,555 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,397 | 🐛 468 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,959 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-21 - A framework for building 3D games with HTML 5 and WebGL.
* [Frappe Charts](https://github.com/frappe/charts) ⭐ 15,081 | 🐛 145 | 🌐 JavaScript | 📅 2025-07-02 - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,266 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,142 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-20 - A JavaScript library dedicated to graph drawing.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,177 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-19 - A fully featured graph theory library.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,374 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-21 - A next-generation declarative infographic visualization engine.
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,090 | 🐛 76 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,354 | 🐛 45 | 🌐 JavaScript | 📅 2026-08-21 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [TimelineJS v3](https://github.com/NUKnightLab/TimelineJS3) ⭐ 3,211 | 🐛 231 | 🌐 JavaScript | 📅 2026-08-11 - A Storytelling Timeline built in JavaScript.

## Spreadsheet

* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,024 | 🐛 108 | 🌐 JavaScript | 📅 2026-08-21 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [Jspreadsheet CE](https://github.com/jspreadsheet/ce) ⭐ 7,216 | 🐛 151 | 🌐 JavaScript | 📅 2026-04-10 - Jspreadsheet is a lightweight vanilla javascript plugin to create amazing web-based interactive tables and spreadsheets compatible with other spreadsheet software.
...
* [quill](https://github.com/quilljs/quill) ⭐ 47,306 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
...
* [trix](https://github.com/basecamp/trix) ⭐ 20,002 | 🐛 185 | 🌐 JavaScript | 📅 2026-08-21 - A rich text editor for everyday writing. By Basecamp.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,276 | 🐛 412 | 🌐 TypeScript | 📅 2026-08-17 - The JavaScript Rich Text editor.
* [medium-editor](https://github.com/yabwe/medium-editor) ⭐ 16,105 | 🐛 359 | 🌐 JavaScript | 📅 2024-10-24 - Medium.com WYSIWYG editor clone.
* [jsoneditor](https://github.com/josdejong/jsoneditor) ⭐ 12,261 | 🐛 233 | 🌐 JavaScript | 📅 2026-08-15 - A web-based tool to view, edit and format JSON.
...
* [Trumbowyg](https://github.com/Alex-D/Trumbowyg) ⭐ 4,149 | 🐛 120 | 🌐 JavaScript | 📅 2026-06-20 - A lightweight and amazing WYSIWYG JavaScript editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,761 | 🐛 413 | 🌐 JavaScript | 📅 2026-08-21 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,277 | 🐛 119 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,545 | 🐛 224 | 🌐 JavaScript | 📅 2026-08-13 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,034 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-21 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,289 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
* [underscore](https://github.com/jashkenas/underscore) ⭐ 27,334 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript's utility \_ belt.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,698 | 🐛 180 | 🌐 TypeScript | 📅 2026-08-08 - A reactive programming library for JavaScript.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,041 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-17 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,664 | 🐛 1,298 | 🌐 JavaScript | 📅 2026-08-18 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 47,915 | 🐛 165 | 🌐 JavaScript | 📅 2026-08-20 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,635 | 🐛 995 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
...
* [tempo](https://github.com/formkit/tempo) ⭐ 2,588 | 🐛 13 | 🌐 TypeScript | 📅 2026-07-01 - Parsing, formatting, and timezones — Tempo is a small tree-shakable library for native Date objects.
...
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,540 | 🐛 595 | 🌐 TypeScript | 📅 2026-08-21 - Dexie.js is a wrapper library for indexedDB.
...
* [PostgreSQL Browser](https://github.com/datawan-labs/pg) ⭐ 760 | 🐛 4 | 🌐 TypeScript | 📅 2024-12-02 - Browser PostgreSQL Playground, no server, just client and pglite (postgresql wasm)
...
* [color-space](https://github.com/colorjs/color-space) ⭐ 381 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-21 - Conversions between 162 color spaces (OKLCH, CAM16, Munsell, camera logs) with cited references.
...
* [Bluebird](https://github.com/petkaantonov/bluebird/) ⭐ 20,492 | 🐛 131 | 🌐 JavaScript | 📅 2024-11-07 - fully featured promise library with focus on innovative features and performance.
...
* [speedy-router](https://github.com/anonrig/router) ⭐ 148 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-21 - The TanStack Router API rebuilt for faster navigations and SSR.

## Security

* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,321 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,197 | 🐛 75 | 🌐 JavaScript | 📅 2026-08-21 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,182 | 🐛 145 | 🌐 TypeScript | 📅 2026-08-21 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,465 | 🐛 215 | 🌐 TypeScript | 📅 2026-08-13 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,913 | 🐛 0 | 🌐 Vue | 📅 2026-08-21 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [tracking.js](https://github.com/eduardolundgren/tracking.js) ⭐ 9,466 | 🐛 227 | 🌐 JavaScript | 📅 2026-08-11 - A modern approach for Computer Vision on the web.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 163 | 🌐 Rust | 📅 2026-08-19 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,982 | 🐛 89 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,724 | 🐛 112 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
* [PrismJS](https://github.com/PrismJS/prism) ⭐ 13,035 | 🐛 483 | 🌐 JavaScript | 📅 2026-06-29 - Lightweight, robust, elegant syntax highlighting.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,737 | 🐛 476 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
* [jquery-validation](https://github.com/jzaefferer/jquery-validation) ⭐ 10,317 | 🐛 41 | 🌐 JavaScript | 📅 2026-06-29 - jQuery Validation Plugin.
* [is.js](https://github.com/arasatasaygin/is.js) ⭐ 9,069 | 🐛 47 | 🌐 JavaScript | 📅 2022-01-11 - Check types, regexps, presence, time and more.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,613 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,627 | 🐛 112 | 🌐 TypeScript | 📅 2026-08-21 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,158 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,891 | 🐛 254 | 🌐 TypeScript | 📅 2026-08-06 - Mobile touch slider and framework with hardware accelerated transitions.
* [impress.js](https://github.com/impress/impress.js) ⭐ 38,171 | 🐛 59 | 🌐 JavaScript | 📅 2026-07-23 - It's a presentation framework based on the power of CSS3 transforms and transitions in modern browsers and inspired by the idea behind prezi.com.
...
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,394 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-21 - An extensible low level carousel for the web, written in TypeScript.
...
* [Ion.RangeSlider](https://github.com/IonDen/ion.rangeSlider) ⭐ 2,546 | 🐛 139 | 🌐 JavaScript | 📅 2026-08-17 - Powerful and easily customizable range slider with many options and skin support.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,615 | 🐛 1,129 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
* [tui.calendar](https://github.com/nhn/tui.calendar) ⭐ 12,698 | 🐛 208 | 🌐 TypeScript | 📅 2024-06-24 - A JavaScript schedule calendar that is full featured. Now your service just got the customizable calendar.
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,534 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [select2](https://github.com/select2/select2) ⭐ 25,911 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-17 - a jQuery based replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results.
...
* [Slideout](https://github.com/mango/slideout) ⭐ 7,874 | 🐛 72 | 🌐 JavaScript | 📅 2020-09-20 - A responsive touch slideout navigation menu for mobile web apps.
...
* [jTable](https://github.com/hikalkan/jtable) ⭐ 1,081 | 🐛 1,504 | 🌐 JavaScript | 📅 2021-11-19 - A jQuery plugin to create AJAX based CRUD tables.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,599 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-20 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
...
* [Dragula](https://github.com/bevacqua/dragula/) ⭐ 22,138 | 🐛 159 | 🌐 JavaScript | 📅 2024-06-07 - Drag and drop so simple it hurts.
* [touchemulator](https://github.com/hammerjs/touchemulator) ⭐ 406 | 🐛 17 | 🌐 JavaScript | 📅 2022-11-17 - Emulate touch input on your desktop.

## Maps

* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,505 | 🐛 562 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,589 | 🐛 1,649 | 🌐 JavaScript | 📅 2026-08-21 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,481 | 🐛 165 | 🌐 C | 📅 2026-08-20 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,859 | 🐛 665 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,883 | 🐛 83 | 🌐 TypeScript | 📅 2026-08-20 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [Lettering.js](https://github.com/davatron5000/Lettering.js) ⭐ 5,336 | 🐛 16 | 🌐 JavaScript | 📅 2020-07-27 - A lightweight, easy to use JavaScript `<span>` injector for radical Web Typography.
...
* [particles.js](https://github.com/VincentGarreau/particles.js) ⭐ 30,206 | 🐛 367 | 🌐 JavaScript | 📅 2024-03-28 - A lightweight JavaScript library for creating particles.
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,913 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,957 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A new and improved version of particles.js with bug fixes and many new features.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,990 | 🐛 774 | 🌐 TypeScript | 📅 2026-08-16 - Turn ES6+ code into vanilla ES5 with no runtime.
* [es6features](https://github.com/lukehoban/es6features) ⭐ 29,034 | 🐛 38 | 📅 2023-01-27 - Overview of ECMAScript 6 features.
...
* [es6-features](https://github.com/rse/es6-features) ⭐ 6,157 | 🐛 33 | 🌐 HTML | 📅 2024-06-20 - ECMAScript 6: Feature Overview & Comparison.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,887 | 🐛 3,991 | 🌐 JavaScript | 📅 2026-08-21 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,034 | 🐛 407 | 🌐 TypeScript | 📅 2026-08-21 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 61,914 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-21 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,773 | 🐛 535 | 🌐 TypeScript | 📅 2026-08-21 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 423 | 🌐 JavaScript | 📅 2026-08-21 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,470 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,275 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-21 - Static site generator for Deno.

## SDK

* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,127 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-21 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,486 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-21 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,572 | 🐛 2,548 | 🌐 TypeScript | 📅 2026-08-21 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,634 | 🐛 624 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,545 | 🐛 1,968 | 🌐 TypeScript | 📅 2026-08-19 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,373 | 🐛 1,081 | 🌐 TypeScript | 📅 2026-08-16 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,472 | 🐛 175 | 🌐 JavaScript | 📅 2026-08-21 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,338 | 🐛 737 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,147 | 🐛 172 | 🌐 TypeScript | 📅 2026-08-17 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,177 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-21 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,193 | 🐛 191 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
...
* [KaibanJS](https://github.com/kaiban-ai/KaibanJS) ⭐ 1,471 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-15 - KaibanJS is an open-source framework browser-compatibility of orchestration of multi-agent ai systems using a Kanban-inspired architecture.

## Misc

* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,529 | 🐛 405 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,316 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,063 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,035 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,847 | 🐛 492 | 🌐 TypeScript | 📅 2026-08-21 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [enum-plus](https://github.com/shijistar/enum-plus) ⭐ 203 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-21 - A drop-in enhancement for native TypeScript enums, adding display text, internationalization and full type safety.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,708 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 498,546 | 🐛 105 | 📅 2026-08-21
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,354 | 🐛 82 | 📅 2026-08-20
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,428 | 🐛 21 | 📅 2026-03-23
