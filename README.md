...
* [Bit](https://github.com/teambit/bit) ⭐ 18,470 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-02 - Create, find and reuse components (React, Angular, Node etc.) across applications.

## Loaders

*Module or loading system for JavaScript.*

* [browserify](https://github.com/substack/node-browserify) ⭐ 14,699 | 🐛 380 | 🌐 JavaScript | 📅 2024-12-21 - Browser-side require() the node.js way.
...
* [SeaJS](https://github.com/seajs/seajs) ⭐ 8,257 | 🐛 157 | 🌐 JavaScript | 📅 2023-07-03 - A Module Loader for the Web.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,960 | 🐛 138 | 🌐 JavaScript | 📅 2026-09-02 - Packs CommonJs/AMD modules for the browser.
...
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,306 | 🐛 609 | 🌐 JavaScript | 📅 2026-09-02 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,329 | 🐛 355 | 🌐 JavaScript | 📅 2026-08-27 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,767 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-02 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,672 | 🐛 252 | 🌐 TypeScript | 📅 2026-09-01 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,469 | 🐛 188 | 🌐 TypeScript | 📅 2026-09-02 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,907 | 🐛 270 | 🌐 JavaScript | 📅 2026-09-02 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,827 | 🐛 73 | 🌐 JavaScript | 📅 2026-06-17 - 🚀 Futuristic JavaScript test runner
...
* [Supertest](https://github.com/visionmedia/supertest) ⭐ 14,398 | 🐛 191 | 🌐 JavaScript | 📅 2026-04-02 - A popular HTTP assertion library for testing REST APIs, often used with other testing frameworks like Mocha or Jest
* [Sinon.JS](https://github.com/sinonjs/sinon) ⭐ 9,757 | 🐛 59 | 🌐 JavaScript | 📅 2026-08-05 - Test spies, stubs, and mocks for JavaScript.
* [chai](https://github.com/chaijs/chai) ⭐ 8,270 | 🐛 92 | 🌐 JavaScript | 📅 2026-09-02 - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,537 | 🐛 261 | 🌐 TypeScript | 📅 2026-09-02 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,532 | 🐛 186 | 🌐 TypeScript | 📅 2026-09-02 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,833 | 🐛 295 | 🌐 TypeScript | 📅 2026-09-02 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,231 | 🐛 1,417 | 🌐 JavaScript | 📅 2026-09-02 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,301 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,495 | 🐛 137 | 🌐 JavaScript | 📅 2026-09-02 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,994 | 🐛 439 | 🌐 JavaScript | 📅 2026-08-31 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,440 | 🐛 4 | 🌐 Rust | 📅 2026-09-02 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,656 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-01 - High-standards, strict & opinionated code quality tool, aiming to keep only good parts of the language.
...
* [vue](https://github.com/vuejs/vue) ⭐ 211,272 | 🐛 638 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,483 | 🐛 1,155 | 🌐 C++ | 📅 2026-09-02 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,021 | 🐛 1,150 | 🌐 TypeScript | 📅 2026-09-02 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 88,042 | 🐛 1,057 | 🌐 JavaScript | 📅 2026-09-02 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,808 | 🐛 330 | 🌐 JavaScript | 📅 2026-09-02 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,850 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-02 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,900 | 🐛 3 | 🌐 HTML | 📅 2026-09-02 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,183 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-26 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,635 | 🐛 838 | 🌐 TypeScript | 📅 2026-09-02 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,570 | 🐛 264 | 🌐 TypeScript | 📅 2026-09-02 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,106 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-02 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,546 | 🐛 384 | 🌐 JavaScript | 📅 2026-09-01 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,230 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [Drawflow](https://github.com/jerosoler/Drawflow) ⭐ 6,109 | 🐛 272 | 🌐 JavaScript | 📅 2024-10-19 - This allow you to create data flows easily and quickly.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 73,061 | 🐛 540 | 🌐 TypeScript | 📅 2026-09-02 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,101 | 🐛 140 | 🌐 JavaScript | 📅 2026-09-02 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,966 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-02 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,612 | 🐛 135 | 🌐 JavaScript | 📅 2026-09-02 - CMS with content editing and essential services.
...
* [Pug](https://github.com/pugjs/pug) ⭐ 21,852 | 🐛 333 | 🌐 JavaScript | 📅 2026-03-13 - Robust, elegant, feature rich template engine for nodejs. (formerly known as Jade)
* [handlebars.js](https://github.com/handlebars-lang/handlebars.js) ⭐ 18,669 | 🐛 115 | 🌐 JavaScript | 📅 2026-06-24 - An extension to the Mustache templating language.
* [mustache.js](https://github.com/janl/mustache.js) ⭐ 16,722 | 🐛 121 | 🌐 JavaScript | 📅 2024-06-14 - Minimal templating with {{mustaches}} in JavaScript.
* [marko](https://github.com/marko-js/marko) ⭐ 14,411 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-02 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [doT](https://github.com/olado/doT) ⭐ 5,044 | 🐛 31 | 🌐 JavaScript | 📅 2023-11-02 - The fastest + concise JavaScript template engine for nodejs and browsers.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 115,038 | 🐛 382 | 🌐 JavaScript | 📅 2026-09-02 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,599 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,676 | 🐛 587 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,220 | 🐛 1,523 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,419 | 🐛 469 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 26,007 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-02 - A framework for building 3D games with HTML 5 and WebGL.
...
* [G2](https://github.com/antvis/G2) ⭐ 12,601 | 🐛 183 | 🌐 TypeScript | 📅 2026-08-31 - A highly interactive data-driven visualization grammar for statistical charts.
* [G6](https://github.com/antvis/g6) ⭐ 12,283 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,158 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-20 - A JavaScript library dedicated to graph drawing.
* [svg.js](https://github.com/wout/svg.js) ⭐ 11,820 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-04 - A lightweight library for manipulating and animating SVG.
* [raphael](https://github.com/DmitryBaranovskiy/raphael) ⭐ 11,270 | 🐛 347 | 🌐 JavaScript | 📅 2024-01-12 - JavaScript Vector Library.
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,194 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-02 - A fully featured graph theory library.
...
* [c3](https://github.com/c3js/c3) ⭐ 9,350 | 🐛 771 | 🌐 JavaScript | 📅 2026-08-05 - D3-based reusable chart library.
* [two.js](https://github.com/jonobr1/two.js) ⭐ 8,653 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-01 - A renderer agnostic two-dimensional drawing api for the web.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,530 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-21 - A next-generation declarative infographic visualization engine.
...
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,104 | 🐛 77 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,367 | 🐛 51 | 🌐 JavaScript | 📅 2026-09-02 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [timesheet.js](https://github.com/sbstjn/timesheet.js) ⭐ 6,978 | 🐛 23 | 🌐 JavaScript | 📅 2018-05-24 - JavaScript library for simple HTML5 & CSS3 time sheets.
* [TimelineJS v3](https://github.com/NUKnightLab/TimelineJS3) ⭐ 3,215 | 🐛 231 | 🌐 JavaScript | 📅 2026-08-11 - A Storytelling Timeline built in JavaScript.

## Spreadsheet

* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,035 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-02 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,440 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-02 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [trix](https://github.com/basecamp/trix) ⭐ 20,008 | 🐛 184 | 🌐 JavaScript | 📅 2026-09-01 - A rich text editor for everyday writing. By Basecamp.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,286 | 🐛 415 | 🌐 TypeScript | 📅 2026-09-02 - The JavaScript Rich Text editor.
* [medium-editor](https://github.com/yabwe/medium-editor) ⭐ 16,102 | 🐛 359 | 🌐 JavaScript | 📅 2024-10-24 - Medium.com WYSIWYG editor clone.
* [jsoneditor](https://github.com/josdejong/jsoneditor) ⭐ 12,264 | 🐛 235 | 🌐 JavaScript | 📅 2026-09-02 - A web-based tool to view, edit and format JSON.
* [Summernote](https://github.com/summernote/summernote) ⭐ 11,837 | 🐛 120 | 🌐 JavaScript | 📅 2026-04-15 - Super simple WYSIWYG editor.
...
* [ckeditor-releases](https://github.com/ckeditor/ckeditor-releases) ⭐ 520 | 🐛 7 | 🌐 JavaScript | 📅 2026-07-10 - The best web text editor for everyone.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,812 | 🐛 413 | 🌐 JavaScript | 📅 2026-09-02 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,297 | 🐛 116 | 🌐 JavaScript | 📅 2026-08-28 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,561 | 🐛 216 | 🌐 JavaScript | 📅 2026-09-01 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,212 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-02 - Browser-native components for previewing files without server-side conversion.
...
* [underscore](https://github.com/jashkenas/underscore) ⭐ 27,327 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript's utility \_ belt.
...
* [rambda](https://github.com/selfrefactor/rambda) ⭐ 1,754 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-02 - Faster and smaller alternative to *Ramda*.
...
* [wild-wild-path](https://github.com/ehmicky/wild-wild-path) ⭐ 730 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-23 - Object property paths with wildcards and regexps.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,035 | 🐛 131 | 🌐 TypeScript | 📅 2026-09-02 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [moment](https://github.com/moment/moment) ⭐ 47,914 | 🐛 74 | 🌐 JavaScript | 📅 2026-09-02 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,643 | 🐛 1,005 | 🌐 TypeScript | 📅 2026-08-30 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,449 | 🐛 180 | 🌐 JavaScript | 📅 2026-08-09 - Luxon is a library for working with dates and times in JavaScript.
...
* [query-string](https://github.com/sindresorhus/query-string) ⭐ 6,906 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-01 - Parse and stringify URL query strings.
...
* [pouchdb](https://github.com/pouchdb/pouchdb) ⭐ 17,602 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-02 - Javascript db inspired by Apache CouchDB to run well within the browser.
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,550 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-28 - Dexie.js is a wrapper library for indexedDB.
...
* [chroma.js](https://github.com/gka/chroma.js) ⭐ 10,576 | 🐛 76 | 🌐 JavaScript | 📅 2026-06-01 - JavaScript library for all kinds of color manipulations.
...
* [color-space](https://github.com/colorjs/color-space) ⭐ 382 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-21 - Conversions between 162 color spaces (OKLCH, CAM16, Munsell, camera logs) with cited references.

## I18n And L10n

*Localization (l10n) and internationalization (i18n) JavaScript libraries.*

* [i18next](https://github.com/i18next/i18next) ⭐ 8,623 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-02 - internationalisation (i18n) with JavaScript the easy way.
...
* [async](https://github.com/caolan/async) ⭐ 28,137 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-07 - Async utilities for node and the browser.
...
* [page.js](https://github.com/visionmedia/page.js) ⭐ 7,677 | 🐛 126 | 🌐 JavaScript | 📅 2023-06-27 - Micro client-side router inspired by the Express router (\~1200 bytes).
...
* [speedy-router](https://github.com/anonrig/router) ⭐ 155 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - The TanStack Router API rebuilt for faster navigations and SSR.

## Security

* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,352 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-29 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [pompelmi](https://github.com/pompelmi/pompelmi) ⭐ 674 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-23 - Fast file-upload malware scanning for Node.js.
...
* [axios](https://github.com/axios/axios) ⭐ 109,197 | 🐛 89 | 🌐 JavaScript | 📅 2026-09-01 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,251 | 🐛 152 | 🌐 TypeScript | 📅 2026-09-02 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,476 | 🐛 218 | 🌐 TypeScript | 📅 2026-09-02 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,981 | 🐛 3 | 🌐 Vue | 📅 2026-09-01 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [bowser](https://github.com/ded/bowser) ⭐ 5,750 | 🐛 85 | 🌐 JavaScript | 📅 2026-08-30 - a browser detector.
...
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,790 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-11 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,991 | 🐛 96 | 🌐 JavaScript | 📅 2026-08-30 - JavaScript syntax highlighter.
...
* [PrismJS](https://github.com/PrismJS/prism) ⭐ 13,040 | 🐛 486 | 🌐 JavaScript | 📅 2026-06-29 - Lightweight, robust, elegant syntax highlighting.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,737 | 🐛 493 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,664 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-02 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,690 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,809 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-02 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,713 | 🐛 105 | 🌐 TypeScript | 📅 2026-09-02 - Open-source notification infrastructure for products.
* [toastr](https://github.com/CodeSeven/toastr) ⭐ 12,101 | 🐛 154 | 🌐 JavaScript | 📅 2023-02-27 - Simple JavaScript toast notifications.
* [noty](https://github.com/needim/noty) ⭐ 6,622 | 🐛 51 | 🌐 JavaScript | 📅 2024-04-04 - jQuery notification plugin.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,240 | 🐛 911 | 🌐 JavaScript | 📅 2026-08-24 - A framework for easily creating beautiful presentations using HTML.
...
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,403 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-21 - An extensible low level carousel for the web, written in TypeScript.
...
* [Ion.RangeSlider](https://github.com/IonDen/ion.rangeSlider) ⭐ 2,544 | 🐛 86 | 🌐 JavaScript | 📅 2026-09-02 - Powerful and easily customizable range slider with many options and skin support.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,624 | 🐛 1,132 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,551 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-02 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [select2](https://github.com/select2/select2) ⭐ 25,904 | 🐛 136 | 🌐 JavaScript | 📅 2026-09-01 - a jQuery based replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results.
...
* [SweetAlert2](https://github.com/sweetalert2/sweetalert2) ⭐ 18,103 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-20 - An awesome replacement for JavaScript's alert.
...
* [lightGallery](https://github.com/sachinchoolur/lightGallery) ⭐ 7,054 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-07 - A customizable, modular, responsive, lightbox gallery plugin for jQuery.
...
* [Slideout](https://github.com/mango/slideout) ⭐ 7,871 | 🐛 72 | 🌐 JavaScript | 📅 2020-09-20 - A responsive touch slideout navigation menu for mobile web apps.
...
* [DataFormsJS](https://github.com/dataformsjs/dataformsjs) ⭐ 196 | 🐛 0 | 🌐 JavaScript | 📅 2025-07-31 - A minimal JavaScript Framework and standalone components for rapid development of sites and SPA's.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,610 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-01 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,555 | 🐛 567 | 🌐 JavaScript | 📅 2026-09-01 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,644 | 🐛 1,653 | 🌐 JavaScript | 📅 2026-09-02 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,517 | 🐛 164 | 🌐 C | 📅 2026-09-01 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,870 | 🐛 671 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,916 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-02 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [clappr](https://github.com/clappr/clappr) ⭐ 7,496 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-01 - An extensible media player for the web <http://clappr.io>
...
* [FlowType.JS](https://github.com/simplefocus/FlowType.JS) ⭐ 4,562 | 🐛 37 | 🌐 JavaScript | 📅 2021-07-28 - Web typography at its finest: font-size and line-height based on element width.
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,773 | 🐛 80 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 28,193 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,972 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-31 - A new and improved version of particles.js with bug fixes and many new features.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,987 | 🐛 779 | 🌐 TypeScript | 📅 2026-08-31 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 142,080 | 🐛 3,423 | 🌐 JavaScript | 📅 2026-09-02 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,160 | 🐛 399 | 🌐 TypeScript | 📅 2026-09-01 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 62,243 | 🐛 93 | 🌐 TypeScript | 📅 2026-09-02 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,810 | 🐛 528 | 🌐 TypeScript | 📅 2026-09-02 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,940 | 🐛 441 | 🌐 JavaScript | 📅 2026-09-02 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,469 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,277 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-01 - Static site generator for Deno.

## SDK

* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,159 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-02 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,499 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-02 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,594 | 🐛 2,584 | 🌐 TypeScript | 📅 2026-09-02 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,644 | 🐛 622 | 🌐 TypeScript | 📅 2026-09-02 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,660 | 🐛 2,001 | 🌐 TypeScript | 📅 2026-09-01 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,372 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-02 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,477 | 🐛 171 | 🌐 JavaScript | 📅 2026-09-02 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,343 | 🐛 743 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,192 | 🐛 171 | 🌐 TypeScript | 📅 2026-08-31 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,198 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-02 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,203 | 🐛 203 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
* [ws](https://github.com/websockets/ws) ⭐ 22,797 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-13 Simple to use, blazing fast and thoroughly tested WebSocket client and server for Node.js.
...
* [liter-llm](https://github.com/xberg-io/liter-llm) ⭐ 252 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - Universal LLM API client for 142+ providers with a unified interface and streaming, via a JavaScript/TypeScript binding over a Rust core.

## Misc

* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,598 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,402 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,103 | 🐛 427 | 🌐 TypeScript | 📅 2026-08-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,863 | 🐛 488 | 🌐 TypeScript | 📅 2026-09-02 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [Idyll](https://github.com/idyll-lang/idyll) ⭐ 2,038 | 🐛 60 | 🌐 JavaScript | 📅 2023-02-04 - Create explorable explanations and interactive storytelling essays. Can be [embedded in HTML](https://github.com/idyll-lang/idyll-embed) ⭐ 13 | 🐛 17 | 🌐 JavaScript | 📅 2023-01-07.
...
* [enum-plus](https://github.com/shijistar/enum-plus) ⭐ 205 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02 - A drop-in enhancement for native TypeScript enums, adding display text, internationalization and full type safety.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,785 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
* [Clean Code JavaScript](https://github.com/ryanmcdermott/clean-code-javascript) ⭐ 94,756 | 🐛 123 | 🌐 JavaScript | 📅 2024-07-29 - Clean Code concepts adapted for JavaScript.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 502,346 | 🐛 105 | 📅 2026-09-02
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,453 | 🐛 24 | 📅 2026-03-23
...
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,650 | 🐛 90 | 📅 2025-07-20
