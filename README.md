...
* [Bit](https://github.com/teambit/bit) ⭐ 18,454 | 🐛 102 | 🌐 TypeScript | 📅 2026-08-13 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,983 | 🐛 146 | 🌐 JavaScript | 📅 2026-08-13 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,025 | 🐛 602 | 🌐 JavaScript | 📅 2026-08-12 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,303 | 🐛 605 | 🌐 JavaScript | 📅 2026-08-12 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,319 | 🐛 347 | 🌐 JavaScript | 📅 2026-08-11 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,456 | 🐛 316 | 🌐 TypeScript | 📅 2026-08-13 - TypeScript-first schema validation with built-in static type inference.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,469 | 🐛 199 | 🌐 TypeScript | 📅 2026-08-13 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,904 | 🐛 241 | 🌐 JavaScript | 📅 2026-08-13 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,835 | 🐛 72 | 🌐 JavaScript | 📅 2026-06-17 - 🚀 Futuristic JavaScript test runner
* [jasmine](https://github.com/jasmine/jasmine) ⭐ 15,824 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-08 - DOM-less simple JavaScript testing framework.
...
* [react testing library](https://github.com/kentcdodds/react-testing-library) ⭐ 19,642 | 🐛 82 | 🌐 JavaScript | 📅 2026-04-02 - Simple and complete React DOM testing utilities that encourage good testing practices.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,460 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-13 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,475 | 🐛 156 | 🌐 TypeScript | 📅 2026-08-13 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,817 | 🐛 355 | 🌐 TypeScript | 📅 2026-08-12 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,198 | 🐛 1,436 | 🌐 JavaScript | 📅 2026-08-13 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,267 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,456 | 🐛 126 | 🌐 JavaScript | 📅 2026-08-13 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,984 | 🐛 433 | 🌐 JavaScript | 📅 2026-08-11 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,322 | 🐛 2 | 🌐 Rust | 📅 2026-08-13 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,231 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,338 | 🐛 1,053 | 🌐 C++ | 📅 2026-08-13 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 100,988 | 🐛 1,170 | 🌐 TypeScript | 📅 2026-08-13 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,976 | 🐛 1,130 | 🌐 JavaScript | 📅 2026-08-12 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,808 | 🐛 414 | 🌐 JavaScript | 📅 2026-08-13 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,814 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-13 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,850 | 🐛 7 | 🌐 HTML | 📅 2026-08-13 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,123 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,603 | 🐛 836 | 🌐 TypeScript | 📅 2026-08-13 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,568 | 🐛 259 | 🌐 TypeScript | 📅 2026-08-13 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,081 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-13 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [feathers](https://github.com/feathersjs/feathers) ⭐ 15,260 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-11 - A minimalist real-time JavaScript framework for tomorrow's apps.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,518 | 🐛 339 | 🌐 JavaScript | 📅 2026-08-13 - A library that adds a visual code editor to web and mobile apps by Google.
...
* [Drawflow](https://github.com/jerosoler/Drawflow) ⭐ 6,099 | 🐛 272 | 🌐 JavaScript | 📅 2024-10-19 - This allow you to create data flows easily and quickly.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 72,861 | 🐛 523 | 🌐 TypeScript | 📅 2026-08-13 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,752 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-13 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,940 | 🐛 141 | 🌐 TypeScript | 📅 2026-08-11 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,599 | 🐛 138 | 🌐 JavaScript | 📅 2026-08-13 - CMS with content editing and essential services.
...
* [marko](https://github.com/marko-js/marko) ⭐ 14,406 | 🐛 30 | 🌐 JavaScript | 📅 2026-08-13 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,497 | 🐛 375 | 🌐 JavaScript | 📅 2026-08-13 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,448 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,639 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,065 | 🐛 1,560 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,382 | 🐛 466 | 🌐 TypeScript | 📅 2026-08-08 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,922 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-13 - A framework for building 3D games with HTML 5 and WebGL.
* [Frappe Charts](https://github.com/frappe/charts) ⭐ 15,088 | 🐛 145 | 🌐 JavaScript | 📅 2025-07-02 - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
...
* [G2](https://github.com/antvis/G2) ⭐ 12,585 | 🐛 182 | 🌐 TypeScript | 📅 2026-07-15 - A highly interactive data-driven visualization grammar for statistical charts.
* [G6](https://github.com/antvis/g6) ⭐ 12,247 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,132 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-12 - A JavaScript library dedicated to graph drawing.
* [svg.js](https://github.com/wout/svg.js) ⭐ 11,818 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-04 - A lightweight library for manipulating and animating SVG.
* [raphael](https://github.com/DmitryBaranovskiy/raphael) ⭐ 11,273 | 🐛 347 | 🌐 JavaScript | 📅 2024-01-12 - JavaScript Vector Library.
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,157 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-13 - A fully featured graph theory library.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,253 | 🐛 22 | 🌐 TypeScript | 📅 2026-06-01 - A next-generation declarative infographic visualization engine.
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,081 | 🐛 74 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,346 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-13 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,019 | 🐛 140 | 🌐 JavaScript | 📅 2026-08-13 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,434 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-10 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [ace](https://github.com/ajaxorg/ace) ⭐ 27,143 | 🐛 136 | 🌐 JavaScript | 📅 2026-08-13 - Ace (Ajax.org Cloud9 Editor).
* [Draft.js](https://github.com/facebook/draft-js) ⚠️ Archived - A React framework for building text editors.
* [trix](https://github.com/basecamp/trix) ⭐ 19,992 | 🐛 184 | 🌐 JavaScript | 📅 2026-08-11 - A rich text editor for everyday writing. By Basecamp.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,274 | 🐛 414 | 🌐 TypeScript | 📅 2026-08-13 - The JavaScript Rich Text editor.
...
* [Squire](https://github.com/neilj/Squire) ⭐ 4,904 | 🐛 57 | 🌐 TypeScript | 📅 2026-06-09 - HTML5 rich text editor.
* [pen](https://github.com/sofish/pen) ⭐ 4,796 | 🐛 65 | 🌐 JavaScript | 📅 2018-09-23 - enjoy live editing (+markdown).
...
* [editor](https://github.com/lepture/editor) ⭐ 2,796 | 🐛 54 | 🌐 JavaScript | 📅 2017-10-09 - A markdown editor. still on development.
...
* [jsduck](https://github.com/senchalabs/jsduck) ⭐ 1,492 | 🐛 86 | 🌐 Ruby | 📅 2020-04-16 - API documentation generator made for Sencha JavaScript frameworks, but can be used for other frameworks too.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,730 | 🐛 423 | 🌐 JavaScript | 📅 2026-08-13 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,270 | 🐛 120 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 1,971 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-13 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,322 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,045 | 🐛 132 | 🌐 TypeScript | 📅 2026-08-06 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [hashmap](https://github.com/flesler/hashmap) ⭐ 383 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-06 - Simple hashmap implementation that supports any kind of keys.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,669 | 🐛 1,293 | 🌐 JavaScript | 📅 2026-06-30 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 47,919 | 🐛 218 | 🌐 JavaScript | 📅 2026-08-13 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,622 | 🐛 984 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,437 | 🐛 178 | 🌐 JavaScript | 📅 2026-08-09 - Luxon is a library for working with dates and times in JavaScript.
...
* [Numeral-js](https://github.com/adamwdraper/Numeral-js) ⭐ 9,704 | 🐛 346 | 🌐 JavaScript | 📅 2026-02-15 - A JavaScript library for formatting and manipulating numbers.
...
* [js-cookie](https://github.com/js-cookie/js-cookie) ⭐ 22,603 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-10 - A simple, lightweight JavaScript API for handling browser cookies.
...
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,533 | 🐛 596 | 🌐 TypeScript | 📅 2026-08-05 - Dexie.js is a wrapper library for indexedDB.
...
* [NeDB](https://github.com/louischatriot/nedb) ⭐ 13,537 | 🐛 209 | 🌐 JavaScript | 📅 2025-05-15 - Embedded Persistent database for Browsers, nw\.js, electron.
...
* [jStorage](https://github.com/andris9/jStorage) ⭐ 1,526 | 🐛 23 | 🌐 JavaScript | 📅 2020-05-16 - jStorage is a simple key/value database to store data on browser side.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,614 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-09 - internationalisation (i18n) with JavaScript the easy way.
...
* [async](https://github.com/caolan/async) ⭐ 28,142 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-07 - Async utilities for node and the browser.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,300 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-13 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [pompelmi](https://github.com/pompelmi/pompelmi) ⭐ 669 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-23 - Fast file-upload malware scanning for Node.js.
...
* [axios](https://github.com/axios/axios) ⭐ 109,231 | 🐛 69 | 🌐 JavaScript | 📅 2026-08-12 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,127 | 🐛 239 | 🌐 TypeScript | 📅 2026-08-13 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,454 | 🐛 211 | 🌐 TypeScript | 📅 2026-08-12 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,882 | 🐛 1 | 🌐 Vue | 📅 2026-08-13 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [tracking.js](https://github.com/eduardolundgren/tracking.js) ⭐ 9,468 | 🐛 227 | 🌐 JavaScript | 📅 2026-08-11 - A modern approach for Computer Vision on the web.
* [ocrad.js](https://github.com/antimatter15/ocrad.js) ⭐ 3,519 | 🐛 28 | 🌐 JavaScript | 📅 2020-09-02 - OCR in JavaScript via Emscripten.

## Machine Learning

* [ConvNetJS](https://github.com/karpathy/convnetjs) ⭐ 11,193 | 🐛 76 | 🌐 JavaScript | 📅 2023-01-07 - Deep Learning in JavaScript. Train Convolutional Neural Networks (or ordinary ones) in your browser.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 159 | 🌐 Rust | 📅 2026-08-13 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,983 | 🐛 121 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,700 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
* [PrismJS](https://github.com/PrismJS/prism) ⭐ 13,036 | 🐛 482 | 🌐 JavaScript | 📅 2026-06-29 - Lightweight, robust, elegant syntax highlighting.

## Loading Status

*Libraries for indicate load status.*

* [SpinKit](https://github.com/tobiasahlin/SpinKit) ⭐ 19,336 | 🐛 11 | 🌐 CSS | 📅 2020-08-01 - A collection of loading indicators animated with CSS.
...
* [Mprogress.js](https://github.com/lightningtgc/MProgress.js) ⭐ 1,531 | 🐛 8 | 🌐 JavaScript | 📅 2021-05-15 - Create Google Material Design progress linear bars.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,740 | 🐛 473 | 🌐 JavaScript | 📅 2026-08-08 - String validation and sanitization.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,583 | 🐛 21 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
* [intro.js](https://github.com/usablica/intro.js) ⭐ 23,476 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-07 - A better way for new feature introduction and step-by-step users guide for your website and project.
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,778 | 🐛 43 | 🌐 JavaScript | 📅 2026-08-13 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,492 | 🐛 103 | 🌐 TypeScript | 📅 2026-08-13 - Open-source notification infrastructure for products.
* [toastr](https://github.com/CodeSeven/toastr) ⭐ 12,105 | 🐛 155 | 🌐 JavaScript | 📅 2023-02-27 - Simple JavaScript toast notifications.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,114 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,881 | 🐛 253 | 🌐 TypeScript | 📅 2026-08-06 - Mobile touch slider and framework with hardware accelerated transitions.
* [impress.js](https://github.com/impress/impress.js) ⭐ 38,191 | 🐛 59 | 🌐 JavaScript | 📅 2026-07-23 - It's a presentation framework based on the power of CSS3 transforms and transitions in modern browsers and inspired by the idea behind prezi.com.
* [slick](https://github.com/kenwheeler/slick) ⭐ 28,564 | 🐛 1,317 | 🌐 JavaScript | 📅 2026-08-01 - The last carousel you'll ever need.
* [PhotoSwipe](https://github.com/dimsemenov/PhotoSwipe) ⭐ 25,238 | 🐛 169 | 🌐 JavaScript | 📅 2025-12-04 - JavaScript image gallery for mobile and desktop, modular, framework independent.
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,387 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-11 - An extensible low level carousel for the web, written in TypeScript.
...
* [bespoke.js](https://github.com/bespokejs/bespoke) ⭐ 4,799 | 🐛 6 | 🌐 JavaScript | 📅 2020-09-08 - DIY Presentation Micro-Framework
...
* [typeahead.js](https://github.com/twitter/typeahead.js) ⭐ 16,445 | 🐛 507 | 🌐 JavaScript | 📅 2023-04-14 - A fast and fully-featured autocomplete library.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,607 | 🐛 1,128 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [Date Range Picker](https://github.com/dangrossman/daterangepicker) ⭐ 10,980 | 🐛 120 | 🌐 JavaScript | 📅 2024-08-09 - creates a dropdown menu from which a user can select a range of dates.
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,525 | 🐛 59 | 🌐 TypeScript | 📅 2026-07-30 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [SweetAlert](https://github.com/t4t5/sweetalert) ⭐ 22,264 | 🐛 199 | 🌐 TypeScript | 📅 2023-04-15 - An awesome replacement for JavaScript's alert.
...
* [Magnific-Popup](https://github.com/dimsemenov/Magnific-Popup) ⭐ 11,316 | 🐛 678 | 🌐 JavaScript | 📅 2024-06-08 - Light and responsive lightbox script with focus on performance.
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,837 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-30 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [Slideout](https://github.com/mango/slideout) ⭐ 7,877 | 🐛 72 | 🌐 JavaScript | 📅 2020-09-20 - A responsive touch slideout navigation menu for mobile web apps.
* [jQuery-menu-aim](https://github.com/kamens/jQuery-menu-aim) ⭐ 7,623 | 🐛 66 | 🌐 JavaScript | 📅 2018-11-01 - jQuery plugin to fire events when user's cursor aims at particular dropdown menu items. For making responsive mega dropdowns like Amazon's.
...
* [jTable](https://github.com/hikalkan/jtable) ⭐ 1,083 | 🐛 1,504 | 🌐 JavaScript | 📅 2021-11-19 - A jQuery plugin to create AJAX based CRUD tables.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,588 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-10 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
* [Wasp](https://github.com/wasp-lang/wasp) ⭐ 18,678 | 🐛 834 | 🌐 TypeScript | 📅 2026-08-13 Wasp is a declarative domain-specific language for developing, building, and deploying modern Javascript full-stack web apps with less code.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,479 | 🐛 557 | 🌐 JavaScript | 📅 2026-08-10 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,561 | 🐛 1,640 | 🌐 JavaScript | 📅 2026-08-13 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,460 | 🐛 165 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,848 | 🐛 664 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
* [flv.js](https://github.com/bilibili/flv.js) ⭐ 23,197 | 🐛 449 | 🌐 JavaScript | 📅 2024-07-07 - An HTML5 Flash Video (FLV) Player written in pure JavaScript without Flash.
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,873 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-12 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [ractive-player](https://github.com/ysulyma/ractive-player) ⭐ 813 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-10 - A library for making interactive videos in React.js.
...
* [particles.js](https://github.com/VincentGarreau/particles.js) ⭐ 30,224 | 🐛 367 | 🌐 JavaScript | 📅 2024-03-28 - A lightweight JavaScript library for creating particles.
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,667 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,950 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A new and improved version of particles.js with bug fixes and many new features.
...
* [bounce.js](https://github.com/tictail/bounce.js) ⭐ 6,161 | 🐛 12 | 🌐 CSS | 📅 2020-09-03 - Create tasty CSS3 powered animations in no time.
...
* [pica](https://github.com/nodeca/pica) ⭐ 4,139 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-26 - High quality image resize (with fast Lanczos filter, implemented in pure JS).
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,979 | 🐛 766 | 🌐 TypeScript | 📅 2026-08-08 - Turn ES6+ code into vanilla ES5 with no runtime.
* [es6features](https://github.com/lukehoban/es6features) ⭐ 29,037 | 🐛 38 | 📅 2023-01-27 - Overview of ECMAScript 6 features.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,763 | 🐛 4,310 | 🌐 JavaScript | 📅 2026-08-13 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 65,907 | 🐛 424 | 🌐 TypeScript | 📅 2026-08-13 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 61,749 | 🐛 119 | 🌐 TypeScript | 📅 2026-08-13 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,754 | 🐛 538 | 🌐 TypeScript | 📅 2026-08-13 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 418 | 🌐 JavaScript | 📅 2026-08-12 - React-based static site generator.
...
* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,112 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-12 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,484 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-13 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,773 | 🐛 36 | 🌐 JavaScript | 📅 2026-06-28 - It is a Next-Generation full text search library for Browser and Node.js.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,572 | 🐛 2,541 | 🌐 TypeScript | 📅 2026-08-13 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,627 | 🐛 614 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,466 | 🐛 1,948 | 🌐 TypeScript | 📅 2026-08-12 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,378 | 🐛 1,076 | 🌐 TypeScript | 📅 2026-08-11 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,473 | 🐛 176 | 🌐 JavaScript | 📅 2026-08-10 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,338 | 🐛 735 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,124 | 🐛 168 | 🌐 TypeScript | 📅 2026-08-12 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,166 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-12 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,197 | 🐛 188 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,460 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,253 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,035 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,019 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,835 | 🐛 500 | 🌐 TypeScript | 📅 2026-08-13 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,655 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 495,291 | 🐛 99 | 📅 2026-06-30
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,268 | 🐛 71 | 📅 2026-07-20
* [bayandin/awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,606 | 🐛 61 | 🌐 Ruby | 📅 2024-06-02
* [bolshchikov/js-must-watch](https://github.com/bolshchikov/js-must-watch) ⭐ 13,601 | 🐛 0 | 📅 2022-01-20
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,413 | 🐛 20 | 📅 2026-03-23
...
* [denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,412 | 🐛 3 | 📅 2026-08-12
