...
* [Bit](https://github.com/teambit/bit) ⭐ 18,460 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-24 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,972 | 🐛 137 | 🌐 JavaScript | 📅 2026-08-24 - Packs CommonJs/AMD modules for the browser.
...
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,309 | 🐛 601 | 🌐 JavaScript | 📅 2026-08-25 - Next-generation ES6 module bundler.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,522 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-25 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,671 | 🐛 251 | 🌐 TypeScript | 📅 2026-08-21 - JavaScript schema builder and validator.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,495 | 🐛 261 | 🌐 TypeScript | 📅 2026-08-24 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,082 | 🐛 169 | 🌐 TypeScript | 📅 2026-08-25 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,825 | 🐛 288 | 🌐 TypeScript | 📅 2026-08-25 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,218 | 🐛 1,416 | 🌐 JavaScript | 📅 2026-08-24 - Prettier is an opinionated code formatter.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,486 | 🐛 130 | 🌐 JavaScript | 📅 2026-08-24 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,406 | 🐛 4 | 🌐 Rust | 📅 2026-08-25 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,690 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,408 | 🐛 1,089 | 🌐 C++ | 📅 2026-08-24 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,005 | 🐛 1,137 | 🌐 TypeScript | 📅 2026-08-25 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,984 | 🐛 1,068 | 🌐 JavaScript | 📅 2026-08-24 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,813 | 🐛 415 | 🌐 JavaScript | 📅 2026-08-24 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,831 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-25 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,883 | 🐛 3 | 🌐 HTML | 📅 2026-08-24 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,164 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
...
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,567 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-24 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,101 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,531 | 🐛 342 | 🌐 JavaScript | 📅 2026-08-24 - A library that adds a visual code editor to web and mobile apps by Google.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 8,113 | 🐛 146 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 73,013 | 🐛 537 | 🌐 TypeScript | 📅 2026-08-24 - Open source Node.js Headless CMS to easily build customisable APIs.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,964 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-25 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,605 | 🐛 135 | 🌐 JavaScript | 📅 2026-08-19 - CMS with content editing and essential services.
...
* [d3](https://github.com/d3/d3) ⭐ 113,545 | 🐛 21 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,660 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,146 | 🐛 1,541 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,980 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-25 - A framework for building 3D games with HTML 5 and WebGL.
...
* [paper.js](https://github.com/paperjs/paper.js) ⭐ 15,066 | 🐛 429 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting – Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,182 | 🐛 21 | 🌐 JavaScript | 📅 2026-08-24 - A fully featured graph theory library.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,381 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-21 - A next-generation declarative infographic visualization engine.
...
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,359 | 🐛 46 | 🌐 JavaScript | 📅 2026-08-24 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [trix](https://github.com/basecamp/trix) ⭐ 20,006 | 🐛 185 | 🌐 JavaScript | 📅 2026-08-21 - A rich text editor for everyday writing. By Basecamp.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,778 | 🐛 414 | 🌐 JavaScript | 📅 2026-08-23 - PDF Reader in JavaScript.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,062 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-25 - Browser-native components for previewing files without server-side conversion.
...
* [ramda](https://github.com/ramda/ramda) ⭐ 24,057 | 🐛 146 | 🌐 JavaScript | 📅 2026-07-26 - A practical functional library for JavaScript programmers.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,669 | 🐛 1,300 | 🌐 JavaScript | 📅 2026-08-18 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
...
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,644 | 🐛 996 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
...
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,546 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-24 - Dexie.js is a wrapper library for indexedDB.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,331 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,202 | 🐛 78 | 🌐 JavaScript | 📅 2026-08-24 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,200 | 🐛 122 | 🌐 TypeScript | 📅 2026-08-25 - Hooks for fetching, caching and updating asynchronous data in React.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,959 | 🐛 0 | 🌐 Vue | 📅 2026-08-25 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [partytown](https://github.com/BuilderIO/partytown) ⭐ 13,761 | 🐛 41 | 🌐 TypeScript | 📅 2026-08-24 - Relocate resource intensive third-party scripts off of the main thread and into a web worker.
...
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,742 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,739 | 🐛 487 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,628 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,793 | 🐛 30 | 🌐 JavaScript | 📅 2026-08-25 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,662 | 🐛 109 | 🌐 TypeScript | 📅 2026-08-25 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,180 | 🐛 908 | 🌐 JavaScript | 📅 2026-08-24 - A framework for easily creating beautiful presentations using HTML.
...
* [FileAPI](https://github.com/mailru/FileAPI) ⭐ 3,550 | 🐛 50 | 🌐 JavaScript | 📅 2020-09-24 - A set of JavaScript tools for working with files. Multiupload, drag'n'drop and chunked file upload. Images: crop, resize and auto orientation by EXIF.
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,846 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-30 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [flexboxgrid](https://github.com/kristoferjoseph/flexboxgrid/) ⭐ 9,307 | 🐛 62 | 🌐 HTML | 📅 2020-10-01 - Grid based on CSS3 flexbox.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,514 | 🐛 563 | 🌐 JavaScript | 📅 2026-08-24 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,596 | 🐛 1,651 | 🌐 JavaScript | 📅 2026-08-25 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,487 | 🐛 167 | 🌐 C | 📅 2026-08-20 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,892 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-25 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [clappr](https://github.com/clappr/clappr) ⭐ 7,495 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-24 - An extensible media player for the web <http://clappr.io>
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,967 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,989 | 🐛 779 | 🌐 TypeScript | 📅 2026-08-23 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,924 | 🐛 3,856 | 🌐 JavaScript | 📅 2026-08-25 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,070 | 🐛 397 | 🌐 TypeScript | 📅 2026-08-24 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 62,017 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-24 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,792 | 🐛 543 | 🌐 TypeScript | 📅 2026-08-24 - The Intuitive Vue Framework.
...
* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,139 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-25 - Official JavaScript / TypeScript library for the OpenAI API.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,569 | 🐛 2,556 | 🌐 TypeScript | 📅 2026-08-24 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
...
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,580 | 🐛 1,983 | 🌐 TypeScript | 📅 2026-08-19 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,473 | 🐛 175 | 🌐 JavaScript | 📅 2026-08-23 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,342 | 🐛 738 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,165 | 🐛 162 | 🌐 TypeScript | 📅 2026-08-24 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,183 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-24 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,204 | 🐛 198 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
...
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,339 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
...
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,042 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,720 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 499,690 | 🐛 106 | 📅 2026-08-21
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,439 | 🐛 22 | 📅 2026-03-23
