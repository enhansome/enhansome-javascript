...
* [jspm](https://github.com/jspm/jspm-cli) ⭐ 3,868 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-17 - Frictionless browser package management.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,458 | 🐛 90 | 🌐 TypeScript | 📅 2026-08-22 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,976 | 🐛 138 | 🌐 JavaScript | 📅 2026-08-23 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,020 | 🐛 601 | 🌐 JavaScript | 📅 2026-08-22 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,306 | 🐛 604 | 🌐 JavaScript | 📅 2026-08-22 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,323 | 🐛 347 | 🌐 JavaScript | 📅 2026-08-22 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,514 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-20 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,672 | 🐛 251 | 🌐 TypeScript | 📅 2026-08-21 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,473 | 🐛 181 | 🌐 TypeScript | 📅 2026-08-21 - Painless JavaScript Unit Testing.
...
* [jasmine](https://github.com/jasmine/jasmine) ⭐ 15,824 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-20 - DOM-less simple JavaScript testing framework.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,906 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-20 - Automated browser testing for the modern web development stack.
...
* [qunit](https://github.com/jquery/qunit) ⭐ 4,033 | 🐛 52 | 🌐 JavaScript | 📅 2026-06-28 - An easy-to-use JavaScript Unit Testing framework.
...
* [react testing library](https://github.com/kentcdodds/react-testing-library) ⭐ 19,647 | 🐛 82 | 🌐 JavaScript | 📅 2026-04-02 - Simple and complete React DOM testing utilities that encourage good testing practices.
...
* [chai](https://github.com/chaijs/chai) ⭐ 8,269 | 🐛 92 | 🌐 JavaScript | 📅 2026-08-17 - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,490 | 🐛 265 | 🌐 TypeScript | 📅 2026-08-23 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,000 | 🐛 159 | 🌐 TypeScript | 📅 2026-08-22 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,822 | 🐛 290 | 🌐 TypeScript | 📅 2026-08-23 - Next-gen WebDriver test automation framework for Node.js.
...
* [taiko](https://github.com/getgauge/taiko) ⭐ 3,673 | 🐛 50 | 🌐 JavaScript | 📅 2026-08-23 - A Node.js library with a simple API to automate Chromium based browsers.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,212 | 🐛 1,418 | 🌐 JavaScript | 📅 2026-08-23 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,280 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,476 | 🐛 130 | 🌐 JavaScript | 📅 2026-08-23 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,992 | 🐛 437 | 🌐 JavaScript | 📅 2026-08-17 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,393 | 🐛 11 | 🌐 Rust | 📅 2026-08-23 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,656 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-02 - High-standards, strict & opinionated code quality tool, aiming to keep only good parts of the language.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,469 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,394 | 🐛 1,080 | 🌐 C++ | 📅 2026-08-22 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,000 | 🐛 1,165 | 🌐 TypeScript | 📅 2026-08-22 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,978 | 🐛 1,076 | 🌐 JavaScript | 📅 2026-08-21 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,810 | 🐛 413 | 🌐 JavaScript | 📅 2026-08-22 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,830 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-23 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,874 | 🐛 2 | 🌐 HTML | 📅 2026-08-19 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,157 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,622 | 🐛 835 | 🌐 TypeScript | 📅 2026-08-23 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,567 | 🐛 266 | 🌐 TypeScript | 📅 2026-08-23 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,097 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [feathers](https://github.com/feathersjs/feathers) ⭐ 15,266 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-14 - A minimalist real-time JavaScript framework for tomorrow's apps.
* [riot](https://github.com/riot/riot) ⭐ 14,914 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-06 - React-like library, but with very small size.
* [mithril.js](https://github.com/lhorie/mithril.js) ⭐ 14,492 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13 - Mithril is a client-side MVC framework (Light-weight, Robust, Fast).
* [Blockly](https://github.com/google/blockly) ⭐ 13,527 | 🐛 345 | 🌐 JavaScript | 📅 2026-08-22 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,224 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 8,110 | 🐛 146 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Remult](https://github.com/remult/remult) ⭐ 3,207 | 🐛 118 | 🌐 TypeScript | 📅 2026-08-20 - A CRUD framework for full-stack TypeScript.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 73,007 | 🐛 539 | 🌐 TypeScript | 📅 2026-08-21 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,045 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-23 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,963 | 🐛 144 | 🌐 TypeScript | 📅 2026-08-20 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,603 | 🐛 135 | 🌐 JavaScript | 📅 2026-08-19 - CMS with content editing and essential services.
...
* [marko](https://github.com/marko-js/marko) ⭐ 14,407 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-23 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
* [EJS](https://github.com/mde/ejs) ⭐ 8,118 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-10 - Effective JavaScript templating.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,707 | 🐛 378 | 🌐 JavaScript | 📅 2026-08-23 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,532 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,660 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,128 | 🐛 1,546 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,406 | 🐛 468 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
* [recharts](https://github.com/recharts/recharts) ⭐ 27,515 | 🐛 438 | 🌐 TypeScript | 📅 2026-08-23 - Redefined chart library built with React and D3.
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,970 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-21 - A framework for building 3D games with HTML 5 and WebGL.
* [Frappe Charts](https://github.com/frappe/charts) ⭐ 15,080 | 🐛 145 | 🌐 JavaScript | 📅 2025-07-02 - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
* [paper.js](https://github.com/paperjs/paper.js) ⭐ 15,065 | 🐛 429 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting – Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
* [G2](https://github.com/antvis/G2) ⭐ 12,593 | 🐛 182 | 🌐 TypeScript | 📅 2026-07-15 - A highly interactive data-driven visualization grammar for statistical charts.
* [G6](https://github.com/antvis/g6) ⭐ 12,269 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,144 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-20 - A JavaScript library dedicated to graph drawing.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,179 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-19 - A fully featured graph theory library.
...
* [two.js](https://github.com/jonobr1/two.js) ⭐ 8,651 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-05 - A renderer agnostic two-dimensional drawing api for the web.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,377 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-21 - A next-generation declarative infographic visualization engine.
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,093 | 🐛 76 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,360 | 🐛 45 | 🌐 JavaScript | 📅 2026-08-21 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [vizzu](https://github.com/vizzuhq/vizzu-lib) ⭐ 2,022 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-20 - Library for animated data visualizations and data stories.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,029 | 🐛 101 | 🌐 JavaScript | 📅 2026-08-21 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [Jspreadsheet CE](https://github.com/jspreadsheet/ce) ⭐ 7,217 | 🐛 151 | 🌐 JavaScript | 📅 2026-04-10 - Jspreadsheet is a lightweight vanilla javascript plugin to create amazing web-based interactive tables and spreadsheets compatible with other spreadsheet software.
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,437 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-21 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [quill](https://github.com/quilljs/quill) ⭐ 47,309 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
...
* [trix](https://github.com/basecamp/trix) ⭐ 20,005 | 🐛 185 | 🌐 JavaScript | 📅 2026-08-21 - A rich text editor for everyday writing. By Basecamp.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,278 | 🐛 411 | 🌐 TypeScript | 📅 2026-08-17 - The JavaScript Rich Text editor.
* [medium-editor](https://github.com/yabwe/medium-editor) ⭐ 16,105 | 🐛 359 | 🌐 JavaScript | 📅 2024-10-24 - Medium.com WYSIWYG editor clone.
...
* [Summernote](https://github.com/summernote/summernote) ⭐ 11,833 | 🐛 118 | 🌐 JavaScript | 📅 2026-04-15 - Super simple WYSIWYG editor.
...
* [Squire](https://github.com/neilj/Squire) ⭐ 4,907 | 🐛 57 | 🌐 TypeScript | 📅 2026-06-09 - HTML5 rich text editor.
...
* [Trumbowyg](https://github.com/Alex-D/Trumbowyg) ⭐ 4,148 | 🐛 120 | 🌐 JavaScript | 📅 2026-06-20 - A lightweight and amazing WYSIWYG JavaScript editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,767 | 🐛 414 | 🌐 JavaScript | 📅 2026-08-23 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,281 | 🐛 119 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,550 | 🐛 224 | 🌐 JavaScript | 📅 2026-08-13 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,044 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-22 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,292 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
* [underscore](https://github.com/jashkenas/underscore) ⭐ 27,333 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript's utility \_ belt.
...
* [wild-wild-path](https://github.com/ehmicky/wild-wild-path) ⭐ 729 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-23 - Object property paths with wildcards and regexps.
...
* [MobX](https://github.com/mobxjs/mobx) ⭐ 28,205 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-20 - TFRP library for simple, scalable state management.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,667 | 🐛 1,298 | 🌐 JavaScript | 📅 2026-08-18 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 47,917 | 🐛 119 | 🌐 JavaScript | 📅 2026-08-20 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,638 | 🐛 995 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,445 | 🐛 179 | 🌐 JavaScript | 📅 2026-08-09 - Luxon is a library for working with dates and times in JavaScript.
* [ms.js](https://github.com/rauchg/ms.js) ⭐ 5,543 | 🐛 37 | 🌐 TypeScript | 📅 2026-05-20 - Tiny millisecond conversion utility.
...
* [localForage](https://github.com/mozilla/localForage) ⭐ 25,807 | 🐛 250 | 🌐 JavaScript | 📅 2024-07-30 - Offline storage, improved. Wraps IndexedDB, WebSQL, or localStorage using a simple but powerful API.
* [js-cookie](https://github.com/js-cookie/js-cookie) ⭐ 22,592 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-10 - A simple, lightweight JavaScript API for handling browser cookies.
* [pouchdb](https://github.com/pouchdb/pouchdb) ⭐ 17,599 | 🐛 186 | 🌐 JavaScript | 📅 2026-07-27 - Javascript db inspired by Apache CouchDB to run well within the browser.
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,543 | 🐛 595 | 🌐 TypeScript | 📅 2026-08-21 - Dexie.js is a wrapper library for indexedDB.
...
* [PostgreSQL Browser](https://github.com/datawan-labs/pg) ⭐ 778 | 🐛 4 | 🌐 TypeScript | 📅 2024-12-02 - Browser PostgreSQL Playground, no server, just client and pglite (postgresql wasm)
...
* [chroma.js](https://github.com/gka/chroma.js) ⭐ 10,573 | 🐛 76 | 🌐 JavaScript | 📅 2026-06-01 - JavaScript library for all kinds of color manipulations.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,619 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-20 - internationalisation (i18n) with JavaScript the easy way.
...
* [speedy-router](https://github.com/anonrig/router) ⭐ 149 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-21 - The TanStack Router API rebuilt for faster navigations and SSR.

## Security

* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,321 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-21 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
* [js-xss](https://github.com/leizongmin/js-xss) ⭐ 5,314 | 🐛 69 | 🌐 HTML | 📅 2026-05-06 - Sanitize untrusted HTML (to prevent XSS) with a configuration specified by a Whitelist.
...
* [axios](https://github.com/axios/axios) ⭐ 109,199 | 🐛 75 | 🌐 JavaScript | 📅 2026-08-22 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,185 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-23 - Hooks for fetching, caching and updating asynchronous data in React.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,954 | 🐛 0 | 🌐 Vue | 📅 2026-08-23 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 889 | 🐛 156 | 🌐 Rust | 📅 2026-08-23 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [partytown](https://github.com/BuilderIO/partytown) ⭐ 13,760 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-03 - Relocate resource intensive third-party scripts off of the main thread and into a web worker.
...
* [worker-dom](https://github.com/ampproject/worker-dom) ⭐ 3,264 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-20 - An in-progress implementation of the DOM API intended to run within a Web Worker.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,982 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,733 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
* [PrismJS](https://github.com/PrismJS/prism) ⭐ 13,037 | 🐛 484 | 🌐 JavaScript | 📅 2026-06-29 - Lightweight, robust, elegant syntax highlighting.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,738 | 🐛 483 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
* [jquery-validation](https://github.com/jzaefferer/jquery-validation) ⭐ 10,317 | 🐛 41 | 🌐 JavaScript | 📅 2026-06-29 - jQuery Validation Plugin.
* [is.js](https://github.com/arasatasaygin/is.js) ⭐ 9,068 | 🐛 47 | 🌐 JavaScript | 📅 2022-01-11 - Check types, regexps, presence, time and more.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,622 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,791 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-19 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,642 | 🐛 107 | 🌐 TypeScript | 📅 2026-08-23 - Open-source notification infrastructure for products.
...
* [toastify-js](https://github.com/apvarun/toastify-js) ⭐ 2,533 | 🐛 51 | 🌐 JavaScript | 📅 2024-08-19 - Pure JavaScript library for better notification messages.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,167 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,892 | 🐛 255 | 🌐 TypeScript | 📅 2026-08-06 - Mobile touch slider and framework with hardware accelerated transitions.
...
* [PhotoSwipe](https://github.com/dimsemenov/PhotoSwipe) ⭐ 25,240 | 🐛 170 | 🌐 JavaScript | 📅 2025-12-04 - JavaScript image gallery for mobile and desktop, modular, framework independent.
...
* [Ion.RangeSlider](https://github.com/IonDen/ion.rangeSlider) ⭐ 2,544 | 🐛 102 | 🌐 JavaScript | 📅 2026-08-23 - Powerful and easily customizable range slider with many options and skin support.
...
* [typeahead.js](https://github.com/twitter/typeahead.js) ⭐ 16,443 | 🐛 506 | 🌐 JavaScript | 📅 2023-04-14 - A fast and fully-featured autocomplete library.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,617 | 🐛 1,129 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,536 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [select2](https://github.com/select2/select2) ⭐ 25,910 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-17 - a jQuery based replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results.
* [chosen](https://github.com/harvesthq/chosen) ⭐ 21,947 | 🐛 309 | 🌐 HTML | 📅 2024-12-02 - A library for making long, unwieldy select boxes more friendly.
...
* [dropzone](https://github.com/enyo/dropzone) ⭐ 18,378 | 🐛 149 | 🌐 JavaScript | 📅 2026-08-23 - Dropzone is an easy to use drag'n'drop library. It supports image previews and shows nice progress bars.
* [filepond](https://github.com/pqina/filepond) ⭐ 16,391 | 🐛 140 | 🌐 JavaScript | 📅 2026-07-13 - A JavaScript library that can upload anything you throw at it, optimizes images for faster uploads, and offers a great, accessible, silky smooth user experience.
...
* [dat.GUI](https://github.com/dataarts/dat.gui) ⭐ 7,724 | 🐛 124 | 🌐 JavaScript | 📅 2026-06-21 - A lightweight gui controller for changing variables in JavaScript.
...
* [SweetAlert](https://github.com/t4t5/sweetalert) ⭐ 22,262 | 🐛 199 | 🌐 TypeScript | 📅 2023-04-15 - An awesome replacement for JavaScript's alert.
...
* [lightGallery](https://github.com/sachinchoolur/lightGallery) ⭐ 7,048 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-07 - A customizable, modular, responsive, lightbox gallery plugin for jQuery.
...
* [fullPage](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,407 | 🐛 129 | 🌐 JavaScript | 📅 2026-03-17 - A simple and easy to use plugin to create fullscreen scrolling websites (also known as single page websites).
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,844 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-30 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [flexboxgrid](https://github.com/kristoferjoseph/flexboxgrid/) ⭐ 9,308 | 🐛 62 | 🌐 HTML | 📅 2020-10-01 - Grid based on CSS3 flexbox.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,603 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-20 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
...
* [Dragula](https://github.com/bevacqua/dragula/) ⭐ 22,137 | 🐛 159 | 🌐 JavaScript | 📅 2024-06-07 - Drag and drop so simple it hurts.
* [touchemulator](https://github.com/hammerjs/touchemulator) ⭐ 406 | 🐛 17 | 🌐 JavaScript | 📅 2022-11-17 - Emulate touch input on your desktop.

## Maps

* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,511 | 🐛 562 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,595 | 🐛 1,650 | 🌐 JavaScript | 📅 2026-08-21 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,484 | 🐛 167 | 🌐 C | 📅 2026-08-20 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
* [mapbox.js](https://github.com/mapbox/mapbox.js) ⚠️ Archived - Mapbox JavaScript API, a Leaflet Plugin.
* [jqvmap](https://github.com/manifestinteractive/jqvmap) ⭐ 1,818 | 🐛 104 | 🌐 JavaScript | 📅 2021-03-28 - jQuery Vector Map Library.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,860 | 🐛 666 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,888 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-21 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [clappr](https://github.com/clappr/clappr) ⭐ 7,495 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-21 - An extensible media player for the web <http://clappr.io>
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,947 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,960 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A new and improved version of particles.js with bug fixes and many new features.
...
* [move.js](https://github.com/visionmedia/move.js) ⭐ 4,693 | 🐛 36 | 🌐 JavaScript | 📅 2022-03-11 - CSS3 backed JavaScript animation framework.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,988 | 🐛 775 | 🌐 TypeScript | 📅 2026-08-23 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,894 | 🐛 3,951 | 🌐 JavaScript | 📅 2026-08-23 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,054 | 🐛 401 | 🌐 TypeScript | 📅 2026-08-23 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 61,968 | 🐛 114 | 🌐 TypeScript | 📅 2026-08-23 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,784 | 🐛 540 | 🌐 TypeScript | 📅 2026-08-23 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,940 | 🐛 423 | 🌐 JavaScript | 📅 2026-08-21 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,469 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,276 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-21 - Static site generator for Deno.

## SDK

* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,133 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-22 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,485 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-22 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,779 | 🐛 36 | 🌐 JavaScript | 📅 2026-06-28 - It is a Next-Generation full text search library for Browser and Node.js.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,557 | 🐛 2,553 | 🌐 TypeScript | 📅 2026-08-23 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,632 | 🐛 624 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,556 | 🐛 1,980 | 🌐 TypeScript | 📅 2026-08-19 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,374 | 🐛 1,078 | 🌐 TypeScript | 📅 2026-08-16 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,472 | 🐛 174 | 🌐 JavaScript | 📅 2026-08-23 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,340 | 🐛 737 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,158 | 🐛 172 | 🌐 TypeScript | 📅 2026-08-17 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,180 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-23 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,195 | 🐛 195 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,539 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,328 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,067 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,037 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,849 | 🐛 495 | 🌐 TypeScript | 📅 2026-08-23 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [enum-plus](https://github.com/shijistar/enum-plus) ⭐ 204 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-22 - A drop-in enhancement for native TypeScript enums, adding display text, internationalization and full type safety.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,715 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [Functional-Light JavaScript](https://github.com/getify/Functional-Light-JS) ⭐ 16,739 | 🐛 27 | 🌐 JavaScript | 📅 2023-12-26 - Pragmatic, balanced FP in JavaScript.
* [braziljs/js-the-right-way](https://github.com/braziljs/js-the-right-way/) ⭐ 8,676 | 🐛 0 | 🌐 HTML | 📅 2026-07-29 - An easy-to-read, quick reference for JS best practices, accepted coding standards, and links around the Web.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 499,202 | 🐛 106 | 📅 2026-08-21
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,373 | 🐛 82 | 📅 2026-08-20
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,434 | 🐛 21 | 📅 2026-03-23
* [davidsonfellipe/awesome-wpo](https://github.com/davidsonfellipe/awesome-wpo) ⭐ 9,048 | 🐛 16 | 📅 2026-07-28
...
* [denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,409 | 🐛 2 | 📅 2026-08-14
* [addyosmani/es6-tools](https://github.com/addyosmani/es6-tools) ⭐ 3,972 | 🐛 14 | 📅 2019-10-31
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,647 | 🐛 91 | 📅 2025-07-20
