...
* [Bit](https://github.com/teambit/bit) ⭐ 18,455 | 🐛 103 | 🌐 TypeScript | 📅 2026-08-16 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,973 | 🐛 141 | 🌐 JavaScript | 📅 2026-08-16 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,023 | 🐛 600 | 🌐 JavaScript | 📅 2026-08-16 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,304 | 🐛 603 | 🌐 JavaScript | 📅 2026-08-16 - Next-generation ES6 module bundler.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,471 | 🐛 189 | 🌐 TypeScript | 📅 2026-08-15 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,672 | 🐛 250 | 🌐 TypeScript | 📅 2026-08-12 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,469 | 🐛 181 | 🌐 TypeScript | 📅 2026-08-16 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,904 | 🐛 257 | 🌐 JavaScript | 📅 2026-08-15 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,832 | 🐛 72 | 🌐 JavaScript | 📅 2026-06-17 - 🚀 Futuristic JavaScript test runner
* [jasmine](https://github.com/jasmine/jasmine) ⭐ 15,824 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-16 - DOM-less simple JavaScript testing framework.
...
* [react testing library](https://github.com/kentcdodds/react-testing-library) ⭐ 19,643 | 🐛 82 | 🌐 JavaScript | 📅 2026-04-02 - Simple and complete React DOM testing utilities that encourage good testing practices.
* [Supertest](https://github.com/visionmedia/supertest) ⭐ 14,391 | 🐛 190 | 🌐 JavaScript | 📅 2026-04-02 - A popular HTTP assertion library for testing REST APIs, often used with other testing frameworks like Mocha or Jest
* [Sinon.JS](https://github.com/sinonjs/sinon) ⭐ 9,757 | 🐛 57 | 🌐 JavaScript | 📅 2026-08-05 - Test spies, stubs, and mocks for JavaScript.
* [chai](https://github.com/chaijs/chai) ⭐ 8,267 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-10 - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,462 | 🐛 266 | 🌐 TypeScript | 📅 2026-08-16 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,583 | 🐛 154 | 🌐 TypeScript | 📅 2026-08-15 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [karma](https://github.com/karma-runner/karma) ⭐ 11,957 | 🐛 402 | 🌐 JavaScript | 📅 2026-06-10 - Spectacular Test Runner for JavaScript.
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,816 | 🐛 353 | 🌐 TypeScript | 📅 2026-08-15 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,204 | 🐛 1,425 | 🌐 JavaScript | 📅 2026-08-16 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,274 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,458 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-16 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,986 | 🐛 434 | 🌐 JavaScript | 📅 2026-08-11 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,338 | 🐛 3 | 🌐 Rust | 📅 2026-08-16 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,215 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,352 | 🐛 1,051 | 🌐 C++ | 📅 2026-08-16 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,003 | 🐛 1,175 | 🌐 TypeScript | 📅 2026-08-14 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,972 | 🐛 1,129 | 🌐 JavaScript | 📅 2026-08-16 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,812 | 🐛 411 | 🌐 JavaScript | 📅 2026-08-14 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,819 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-13 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,857 | 🐛 4 | 🌐 HTML | 📅 2026-08-14 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,133 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,604 | 🐛 832 | 🌐 TypeScript | 📅 2026-08-15 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,569 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-16 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,087 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-13 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,521 | 🐛 345 | 🌐 JavaScript | 📅 2026-08-15 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,203 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [Drawflow](https://github.com/jerosoler/Drawflow) ⭐ 6,103 | 🐛 272 | 🌐 JavaScript | 📅 2024-10-19 - This allow you to create data flows easily and quickly.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 72,938 | 🐛 542 | 🌐 TypeScript | 📅 2026-08-14 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,785 | 🐛 130 | 🌐 JavaScript | 📅 2026-08-16 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,942 | 🐛 142 | 🌐 TypeScript | 📅 2026-08-11 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,599 | 🐛 136 | 🌐 JavaScript | 📅 2026-08-15 - CMS with content editing and essential services.
...
* [marko](https://github.com/marko-js/marko) ⭐ 14,405 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-15 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,550 | 🐛 368 | 🌐 JavaScript | 📅 2026-08-16 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,459 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,646 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,081 | 🐛 1,559 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,387 | 🐛 466 | 🌐 TypeScript | 📅 2026-08-08 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
* [recharts](https://github.com/recharts/recharts) ⭐ 27,506 | 🐛 443 | 🌐 TypeScript | 📅 2026-08-16 - Redefined chart library built with React and D3.
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,934 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-14 - A framework for building 3D games with HTML 5 and WebGL.
* [Frappe Charts](https://github.com/frappe/charts) ⭐ 15,086 | 🐛 145 | 🌐 JavaScript | 📅 2025-07-02 - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
...
* [G2](https://github.com/antvis/G2) ⭐ 12,594 | 🐛 182 | 🌐 TypeScript | 📅 2026-07-15 - A highly interactive data-driven visualization grammar for statistical charts.
* [G6](https://github.com/antvis/g6) ⭐ 12,249 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,138 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-16 - A JavaScript library dedicated to graph drawing.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,165 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-14 - A fully featured graph theory library.
...
* [morris.js](https://github.com/morrisjs/morris.js) ⭐ 6,880 | 🐛 324 | 🌐 CoffeeScript | 📅 2021-10-07 - Pretty time-series line graphs.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,329 | 🐛 22 | 🌐 TypeScript | 📅 2026-06-01 - A next-generation declarative infographic visualization engine.
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,086 | 🐛 74 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,350 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-14 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [d3-cloud](https://github.com/jasondavies/d3-cloud) ⭐ 3,946 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-09 - Create word clouds in JavaScript.
...
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,435 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-15 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [quill](https://github.com/quilljs/quill) ⭐ 47,299 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
* [CodeMirror](https://github.com/codemirror/CodeMirror) ⚠️ Archived - In-browser code editor.
* [ace](https://github.com/ajaxorg/ace) ⭐ 27,141 | 🐛 140 | 🌐 JavaScript | 📅 2026-08-13 - Ace (Ajax.org Cloud9 Editor).
...
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,271 | 🐛 418 | 🌐 TypeScript | 📅 2026-08-16 - The JavaScript Rich Text editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,737 | 🐛 419 | 🌐 JavaScript | 📅 2026-08-16 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,274 | 🐛 120 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,543 | 🐛 224 | 🌐 JavaScript | 📅 2026-08-13 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 1,988 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-13 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,266 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
* [underscore](https://github.com/jashkenas/underscore) ⭐ 27,337 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript's utility \_ belt.
...
* [MobX](https://github.com/mobxjs/mobx) ⭐ 28,201 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-02 - TFRP library for simple, scalable state management.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,039 | 🐛 128 | 🌐 TypeScript | 📅 2026-08-16 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,666 | 🐛 1,297 | 🌐 JavaScript | 📅 2026-08-16 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
...
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,626 | 🐛 992 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,441 | 🐛 178 | 🌐 JavaScript | 📅 2026-08-09 - Luxon is a library for working with dates and times in JavaScript.
...
* [jquery-timeago](https://github.com/rmm5t/jquery-timeago) ⭐ 3,795 | 🐛 45 | 🌐 JavaScript | 📅 2026-08-02 - A jQuery plugin that makes it easy to support automatically updating fuzzy timestamps (e.g. "4 minutes ago").
...
* [localForage](https://github.com/mozilla/localForage) ⭐ 25,800 | 🐛 250 | 🌐 JavaScript | 📅 2024-07-30 - Offline storage, improved. Wraps IndexedDB, WebSQL, or localStorage using a simple but powerful API.
...
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,538 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-14 - Dexie.js is a wrapper library for indexedDB.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,307 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-16 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,206 | 🐛 64 | 🌐 JavaScript | 📅 2026-08-13 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,145 | 🐛 244 | 🌐 TypeScript | 📅 2026-08-16 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,457 | 🐛 213 | 🌐 TypeScript | 📅 2026-08-13 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,892 | 🐛 0 | 🌐 Vue | 📅 2026-08-14 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 161 | 🌐 Rust | 📅 2026-08-16 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,979 | 🐛 93 | 🌐 JavaScript | 📅 2026-08-16 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,709 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [is.js](https://github.com/arasatasaygin/is.js) ⭐ 9,070 | 🐛 47 | 🌐 JavaScript | 📅 2022-01-11 - Check types, regexps, presence, time and more.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,592 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,779 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-14 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,589 | 🐛 103 | 🌐 TypeScript | 📅 2026-08-16 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,131 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,879 | 🐛 253 | 🌐 TypeScript | 📅 2026-08-06 - Mobile touch slider and framework with hardware accelerated transitions.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,607 | 🐛 1,129 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
* [tui.calendar](https://github.com/nhn/tui.calendar) ⭐ 12,697 | 🐛 208 | 🌐 TypeScript | 📅 2024-06-24 - A JavaScript schedule calendar that is full featured. Now your service just got the customizable calendar.
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,529 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [lightGallery](https://github.com/sachinchoolur/lightGallery) ⭐ 7,045 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-07 - A customizable, modular, responsive, lightbox gallery plugin for jQuery.
...
* [fullPage](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,410 | 🐛 127 | 🌐 JavaScript | 📅 2026-03-17 - A simple and easy to use plugin to create fullscreen scrolling websites (also known as single page websites).
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,572 | 🐛 1,639 | 🌐 JavaScript | 📅 2026-08-15 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,465 | 🐛 165 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,876 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-16 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [ractive-player](https://github.com/ysulyma/ractive-player) ⭐ 813 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-16 - A library for making interactive videos in React.js.
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,737 | 🐛 79 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,756 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,202 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [barbajs](https://github.com/barbajs/barba) ⭐ 12,966 | 🐛 15 | 🌐 TypeScript | 📅 2024-12-02 - It helps you create fluid and smooth transitions between your website's pages.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,984 | 🐛 769 | 🌐 TypeScript | 📅 2026-08-16 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,799 | 🐛 4,210 | 🌐 JavaScript | 📅 2026-08-16 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 65,931 | 🐛 427 | 🌐 TypeScript | 📅 2026-08-13 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 61,811 | 🐛 123 | 🌐 TypeScript | 📅 2026-08-16 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,758 | 🐛 537 | 🌐 TypeScript | 📅 2026-08-16 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,942 | 🐛 420 | 🌐 JavaScript | 📅 2026-08-15 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,473 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,276 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-10 - Static site generator for Deno.
...
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,483 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-15 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,576 | 🐛 2,537 | 🌐 TypeScript | 📅 2026-08-14 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,631 | 🐛 614 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,494 | 🐛 1,952 | 🌐 TypeScript | 📅 2026-08-12 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
...
* [Knex](https://github.com/knex/knex) ⭐ 20,341 | 🐛 735 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,133 | 🐛 169 | 🌐 TypeScript | 📅 2026-08-14 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,171 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-16 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,195 | 🐛 188 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,468 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,278 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,040 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,026 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
* [list.js](https://github.com/javve/list.js) ⭐ 11,212 | 🐛 202 | 🌐 JavaScript | 📅 2025-04-27 - Adds search, sort, filters and flexibility to tables, lists and various HTML elements. Built to be invisible and work on existing HTML.
  <https://listjs.com>
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,840 | 🐛 502 | 🌐 TypeScript | 📅 2026-08-14 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,662 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 496,428 | 🐛 100 | 📅 2026-06-30
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,291 | 🐛 74 | 📅 2026-07-20
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,419 | 🐛 19 | 📅 2026-03-23
* [davidsonfellipe/awesome-wpo](https://github.com/davidsonfellipe/awesome-wpo) ⭐ 9,029 | 🐛 16 | 📅 2026-07-28
