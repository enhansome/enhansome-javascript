...
* [Bower](https://github.com/bower/bower) ⭐ 14,912 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-13 - A package manager for the web.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,457 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-19 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,971 | 🐛 138 | 🌐 JavaScript | 📅 2026-08-19 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,019 | 🐛 601 | 🌐 JavaScript | 📅 2026-08-17 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,306 | 🐛 604 | 🌐 JavaScript | 📅 2026-08-16 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,320 | 🐛 349 | 🌐 JavaScript | 📅 2026-08-14 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,491 | 🐛 159 | 🌐 TypeScript | 📅 2026-08-17 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,673 | 🐛 251 | 🌐 TypeScript | 📅 2026-08-12 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,469 | 🐛 178 | 🌐 TypeScript | 📅 2026-08-19 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,902 | 🐛 260 | 🌐 JavaScript | 📅 2026-08-19 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,832 | 🐛 72 | 🌐 JavaScript | 📅 2026-06-17 - 🚀 Futuristic JavaScript test runner
* [jasmine](https://github.com/jasmine/jasmine) ⭐ 15,822 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-18 - DOM-less simple JavaScript testing framework.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,907 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-12 - Automated browser testing for the modern web development stack.
...
* [react testing library](https://github.com/kentcdodds/react-testing-library) ⭐ 19,641 | 🐛 82 | 🌐 JavaScript | 📅 2026-04-02 - Simple and complete React DOM testing utilities that encourage good testing practices.
* [Supertest](https://github.com/visionmedia/supertest) ⭐ 14,393 | 🐛 190 | 🌐 JavaScript | 📅 2026-04-02 - A popular HTTP assertion library for testing REST APIs, often used with other testing frameworks like Mocha or Jest
* [Sinon.JS](https://github.com/sinonjs/sinon) ⭐ 9,756 | 🐛 58 | 🌐 JavaScript | 📅 2026-08-05 - Test spies, stubs, and mocks for JavaScript.
...
* [blanket](https://github.com/alex-seville/blanket) ⭐ 1,396 | 🐛 161 | 🌐 JavaScript | 📅 2022-12-06 - A simple code coverage library for JavaScript. Designed to be easy to install and use, for both browser and nodejs.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,466 | 🐛 265 | 🌐 TypeScript | 📅 2026-08-19 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,729 | 🐛 162 | 🌐 TypeScript | 📅 2026-08-19 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,818 | 🐛 294 | 🌐 TypeScript | 📅 2026-08-19 - Next-gen WebDriver test automation framework for Node.js.
...
* [taiko](https://github.com/getgauge/taiko) ⭐ 3,672 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-03 - A Node.js library with a simple API to automate Chromium based browsers.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,205 | 🐛 1,418 | 🌐 JavaScript | 📅 2026-08-18 - Prettier is an opinionated code formatter.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,461 | 🐛 127 | 🌐 JavaScript | 📅 2026-08-18 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,990 | 🐛 436 | 🌐 JavaScript | 📅 2026-08-17 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,352 | 🐛 3 | 🌐 Rust | 📅 2026-08-19 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,239 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,363 | 🐛 1,049 | 🌐 C++ | 📅 2026-08-19 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,006 | 🐛 1,142 | 🌐 TypeScript | 📅 2026-08-19 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,980 | 🐛 1,133 | 🌐 JavaScript | 📅 2026-08-19 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,809 | 🐛 409 | 🌐 JavaScript | 📅 2026-08-19 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,823 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-17 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,864 | 🐛 3 | 🌐 HTML | 📅 2026-08-18 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,143 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,608 | 🐛 835 | 🌐 TypeScript | 📅 2026-08-19 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,567 | 🐛 262 | 🌐 TypeScript | 📅 2026-08-19 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,093 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-13 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,522 | 🐛 339 | 🌐 JavaScript | 📅 2026-08-18 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,221 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [Drawflow](https://github.com/jerosoler/Drawflow) ⭐ 6,105 | 🐛 272 | 🌐 JavaScript | 📅 2024-10-19 - This allow you to create data flows easily and quickly.
...
* [Remult](https://github.com/remult/remult) ⭐ 3,207 | 🐛 118 | 🌐 TypeScript | 📅 2026-08-18 - A CRUD framework for full-stack TypeScript.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 72,967 | 🐛 551 | 🌐 TypeScript | 📅 2026-08-19 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,796 | 🐛 128 | 🌐 JavaScript | 📅 2026-08-19 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,958 | 🐛 143 | 🌐 TypeScript | 📅 2026-08-18 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,599 | 🐛 135 | 🌐 JavaScript | 📅 2026-08-19 - CMS with content editing and essential services.
* [PencilBlue](https://github.com/pencilblue/pencilblue/) ⭐ 1,567 | 🐛 62 | 🌐 JavaScript | 📅 2021-12-09 - CMS and blogging platform.
* [Factor](https://github.com/fiction-com/factor) ⭐ 1,463 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-16 - The Javascript CMS
...
* [marko](https://github.com/marko-js/marko) ⭐ 14,406 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-19 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,609 | 🐛 371 | 🌐 JavaScript | 📅 2026-08-19 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,493 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,642 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,093 | 🐛 1,555 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,392 | 🐛 468 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
* [recharts](https://github.com/recharts/recharts) ⭐ 27,507 | 🐛 436 | 🌐 TypeScript | 📅 2026-08-19 - Redefined chart library built with React and D3.
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,946 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-14 - A framework for building 3D games with HTML 5 and WebGL.
* [Frappe Charts](https://github.com/frappe/charts) ⭐ 15,083 | 🐛 145 | 🌐 JavaScript | 📅 2025-07-02 - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
...
* [G2](https://github.com/antvis/G2) ⭐ 12,591 | 🐛 182 | 🌐 TypeScript | 📅 2026-07-15 - A highly interactive data-driven visualization grammar for statistical charts.
* [G6](https://github.com/antvis/g6) ⭐ 12,260 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,140 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-18 - A JavaScript library dedicated to graph drawing.
* [svg.js](https://github.com/wout/svg.js) ⭐ 11,819 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-04 - A lightweight library for manipulating and animating SVG.
* [raphael](https://github.com/DmitryBaranovskiy/raphael) ⭐ 11,270 | 🐛 347 | 🌐 JavaScript | 📅 2024-01-12 - JavaScript Vector Library.
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,170 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-14 - A fully featured graph theory library.
...
* [morris.js](https://github.com/morrisjs/morris.js) ⭐ 6,880 | 🐛 323 | 🌐 CoffeeScript | 📅 2021-10-07 - Pretty time-series line graphs.
* [rickshaw](https://github.com/shutterstock/rickshaw) ⭐ 6,507 | 🐛 203 | 🌐 JavaScript | 📅 2025-01-17 - JavaScript toolkit for creating interactive real-time graphs.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,361 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-19 - A next-generation declarative infographic visualization engine.
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,091 | 🐛 76 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,353 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-18 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,023 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-19 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [Jspreadsheet CE](https://github.com/jspreadsheet/ce) ⭐ 7,214 | 🐛 151 | 🌐 JavaScript | 📅 2026-04-10 - Jspreadsheet is a lightweight vanilla javascript plugin to create amazing web-based interactive tables and spreadsheets compatible with other spreadsheet software.
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,436 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-18 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [quill](https://github.com/quilljs/quill) ⭐ 47,305 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
* [CodeMirror](https://github.com/codemirror/CodeMirror) ⚠️ Archived - In-browser code editor.
* [ace](https://github.com/ajaxorg/ace) ⭐ 27,141 | 🐛 139 | 🌐 JavaScript | 📅 2026-08-13 - Ace (Ajax.org Cloud9 Editor).
* [Draft.js](https://github.com/facebook/draft-js) ⚠️ Archived - A React framework for building text editors.
* [trix](https://github.com/basecamp/trix) ⭐ 19,998 | 🐛 184 | 🌐 JavaScript | 📅 2026-08-11 - A rich text editor for everyday writing. By Basecamp.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,271 | 🐛 412 | 🌐 TypeScript | 📅 2026-08-17 - The JavaScript Rich Text editor.
...
* [Trumbowyg](https://github.com/Alex-D/Trumbowyg) ⭐ 4,152 | 🐛 120 | 🌐 JavaScript | 📅 2026-06-20 - A lightweight and amazing WYSIWYG JavaScript editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,752 | 🐛 413 | 🌐 JavaScript | 📅 2026-08-19 - PDF Reader in JavaScript.
...
* [diff2html](https://github.com/rtfpessoa/diff2html) ⭐ 3,396 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-08 - Git diff output parser and pretty HTML generator.
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,011 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-19 - Browser-native components for previewing files without server-side conversion.
...
* [ramda](https://github.com/ramda/ramda) ⭐ 24,060 | 🐛 146 | 🌐 JavaScript | 📅 2026-07-26 - A practical functional library for JavaScript programmers.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,698 | 🐛 179 | 🌐 TypeScript | 📅 2026-08-08 - A reactive programming library for JavaScript.
* [MobX](https://github.com/mobxjs/mobx) ⭐ 28,203 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-19 - TFRP library for simple, scalable state management.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,039 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-17 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,666 | 🐛 1,298 | 🌐 JavaScript | 📅 2026-08-18 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 47,915 | 🐛 190 | 🌐 JavaScript | 📅 2026-08-19 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,631 | 🐛 995 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
...
* [ms.js](https://github.com/rauchg/ms.js) ⭐ 5,545 | 🐛 35 | 🌐 TypeScript | 📅 2026-05-20 - Tiny millisecond conversion utility.
...
* [moment-timezone](https://github.com/moment/moment-timezone) ⭐ 3,877 | 🐛 75 | 🌐 JavaScript | 📅 2026-07-19 - Timezone support for moment.js.
...
* [localForage](https://github.com/mozilla/localForage) ⭐ 25,803 | 🐛 250 | 🌐 JavaScript | 📅 2024-07-30 - Offline storage, improved. Wraps IndexedDB, WebSQL, or localStorage using a simple but powerful API.
* [js-cookie](https://github.com/js-cookie/js-cookie) ⭐ 22,594 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-10 - A simple, lightweight JavaScript API for handling browser cookies.
...
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,536 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-17 - Dexie.js is a wrapper library for indexedDB.
...
* [Hoodie](https://github.com/hoodiehq/hoodie) ⭐ 4,457 | 🐛 97 | 🌐 JavaScript | 📅 2024-07-27 - Offline First backend to work in browser without internet connectivity.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,619 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-09 - internationalisation (i18n) with JavaScript the easy way.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,315 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,198 | 🐛 71 | 🌐 JavaScript | 📅 2026-08-18 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,164 | 🐛 175 | 🌐 TypeScript | 📅 2026-08-19 - Hooks for fetching, caching and updating asynchronous data in React.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,899 | 🐛 0 | 🌐 Vue | 📅 2026-08-19 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [ConvNetJS](https://github.com/karpathy/convnetjs) ⭐ 11,195 | 🐛 76 | 🌐 JavaScript | 📅 2023-01-07 - Deep Learning in JavaScript. Train Convolutional Neural Networks (or ordinary ones) in your browser.
...
* [partytown](https://github.com/BuilderIO/partytown) ⭐ 13,755 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-03 - Relocate resource intensive third-party scripts off of the main thread and into a web worker.
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,781 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-11 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [worker-dom](https://github.com/ampproject/worker-dom) ⭐ 3,264 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-19 - An in-progress implementation of the DOM API intended to run within a Web Worker.
...
* [clooney](https://github.com/GoogleChromeLabs/clooney) ⭐ 1,419 | 🐛 40 | 🌐 JavaScript | 📅 2026-07-02 - Clooney is an actor library for the web. Use workers without thinking about workers.

## Code highlighting

* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,980 | 🐛 89 | 🌐 JavaScript | 📅 2026-08-19 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,716 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
* [PrismJS](https://github.com/PrismJS/prism) ⭐ 13,036 | 🐛 483 | 🌐 JavaScript | 📅 2026-06-29 - Lightweight, robust, elegant syntax highlighting.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,602 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,782 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-17 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,615 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-19 - Open-source notification infrastructure for products.
* [toastr](https://github.com/CodeSeven/toastr) ⭐ 12,104 | 🐛 154 | 🌐 JavaScript | 📅 2023-02-27 - Simple JavaScript toast notifications.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,150 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - A framework for easily creating beautiful presentations using HTML.
...
* [PhotoSwipe](https://github.com/dimsemenov/PhotoSwipe) ⭐ 25,238 | 🐛 170 | 🌐 JavaScript | 📅 2025-12-04 - JavaScript image gallery for mobile and desktop, modular, framework independent.
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,390 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-11 - An extensible low level carousel for the web, written in TypeScript.
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,532 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [select2](https://github.com/select2/select2) ⭐ 25,913 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-17 - a jQuery based replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results.
...
* [dropzone](https://github.com/enyo/dropzone) ⭐ 18,380 | 🐛 149 | 🌐 JavaScript | 📅 2024-07-15 - Dropzone is an easy to use drag'n'drop library. It supports image previews and shows nice progress bars.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,594 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-10 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
* [Wasp](https://github.com/wasp-lang/wasp) ⭐ 18,692 | 🐛 852 | 🌐 TypeScript | 📅 2026-08-19 Wasp is a declarative domain-specific language for developing, building, and deploying modern Javascript full-stack web apps with less code.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,494 | 🐛 561 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,582 | 🐛 1,645 | 🌐 JavaScript | 📅 2026-08-18 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,472 | 🐛 165 | 🌐 C | 📅 2026-08-17 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,860 | 🐛 664 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,877 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-19 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [clappr](https://github.com/clappr/clappr) ⭐ 7,494 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 - An extensible media player for the web <http://clappr.io>
...
* [ractive-player](https://github.com/ysulyma/ractive-player) ⭐ 814 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-17 - A library for making interactive videos in React.js.
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,735 | 🐛 79 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,833 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,199 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [barbajs](https://github.com/barbajs/barba) ⭐ 12,967 | 🐛 15 | 🌐 TypeScript | 📅 2024-12-02 - It helps you create fluid and smooth transitions between your website's pages.
* [Effeckt.css](https://github.com/h5bp/Effeckt.css) ⚠️ Archived - A Performant Transitions and Animations Library.
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,956 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A new and improved version of particles.js with bug fixes and many new features.
...
* [pica](https://github.com/nodeca/pica) ⭐ 4,141 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-15 - High quality image resize (with fast Lanczos filter, implemented in pure JS).
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,987 | 🐛 771 | 🌐 TypeScript | 📅 2026-08-16 - Turn ES6+ code into vanilla ES5 with no runtime.
* [es6features](https://github.com/lukehoban/es6features) ⭐ 29,035 | 🐛 38 | 📅 2023-01-27 - Overview of ECMAScript 6 features.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,864 | 🐛 4,087 | 🌐 JavaScript | 📅 2026-08-19 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 65,991 | 🐛 431 | 🌐 TypeScript | 📅 2026-08-13 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 61,862 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-19 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,763 | 🐛 539 | 🌐 TypeScript | 📅 2026-08-19 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,943 | 🐛 422 | 🌐 JavaScript | 📅 2026-08-19 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,470 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,274 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-10 - Static site generator for Deno.

## SDK

* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,125 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-19 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,484 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-19 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,775 | 🐛 36 | 🌐 JavaScript | 📅 2026-06-28 - It is a Next-Generation full text search library for Browser and Node.js.
...
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,632 | 🐛 620 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,517 | 🐛 1,956 | 🌐 TypeScript | 📅 2026-08-19 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,371 | 🐛 1,075 | 🌐 TypeScript | 📅 2026-08-16 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,472 | 🐛 173 | 🌐 JavaScript | 📅 2026-08-19 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,340 | 🐛 736 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,134 | 🐛 172 | 🌐 TypeScript | 📅 2026-08-17 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,176 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-19 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
* [Objection.js](https://github.com/Vincit/objection.js) ⭐ 7,344 | 🐛 135 | 🌐 JavaScript | 📅 2026-06-23 A SQL-friendly ORM for Node.js built on top of Knex.js, with powerful relational support.

## WebSockets

* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,190 | 🐛 191 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
* [ws](https://github.com/websockets/ws) ⭐ 22,790 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-13 Simple to use, blazing fast and thoroughly tested WebSocket client and server for Node.js.

## Generative AI

* [KaibanJS](https://github.com/kaiban-ai/KaibanJS) ⭐ 1,470 | 🐛 79 | 🌐 TypeScript | 📅 2026-05-15 - KaibanJS is an open-source framework browser-compatibility of orchestration of multi-agent ai systems using a Kanban-inspired architecture.

## Misc

* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,522 | 🐛 405 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,297 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,052 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,030 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,843 | 🐛 490 | 🌐 TypeScript | 📅 2026-08-19 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [enum-plus](https://github.com/shijistar/enum-plus) ⭐ 202 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-18 - A drop-in enhancement for native TypeScript enums, adding display text, internationalization and full type safety.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,711 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 497,664 | 🐛 102 | 📅 2026-08-18
...
* [bolshchikov/js-must-watch](https://github.com/bolshchikov/js-must-watch) ⭐ 13,602 | 🐛 0 | 📅 2022-01-20
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,422 | 🐛 21 | 📅 2026-03-23
...
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,643 | 🐛 90 | 📅 2025-07-20
