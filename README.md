...
* [Bit](https://github.com/teambit/bit) ⭐ 18,456 | 🐛 100 | 🌐 TypeScript | 📅 2026-08-18 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,967 | 🐛 139 | 🌐 JavaScript | 📅 2026-08-18 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,018 | 🐛 601 | 🌐 JavaScript | 📅 2026-08-17 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,303 | 🐛 604 | 🌐 JavaScript | 📅 2026-08-16 - Next-generation ES6 module bundler.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 43,484 | 🐛 159 | 🌐 TypeScript | 📅 2026-08-17 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,673 | 🐛 250 | 🌐 TypeScript | 📅 2026-08-12 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,468 | 🐛 178 | 🌐 TypeScript | 📅 2026-08-18 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,901 | 🐛 257 | 🌐 JavaScript | 📅 2026-08-17 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
...
* [Supertest](https://github.com/visionmedia/supertest) ⭐ 14,392 | 🐛 190 | 🌐 JavaScript | 📅 2026-04-02 - A popular HTTP assertion library for testing REST APIs, often used with other testing frameworks like Mocha or Jest
* [Sinon.JS](https://github.com/sinonjs/sinon) ⭐ 9,756 | 🐛 57 | 🌐 JavaScript | 📅 2026-08-05 - Test spies, stubs, and mocks for JavaScript.
* [chai](https://github.com/chaijs/chai) ⭐ 8,267 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-17 - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,459 | 🐛 262 | 🌐 TypeScript | 📅 2026-08-18 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,685 | 🐛 161 | 🌐 TypeScript | 📅 2026-08-18 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
* [phantomjs](https://github.com/ariya/phantomjs) ⚠️ Archived - Scriptable Headless WebKit.
* [karma](https://github.com/karma-runner/karma) ⭐ 11,960 | 🐛 402 | 🌐 JavaScript | 📅 2026-06-10 - Spectacular Test Runner for JavaScript.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,816 | 🐛 291 | 🌐 TypeScript | 📅 2026-08-18 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,203 | 🐛 1,421 | 🌐 JavaScript | 📅 2026-08-18 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,278 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
* [JavaScript Standard Style](https://github.com/feross/standard) ⭐ 29,426 | 🐛 130 | 🌐 JavaScript | 📅 2025-07-11 - Opinionated, no-configuration style guide, style checker, and formatter
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,457 | 🐛 127 | 🌐 JavaScript | 📅 2026-08-18 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,985 | 🐛 436 | 🌐 JavaScript | 📅 2026-08-17 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,348 | 🐛 11 | 🌐 Rust | 📅 2026-08-18 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [react-native](https://github.com/facebook/react-native) ⭐ 126,356 | 🐛 1,049 | 🌐 C++ | 📅 2026-08-18 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,005 | 🐛 1,139 | 🌐 TypeScript | 📅 2026-08-18 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,969 | 🐛 1,132 | 🌐 JavaScript | 📅 2026-08-18 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,810 | 🐛 410 | 🌐 JavaScript | 📅 2026-08-18 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,818 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-17 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,863 | 🐛 5 | 🌐 HTML | 📅 2026-08-17 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
* [backbone](https://github.com/jashkenas/backbone) ⭐ 28,099 | 🐛 65 | 🌐 JavaScript | 📅 2026-07-29 - Give your JS App some Backbone with Models, Views, Collections, and Events.
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,135 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,605 | 🐛 833 | 🌐 TypeScript | 📅 2026-08-17 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,568 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-18 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,091 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-13 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,522 | 🐛 340 | 🌐 JavaScript | 📅 2026-08-18 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,218 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 72,960 | 🐛 553 | 🌐 TypeScript | 📅 2026-08-18 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,792 | 🐛 122 | 🌐 JavaScript | 📅 2026-08-18 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,949 | 🐛 143 | 🌐 TypeScript | 📅 2026-08-18 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,599 | 🐛 137 | 🌐 JavaScript | 📅 2026-08-18 - CMS with content editing and essential services.
...
* [marko](https://github.com/marko-js/marko) ⭐ 14,406 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-18 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,588 | 🐛 368 | 🌐 JavaScript | 📅 2026-08-18 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,484 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,640 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,091 | 🐛 1,556 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,392 | 🐛 467 | 🌐 TypeScript | 📅 2026-08-08 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
* [recharts](https://github.com/recharts/recharts) ⭐ 27,505 | 🐛 438 | 🌐 TypeScript | 📅 2026-08-18 - Redefined chart library built with React and D3.
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,942 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-14 - A framework for building 3D games with HTML 5 and WebGL.
* [Frappe Charts](https://github.com/frappe/charts) ⭐ 15,084 | 🐛 145 | 🌐 JavaScript | 📅 2025-07-02 - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
...
* [G2](https://github.com/antvis/G2) ⭐ 12,590 | 🐛 182 | 🌐 TypeScript | 📅 2026-07-15 - A highly interactive data-driven visualization grammar for statistical charts.
* [G6](https://github.com/antvis/g6) ⭐ 12,257 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,166 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-14 - A fully featured graph theory library.
...
* [c3](https://github.com/c3js/c3) ⭐ 9,346 | 🐛 771 | 🌐 JavaScript | 📅 2026-08-05 - D3-based reusable chart library.
* [two.js](https://github.com/jonobr1/two.js) ⭐ 8,648 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-05 - A renderer agnostic two-dimensional drawing api for the web.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,357 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-18 - A next-generation declarative infographic visualization engine.
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,089 | 🐛 76 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
...
* [vizzu](https://github.com/vizzuhq/vizzu-lib) ⭐ 2,019 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-20 - Library for animated data visualizations and data stories.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,021 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-18 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [quill](https://github.com/quilljs/quill) ⭐ 47,300 | 🐛 659 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
* [CodeMirror](https://github.com/codemirror/CodeMirror) ⚠️ Archived - In-browser code editor.
* [ace](https://github.com/ajaxorg/ace) ⭐ 27,142 | 🐛 140 | 🌐 JavaScript | 📅 2026-08-13 - Ace (Ajax.org Cloud9 Editor).
...
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,270 | 🐛 412 | 🌐 TypeScript | 📅 2026-08-17 - The JavaScript Rich Text editor.
* [medium-editor](https://github.com/yabwe/medium-editor) ⭐ 16,106 | 🐛 359 | 🌐 JavaScript | 📅 2024-10-24 - Medium.com WYSIWYG editor clone.
* [jsoneditor](https://github.com/josdejong/jsoneditor) ⭐ 12,262 | 🐛 233 | 🌐 JavaScript | 📅 2026-08-15 - A web-based tool to view, edit and format JSON.
* [Summernote](https://github.com/summernote/summernote) ⭐ 11,831 | 🐛 118 | 🌐 JavaScript | 📅 2026-04-15 - Super simple WYSIWYG editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,745 | 🐛 415 | 🌐 JavaScript | 📅 2026-08-18 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,275 | 🐛 119 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,003 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-18 - Browser-native components for previewing files without server-side conversion.
...
* [underscore](https://github.com/jashkenas/underscore) ⭐ 27,332 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript's utility \_ belt.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,701 | 🐛 179 | 🌐 TypeScript | 📅 2026-08-08 - A reactive programming library for JavaScript.
* [MobX](https://github.com/mobxjs/mobx) ⭐ 28,202 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-17 - TFRP library for simple, scalable state management.
...
* [moment](https://github.com/moment/moment) ⭐ 47,915 | 🐛 196 | 🌐 JavaScript | 📅 2026-08-18 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,628 | 🐛 995 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
...
* [tempo](https://github.com/formkit/tempo) ⭐ 2,588 | 🐛 12 | 🌐 TypeScript | 📅 2026-07-01 - Parsing, formatting, and timezones — Tempo is a small tree-shakable library for native Date objects.
...
* [localForage](https://github.com/mozilla/localForage) ⭐ 25,801 | 🐛 250 | 🌐 JavaScript | 📅 2024-07-30 - Offline storage, improved. Wraps IndexedDB, WebSQL, or localStorage using a simple but powerful API.
* [js-cookie](https://github.com/js-cookie/js-cookie) ⭐ 22,595 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-10 - A simple, lightweight JavaScript API for handling browser cookies.
* [pouchdb](https://github.com/pouchdb/pouchdb) ⭐ 17,597 | 🐛 186 | 🌐 JavaScript | 📅 2026-07-27 - Javascript db inspired by Apache CouchDB to run well within the browser.
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,535 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-17 - Dexie.js is a wrapper library for indexedDB.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,617 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-09 - internationalisation (i18n) with JavaScript the easy way.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,311 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-18 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,197 | 🐛 69 | 🌐 JavaScript | 📅 2026-08-18 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,152 | 🐛 179 | 🌐 TypeScript | 📅 2026-08-18 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,455 | 🐛 215 | 🌐 TypeScript | 📅 2026-08-13 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,898 | 🐛 0 | 🌐 Vue | 📅 2026-08-18 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [os.js](https://github.com/os-js/OS.js) ⭐ 7,077 | 🐛 20 | 🌐 JavaScript | 📅 2022-12-12 - An open-source web desktop platform with a window manager, application APIs, GUI toolkit, filesystem abstractions and much more.

## Benchmark

* [benchmark.js](https://github.com/bestiejs/benchmark.js) ⚠️ Archived - A benchmarking library. As used on jsPerf.com.
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 164 | 🌐 Rust | 📅 2026-08-18 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [partytown](https://github.com/BuilderIO/partytown) ⭐ 13,754 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-03 - Relocate resource intensive third-party scripts off of the main thread and into a web worker.
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,780 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-11 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [worker-dom](https://github.com/ampproject/worker-dom) ⭐ 3,264 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-13 - An in-progress implementation of the DOM API intended to run within a Web Worker.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,980 | 🐛 92 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,714 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,600 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,780 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-17 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,605 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-18 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,145 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,880 | 🐛 253 | 🌐 TypeScript | 📅 2026-08-06 - Mobile touch slider and framework with hardware accelerated transitions.
...
* [slick](https://github.com/kenwheeler/slick) ⭐ 28,558 | 🐛 1,317 | 🌐 JavaScript | 📅 2026-08-01 - The last carousel you'll ever need.
* [PhotoSwipe](https://github.com/dimsemenov/PhotoSwipe) ⭐ 25,237 | 🐛 170 | 🌐 JavaScript | 📅 2025-12-04 - JavaScript image gallery for mobile and desktop, modular, framework independent.
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,389 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-11 - An extensible low level carousel for the web, written in TypeScript.
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,531 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [select2](https://github.com/select2/select2) ⭐ 25,912 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-17 - a jQuery based replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results.
...
* [filepond](https://github.com/pqina/filepond) ⭐ 16,388 | 🐛 140 | 🌐 JavaScript | 📅 2026-07-13 - A JavaScript library that can upload anything you throw at it, optimizes images for faster uploads, and offers a great, accessible, silky smooth user experience.
...
* [hint.css](https://github.com/chinchang/hint.css) ⭐ 8,430 | 🐛 54 | 🌐 CSS | 📅 2024-10-17 - A tooltip library in CSS for your lovely websites.
...
* [SweetAlert2](https://github.com/sweetalert2/sweetalert2) ⭐ 18,100 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-20 - An awesome replacement for JavaScript's alert.
...
* [vex](https://github.com/HubSpot/vex) ⭐ 6,873 | 🐛 54 | 🌐 CSS | 📅 2023-02-26 - A modern dialog library which is highly configurable and easy to style.
...
* [parallax](https://github.com/wagerfield/parallax) ⭐ 16,579 | 🐛 11 | 🌐 JavaScript | 📅 2024-04-06 - Parallax Engine that reacts to the orientation of a smart device.
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,842 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-30 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,592 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-10 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
...
* [Dragula](https://github.com/bevacqua/dragula/) ⭐ 22,141 | 🐛 159 | 🌐 JavaScript | 📅 2024-06-07 - Drag and drop so simple it hurts.
* [touchemulator](https://github.com/hammerjs/touchemulator) ⭐ 406 | 🐛 17 | 🌐 JavaScript | 📅 2022-11-17 - Emulate touch input on your desktop.

## Maps

* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,491 | 🐛 561 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,577 | 🐛 1,640 | 🌐 JavaScript | 📅 2026-08-18 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,469 | 🐛 165 | 🌐 C | 📅 2026-08-17 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,862 | 🐛 664 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,877 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-18 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [ractive-player](https://github.com/ysulyma/ractive-player) ⭐ 813 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-17 - A library for making interactive videos in React.js.
...
* [circletype](https://github.com/peterhry/circletype) ⭐ 698 | 🐛 1 | 🌐 JavaScript | 📅 2026-01-20 - A jQuery plugin that lets you curve type on the web.
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,732 | 🐛 79 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,800 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,953 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A new and improved version of particles.js with bug fixes and many new features.
...
* [jquery.transit](https://github.com/rstacruz/jquery.transit) ⭐ 7,234 | 🐛 135 | 🌐 JavaScript | 📅 2022-01-18 - Super-smooth CSS3 transformations and transitions for jQuery.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,983 | 🐛 769 | 🌐 TypeScript | 📅 2026-08-16 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,849 | 🐛 4,148 | 🌐 JavaScript | 📅 2026-08-18 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 65,951 | 🐛 430 | 🌐 TypeScript | 📅 2026-08-13 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 61,846 | 🐛 133 | 🌐 TypeScript | 📅 2026-08-18 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,761 | 🐛 541 | 🌐 TypeScript | 📅 2026-08-18 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,943 | 🐛 421 | 🌐 JavaScript | 📅 2026-08-15 - React-based static site generator.
...
* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,123 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-18 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,484 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-18 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,566 | 🐛 2,538 | 🌐 TypeScript | 📅 2026-08-18 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,631 | 🐛 619 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,506 | 🐛 1,956 | 🌐 TypeScript | 📅 2026-08-18 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,373 | 🐛 1,075 | 🌐 TypeScript | 📅 2026-08-16 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,471 | 🐛 174 | 🌐 JavaScript | 📅 2026-08-18 MongoDB object modeling designed to work in an asynchronous environment.
...
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,133 | 🐛 170 | 🌐 TypeScript | 📅 2026-08-17 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,174 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-17 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,189 | 🐛 191 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
* [ws](https://github.com/websockets/ws) ⭐ 22,791 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-13 Simple to use, blazing fast and thoroughly tested WebSocket client and server for Node.js.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,511 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,290 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,051 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,029 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,843 | 🐛 488 | 🌐 TypeScript | 📅 2026-08-18 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 497,303 | 🐛 102 | 📅 2026-08-18
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,318 | 🐛 79 | 📅 2026-07-20
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,423 | 🐛 21 | 📅 2026-03-23
...
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,642 | 🐛 89 | 📅 2025-07-20
