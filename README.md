...
* [Bower](https://github.com/bower/bower) ⭐ 14,909 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-13 - A package manager for the web.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,468 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-31 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [SeaJS](https://github.com/seajs/seajs) ⭐ 8,258 | 🐛 157 | 🌐 JavaScript | 📅 2023-07-03 - A Module Loader for the Web.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,962 | 🐛 146 | 🌐 JavaScript | 📅 2026-08-31 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,023 | 🐛 605 | 🌐 JavaScript | 📅 2026-08-30 - Blazing fast, zero configuration web application bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,327 | 🐛 352 | 🌐 JavaScript | 📅 2026-08-27 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,728 | 🐛 80 | 🌐 TypeScript | 📅 2026-08-31 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,673 | 🐛 252 | 🌐 TypeScript | 📅 2026-08-30 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,476 | 🐛 191 | 🌐 TypeScript | 📅 2026-08-31 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,908 | 🐛 266 | 🌐 JavaScript | 📅 2026-08-31 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
...
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,905 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-20 - Automated browser testing for the modern web development stack.
...
* [react testing library](https://github.com/kentcdodds/react-testing-library) ⭐ 19,644 | 🐛 81 | 🌐 JavaScript | 📅 2026-08-27 - Simple and complete React DOM testing utilities that encourage good testing practices.
...
* [Sinon.JS](https://github.com/sinonjs/sinon) ⭐ 9,759 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-05 - Test spies, stubs, and mocks for JavaScript.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,531 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-31 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,436 | 🐛 177 | 🌐 TypeScript | 📅 2026-08-31 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,831 | 🐛 294 | 🌐 TypeScript | 📅 2026-08-31 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,229 | 🐛 1,419 | 🌐 JavaScript | 📅 2026-08-31 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,299 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
* [JavaScript Standard Style](https://github.com/feross/standard) ⭐ 29,437 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11 - Opinionated, no-configuration style guide, style checker, and formatter
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,495 | 🐛 140 | 🌐 JavaScript | 📅 2026-08-31 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,992 | 🐛 439 | 🌐 JavaScript | 📅 2026-08-17 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,436 | 🐛 9 | 🌐 Rust | 📅 2026-08-31 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 254 | 🐛 3 | 🌐 Go | 📅 2026-08-07 - Trace imports, identify circular dependencies, find unused code, clean node modules — all from a blazing-fast CLI.
...
* [vue](https://github.com/vuejs/vue) ⭐ 211,014 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,467 | 🐛 1,172 | 🌐 C++ | 📅 2026-08-31 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,020 | 🐛 1,155 | 🌐 TypeScript | 📅 2026-08-31 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 88,034 | 🐛 1,050 | 🌐 JavaScript | 📅 2026-08-31 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,812 | 🐛 350 | 🌐 JavaScript | 📅 2026-08-31 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,847 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-29 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,898 | 🐛 2 | 🌐 HTML | 📅 2026-08-31 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,179 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-26 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,634 | 🐛 834 | 🌐 TypeScript | 📅 2026-08-31 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,568 | 🐛 267 | 🌐 TypeScript | 📅 2026-08-31 - A JavaScript framework for creating ambitious web applications.
...
* [mithril.js](https://github.com/lhorie/mithril.js) ⭐ 14,494 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13 - Mithril is a client-side MVC framework (Light-weight, Robust, Fast).
* [Blockly](https://github.com/google/blockly) ⭐ 13,543 | 🐛 382 | 🌐 JavaScript | 📅 2026-08-31 - A library that adds a visual code editor to web and mobile apps by Google.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 8,121 | 🐛 146 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 73,050 | 🐛 554 | 🌐 TypeScript | 📅 2026-08-31 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,094 | 🐛 139 | 🌐 JavaScript | 📅 2026-08-31 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,965 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-31 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,610 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-31 - CMS with content editing and essential services.
...
* [Pug](https://github.com/pugjs/pug) ⭐ 21,853 | 🐛 333 | 🌐 JavaScript | 📅 2026-03-13 - Robust, elegant, feature rich template engine for nodejs. (formerly known as Jade)
* [handlebars.js](https://github.com/handlebars-lang/handlebars.js) ⭐ 18,670 | 🐛 115 | 🌐 JavaScript | 📅 2026-06-24 - An extension to the Mustache templating language.
...
* [marko](https://github.com/marko-js/marko) ⭐ 14,411 | 🐛 34 | 🌐 JavaScript | 📅 2026-08-31 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,983 | 🐛 374 | 🌐 JavaScript | 📅 2026-08-31 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,584 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,676 | 🐛 586 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,206 | 🐛 1,522 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,418 | 🐛 468 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
* [recharts](https://github.com/recharts/recharts) ⭐ 27,528 | 🐛 444 | 🌐 TypeScript | 📅 2026-08-31 - Redefined chart library built with React and D3.
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 26,000 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-31 - A framework for building 3D games with HTML 5 and WebGL.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,278 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,154 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-20 - A JavaScript library dedicated to graph drawing.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,194 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-28 - A fully featured graph theory library.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,478 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-21 - A next-generation declarative infographic visualization engine.
...
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,100 | 🐛 77 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
...
* [epoch](https://github.com/epochjs/epoch) ⭐ 4,948 | 🐛 69 | 🌐 HTML | 📅 2019-02-14 - A general purpose real-time charting library.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,030 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-31 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,439 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-31 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [trix](https://github.com/basecamp/trix) ⭐ 20,009 | 🐛 184 | 🌐 JavaScript | 📅 2026-08-30 - A rich text editor for everyday writing. By Basecamp.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,286 | 🐛 415 | 🌐 TypeScript | 📅 2026-08-31 - The JavaScript Rich Text editor.
...
* [Summernote](https://github.com/summernote/summernote) ⭐ 11,836 | 🐛 120 | 🌐 JavaScript | 📅 2026-04-15 - Super simple WYSIWYG editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,807 | 🐛 417 | 🌐 JavaScript | 📅 2026-08-31 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,296 | 🐛 116 | 🌐 JavaScript | 📅 2026-08-28 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,555 | 🐛 215 | 🌐 JavaScript | 📅 2026-08-24 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,180 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-31 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,280 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
* [underscore](https://github.com/jashkenas/underscore) ⭐ 27,328 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript's utility \_ belt.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,040 | 🐛 130 | 🌐 TypeScript | 📅 2026-08-27 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,664 | 🐛 1,308 | 🌐 JavaScript | 📅 2026-08-31 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
...
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,645 | 🐛 1,003 | 🌐 TypeScript | 📅 2026-08-30 - Modern JavaScript date utility library.
...
* [query-string](https://github.com/sindresorhus/query-string) ⭐ 6,906 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-06 - Parse and stringify URL query strings.
...
* [pouchdb](https://github.com/pouchdb/pouchdb) ⭐ 17,604 | 🐛 185 | 🌐 JavaScript | 📅 2026-08-25 - Javascript db inspired by Apache CouchDB to run well within the browser.
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,551 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-28 - Dexie.js is a wrapper library for indexedDB.
...
* [colors](https://github.com/mrmrs/colors) ⭐ 9,410 | 🐛 16 | 🌐 CSS | 📅 2023-07-20 - Smarter defaults for colors on the web.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,623 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-20 - internationalisation (i18n) with JavaScript the easy way.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,350 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-29 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,195 | 🐛 83 | 🌐 JavaScript | 📅 2026-08-28 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,238 | 🐛 139 | 🌐 TypeScript | 📅 2026-08-31 - Hooks for fetching, caching and updating asynchronous data in React.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,977 | 🐛 2 | 🌐 Vue | 📅 2026-08-31 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [bowser](https://github.com/ded/bowser) ⭐ 5,749 | 🐛 85 | 🌐 JavaScript | 📅 2026-08-30 - a browser detector.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,991 | 🐛 94 | 🌐 JavaScript | 📅 2026-08-30 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,763 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,738 | 🐛 491 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
...
* [keymaster](https://github.com/madrobby/keymaster) ⭐ 6,509 | 🐛 82 | 🌐 JavaScript | 📅 2024-07-29 - A simple micro-library for defining and dispatching keyboard shortcuts.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,654 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,809 | 🐛 34 | 🌐 JavaScript | 📅 2026-08-25 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,701 | 🐛 106 | 🌐 TypeScript | 📅 2026-08-31 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,237 | 🐛 911 | 🌐 JavaScript | 📅 2026-08-24 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,900 | 🐛 236 | 🌐 TypeScript | 📅 2026-08-28 - Mobile touch slider and framework with hardware accelerated transitions.
...
* [typeahead.js](https://github.com/twitter/typeahead.js) ⭐ 16,440 | 🐛 506 | 🌐 JavaScript | 📅 2023-04-14 - A fast and fully-featured autocomplete library.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,622 | 🐛 1,131 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
* [tui.calendar](https://github.com/nhn/tui.calendar) ⭐ 12,705 | 🐛 208 | 🌐 TypeScript | 📅 2024-06-24 - A JavaScript schedule calendar that is full featured. Now your service just got the customizable calendar.
...
* [select2](https://github.com/select2/select2) ⭐ 25,905 | 🐛 134 | 🌐 JavaScript | 📅 2026-08-31 - a jQuery based replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results.
* [chosen](https://github.com/harvesthq/chosen) ⭐ 21,942 | 🐛 309 | 🌐 HTML | 📅 2024-12-02 - A library for making long, unwieldy select boxes more friendly.
...
* [dropzone](https://github.com/enyo/dropzone) ⭐ 18,377 | 🐛 151 | 🌐 JavaScript | 📅 2026-08-30 - Dropzone is an easy to use drag'n'drop library. It supports image previews and shows nice progress bars.
* [filepond](https://github.com/pqina/filepond) ⭐ 16,388 | 🐛 140 | 🌐 JavaScript | 📅 2026-08-28 - A JavaScript library that can upload anything you throw at it, optimizes images for faster uploads, and offers a great, accessible, silky smooth user experience.
...
* [FileAPI](https://github.com/mailru/FileAPI) ⭐ 3,548 | 🐛 50 | 🌐 JavaScript | 📅 2020-09-24 - A set of JavaScript tools for working with files. Multiupload, drag'n'drop and chunked file upload. Images: crop, resize and auto orientation by EXIF.
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,853 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-30 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [rellax](https://github.com/dixonandmoe/rellax) ⭐ 7,133 | 🐛 77 | 🌐 HTML | 📅 2024-08-24 - Buttery smooth, super lightweight, vanilla javascript parallax library.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,542 | 🐛 566 | 🌐 JavaScript | 📅 2026-08-31 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,630 | 🐛 1,649 | 🌐 JavaScript | 📅 2026-08-31 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,511 | 🐛 165 | 🌐 C | 📅 2026-08-27 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,908 | 🐛 91 | 🌐 TypeScript | 📅 2026-08-31 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [clappr](https://github.com/clappr/clappr) ⭐ 7,492 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-31 - An extensible media player for the web <http://clappr.io>
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,766 | 🐛 80 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 28,133 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,973 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-31 - A new and improved version of particles.js with bug fixes and many new features.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,989 | 🐛 778 | 🌐 TypeScript | 📅 2026-08-31 - Turn ES6+ code into vanilla ES5 with no runtime.
* [es6features](https://github.com/lukehoban/es6features) ⭐ 29,033 | 🐛 38 | 📅 2023-01-27 - Overview of ECMAScript 6 features.
* [es6-cheatsheet](https://github.com/DrkSephy/es6-cheatsheet) ⭐ 13,320 | 🐛 7 | 🌐 JavaScript | 📅 2022-10-08 - ES2015 \[ES6] cheatsheet containing tips, tricks, best practices and code snippets.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 142,041 | 🐛 3,544 | 🌐 JavaScript | 📅 2026-08-31 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,134 | 🐛 398 | 🌐 TypeScript | 📅 2026-08-31 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 62,199 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-31 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,809 | 🐛 543 | 🌐 TypeScript | 📅 2026-08-31 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,944 | 🐛 438 | 🌐 JavaScript | 📅 2026-08-29 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,469 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,278 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-26 - Static site generator for Deno.

## SDK

* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,156 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-31 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,498 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-31 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,785 | 🐛 38 | 🌐 JavaScript | 📅 2026-06-28 - It is a Next-Generation full text search library for Browser and Node.js.
...
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,640 | 🐛 617 | 🌐 TypeScript | 📅 2026-08-27 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,642 | 🐛 2,004 | 🌐 TypeScript | 📅 2026-08-31 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,374 | 🐛 1,079 | 🌐 TypeScript | 📅 2026-08-31 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,478 | 🐛 169 | 🌐 JavaScript | 📅 2026-08-30 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,343 | 🐛 744 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,185 | 🐛 170 | 🌐 TypeScript | 📅 2026-08-31 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,194 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-31 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,210 | 🐛 203 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,583 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,384 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,096 | 🐛 423 | 🌐 TypeScript | 📅 2026-08-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,053 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-28 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,862 | 🐛 496 | 🌐 TypeScript | 📅 2026-08-31 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [enum-plus](https://github.com/shijistar/enum-plus) ⭐ 205 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - A drop-in enhancement for native TypeScript enums, adding display text, internationalization and full type safety.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,766 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 501,705 | 🐛 105 | 📅 2026-08-21
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,454 | 🐛 86 | 📅 2026-08-20
* [bayandin/awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,639 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02
* [bolshchikov/js-must-watch](https://github.com/bolshchikov/js-must-watch) ⭐ 13,603 | 🐛 0 | 📅 2022-01-20
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,447 | 🐛 24 | 📅 2026-03-23
...
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,649 | 🐛 90 | 📅 2025-07-20
