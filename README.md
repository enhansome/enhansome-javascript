...
* [jspm](https://github.com/jspm/jspm-cli) ⭐ 3,867 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-17 - Frictionless browser package management.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,461 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-25 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,970 | 🐛 133 | 🌐 JavaScript | 📅 2026-08-25 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,019 | 🐛 603 | 🌐 JavaScript | 📅 2026-08-25 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,307 | 🐛 601 | 🌐 JavaScript | 📅 2026-08-25 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,324 | 🐛 348 | 🌐 JavaScript | 📅 2026-08-22 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,527 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-25 - TypeScript-first schema validation with built-in static type inference.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,474 | 🐛 182 | 🌐 TypeScript | 📅 2026-08-25 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,905 | 🐛 264 | 🌐 JavaScript | 📅 2026-08-21 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,831 | 🐛 72 | 🌐 JavaScript | 📅 2026-06-17 - 🚀 Futuristic JavaScript test runner
* [jasmine](https://github.com/jasmine/jasmine) ⭐ 15,823 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-20 - DOM-less simple JavaScript testing framework.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,907 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-20 - Automated browser testing for the modern web development stack.
...
* [react testing library](https://github.com/kentcdodds/react-testing-library) ⭐ 19,648 | 🐛 83 | 🌐 JavaScript | 📅 2026-04-02 - Simple and complete React DOM testing utilities that encourage good testing practices.
...
* [chai](https://github.com/chaijs/chai) ⭐ 8,270 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-24 - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,496 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-25 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,112 | 🐛 178 | 🌐 TypeScript | 📅 2026-08-25 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,826 | 🐛 287 | 🌐 TypeScript | 📅 2026-08-25 - Next-gen WebDriver test automation framework for Node.js.
...
* [taiko](https://github.com/getgauge/taiko) ⭐ 3,673 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-25 - A Node.js library with a simple API to automate Chromium based browsers.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,217 | 🐛 1,416 | 🌐 JavaScript | 📅 2026-08-24 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,282 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,486 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-25 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,992 | 🐛 438 | 🌐 JavaScript | 📅 2026-08-17 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,408 | 🐛 8 | 🌐 Rust | 📅 2026-08-25 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,687 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,410 | 🐛 1,099 | 🌐 C++ | 📅 2026-08-25 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,004 | 🐛 1,139 | 🌐 TypeScript | 📅 2026-08-25 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,985 | 🐛 1,053 | 🌐 JavaScript | 📅 2026-08-25 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,813 | 🐛 415 | 🌐 JavaScript | 📅 2026-08-25 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,833 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-25 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,881 | 🐛 1 | 🌐 HTML | 📅 2026-08-25 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,165 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-25 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,625 | 🐛 835 | 🌐 TypeScript | 📅 2026-08-23 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,567 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-25 - A JavaScript framework for creating ambitious web applications.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,532 | 🐛 336 | 🌐 JavaScript | 📅 2026-08-25 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,225 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [Drawflow](https://github.com/jerosoler/Drawflow) ⭐ 6,107 | 🐛 272 | 🌐 JavaScript | 📅 2024-10-19 - This allow you to create data flows easily and quickly.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 73,013 | 🐛 543 | 🌐 TypeScript | 📅 2026-08-25 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,057 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-25 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,963 | 🐛 137 | 🌐 TypeScript | 📅 2026-08-25 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,606 | 🐛 135 | 🌐 JavaScript | 📅 2026-08-25 - CMS with content editing and essential services.
...
* [handlebars.js](https://github.com/handlebars-lang/handlebars.js) ⭐ 18,670 | 🐛 114 | 🌐 JavaScript | 📅 2026-06-24 - An extension to the Mustache templating language.
* [mustache.js](https://github.com/janl/mustache.js) ⭐ 16,723 | 🐛 120 | 🌐 JavaScript | 📅 2024-06-14 - Minimal templating with {{mustaches}} in JavaScript.
* [marko](https://github.com/marko-js/marko) ⭐ 14,407 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-25 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,773 | 🐛 374 | 🌐 JavaScript | 📅 2026-08-25 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,546 | 🐛 21 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,659 | 🐛 583 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,148 | 🐛 1,541 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,407 | 🐛 468 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,984 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-25 - A framework for building 3D games with HTML 5 and WebGL.
* [Frappe Charts](https://github.com/frappe/charts) ⭐ 15,080 | 🐛 146 | 🌐 JavaScript | 📅 2025-07-02 - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
* [paper.js](https://github.com/paperjs/paper.js) ⭐ 15,067 | 🐛 429 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting – Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,271 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,146 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-20 - A JavaScript library dedicated to graph drawing.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,183 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-25 - A fully featured graph theory library.
...
* [two.js](https://github.com/jonobr1/two.js) ⭐ 8,651 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-24 - A renderer agnostic two-dimensional drawing api for the web.
...
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,093 | 🐛 77 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,360 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-24 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [d3-cloud](https://github.com/jasondavies/d3-cloud) ⭐ 3,948 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-09 - Create word clouds in JavaScript.
...
* [vizzu](https://github.com/vizzuhq/vizzu-lib) ⭐ 2,023 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-20 - Library for animated data visualizations and data stories.
...
* [TimelineJS v3](https://github.com/NUKnightLab/TimelineJS3) ⭐ 3,212 | 🐛 231 | 🌐 JavaScript | 📅 2026-08-11 - A Storytelling Timeline built in JavaScript.

## Spreadsheet

* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,027 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-25 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [Jspreadsheet CE](https://github.com/jspreadsheet/ce) ⭐ 7,219 | 🐛 151 | 🌐 JavaScript | 📅 2026-04-10 - Jspreadsheet is a lightweight vanilla javascript plugin to create amazing web-based interactive tables and spreadsheets compatible with other spreadsheet software.
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,438 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-24 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [quill](https://github.com/quilljs/quill) ⭐ 47,316 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
* [CodeMirror](https://github.com/codemirror/CodeMirror) ⚠️ Archived - In-browser code editor.
* [ace](https://github.com/ajaxorg/ace) ⭐ 27,143 | 🐛 139 | 🌐 JavaScript | 📅 2026-08-13 - Ace (Ajax.org Cloud9 Editor).
...
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,279 | 🐛 412 | 🌐 TypeScript | 📅 2026-08-17 - The JavaScript Rich Text editor.
* [medium-editor](https://github.com/yabwe/medium-editor) ⭐ 16,104 | 🐛 359 | 🌐 JavaScript | 📅 2024-10-24 - Medium.com WYSIWYG editor clone.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,781 | 🐛 421 | 🌐 JavaScript | 📅 2026-08-25 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,283 | 🐛 119 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,068 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-25 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,290 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
* [underscore](https://github.com/jashkenas/underscore) ⭐ 27,330 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript's utility \_ belt.
...
* [lazy.js](https://github.com/dtao/lazy.js) ⭐ 5,968 | 🐛 59 | 🌐 JavaScript | 📅 2020-07-15 - Like Underscore, but lazier.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,704 | 🐛 180 | 🌐 TypeScript | 📅 2026-08-08 - A reactive programming library for JavaScript.
* [MobX](https://github.com/mobxjs/mobx) ⭐ 28,206 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-24 - TFRP library for simple, scalable state management.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,041 | 🐛 128 | 🌐 TypeScript | 📅 2026-08-17 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [hashmap](https://github.com/flesler/hashmap) ⭐ 384 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-13 - Simple hashmap implementation that supports any kind of keys.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,666 | 🐛 1,300 | 🌐 JavaScript | 📅 2026-08-18 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 47,916 | 🐛 106 | 🌐 JavaScript | 📅 2026-08-23 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,647 | 🐛 996 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
...
* [query-string](https://github.com/sindresorhus/query-string) ⭐ 6,902 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-06 - Parse and stringify URL query strings.
...
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,549 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-24 - Dexie.js is a wrapper library for indexedDB.
...
* [Hoodie](https://github.com/hoodiehq/hoodie) ⭐ 4,457 | 🐛 98 | 🌐 JavaScript | 📅 2024-07-27 - Offline First backend to work in browser without internet connectivity.
...
* [chroma.js](https://github.com/gka/chroma.js) ⭐ 10,574 | 🐛 77 | 🌐 JavaScript | 📅 2026-06-01 - JavaScript library for all kinds of color manipulations.
...
* [async](https://github.com/caolan/async) ⭐ 28,138 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-07 - Async utilities for node and the browser.
* [Bluebird](https://github.com/petkaantonov/bluebird/) ⭐ 20,491 | 🐛 131 | 🌐 JavaScript | 📅 2024-11-07 - fully featured promise library with focus on innovative features and performance.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,334 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,199 | 🐛 79 | 🌐 JavaScript | 📅 2026-08-25 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,203 | 🐛 123 | 🌐 TypeScript | 📅 2026-08-25 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,467 | 🐛 214 | 🌐 TypeScript | 📅 2026-08-23 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,965 | 🐛 2 | 🌐 Vue | 📅 2026-08-25 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [bowser](https://github.com/ded/bowser) ⭐ 5,749 | 🐛 95 | 🌐 JavaScript | 📅 2026-08-01 - a browser detector.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 890 | 🐛 157 | 🌐 Rust | 📅 2026-08-24 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [partytown](https://github.com/BuilderIO/partytown) ⭐ 13,762 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-25 - Relocate resource intensive third-party scripts off of the main thread and into a web worker.
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,784 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-11 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [workerpool](https://github.com/josdejong/workerpool) ⭐ 2,307 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-10 - Offload tasks to a pool of workers on node.js and in the browser.
...
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,741 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,739 | 🐛 488 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,630 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
* [intro.js](https://github.com/usablica/intro.js) ⭐ 23,454 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-07 - A better way for new feature introduction and step-by-step users guide for your website and project.
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,794 | 🐛 34 | 🌐 JavaScript | 📅 2026-08-25 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,665 | 🐛 102 | 🌐 TypeScript | 📅 2026-08-25 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,187 | 🐛 908 | 🌐 JavaScript | 📅 2026-08-24 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,893 | 🐛 255 | 🌐 TypeScript | 📅 2026-08-06 - Mobile touch slider and framework with hardware accelerated transitions.
...
* [PhotoSwipe](https://github.com/dimsemenov/PhotoSwipe) ⭐ 25,241 | 🐛 170 | 🌐 JavaScript | 📅 2025-12-04 - JavaScript image gallery for mobile and desktop, modular, framework independent.
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,395 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-21 - An extensible low level carousel for the web, written in TypeScript.
...
* [Ion.RangeSlider](https://github.com/IonDen/ion.rangeSlider) ⭐ 2,544 | 🐛 92 | 🌐 JavaScript | 📅 2026-08-24 - Powerful and easily customizable range slider with many options and skin support.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,618 | 🐛 1,129 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
* [tui.calendar](https://github.com/nhn/tui.calendar) ⭐ 12,701 | 🐛 208 | 🌐 TypeScript | 📅 2024-06-24 - A JavaScript schedule calendar that is full featured. Now your service just got the customizable calendar.
...
* [pickadate.js](https://github.com/amsul/pickadate.js) ⭐ 7,652 | 🐛 315 | 🌐 JavaScript | 📅 2023-07-14 - The mobile-friendly, responsive, and lightweight jQuery date & time input picker.
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,538 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [select2](https://github.com/select2/select2) ⭐ 25,908 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-24 - a jQuery based replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results.
* [chosen](https://github.com/harvesthq/chosen) ⭐ 21,946 | 🐛 309 | 🌐 HTML | 📅 2024-12-02 - A library for making long, unwieldy select boxes more friendly.
...
* [filepond](https://github.com/pqina/filepond) ⭐ 16,390 | 🐛 140 | 🌐 JavaScript | 📅 2026-07-13 - A JavaScript library that can upload anything you throw at it, optimizes images for faster uploads, and offers a great, accessible, silky smooth user experience.
...
* [fullPage](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,403 | 🐛 129 | 🌐 JavaScript | 📅 2026-03-17 - A simple and easy to use plugin to create fullscreen scrolling websites (also known as single page websites).
...
* [headroom](https://github.com/WickyNilliams/headroom.js) ⭐ 10,837 | 🐛 20 | 🌐 JavaScript | 📅 2023-10-25 - Give your pages some headroom. Hide your header until you need it.
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,845 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-30 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,601 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-20 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,519 | 🐛 563 | 🌐 JavaScript | 📅 2026-08-24 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,603 | 🐛 1,652 | 🌐 JavaScript | 📅 2026-08-25 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,491 | 🐛 167 | 🌐 C | 📅 2026-08-20 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [polymaps](https://github.com/simplegeo/polymaps) ⭐ 1,600 | 🐛 67 | 🌐 JavaScript | 📅 2023-07-26 - A free JavaScript library for making dynamic, interactive maps in modern web browsers.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,865 | 🐛 668 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,895 | 🐛 90 | 🌐 TypeScript | 📅 2026-08-25 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [clappr](https://github.com/clappr/clappr) ⭐ 7,494 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-25 - An extensible media player for the web <http://clappr.io>
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,749 | 🐛 79 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,989 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,200 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [barbajs](https://github.com/barbajs/barba) ⭐ 12,970 | 🐛 15 | 🌐 TypeScript | 📅 2024-12-02 - It helps you create fluid and smooth transitions between your website's pages.
* [Effeckt.css](https://github.com/h5bp/Effeckt.css) ⚠️ Archived - A Performant Transitions and Animations Library.
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,961 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A new and improved version of particles.js with bug fixes and many new features.
...
* [pica](https://github.com/nodeca/pica) ⭐ 4,143 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-15 - High quality image resize (with fast Lanczos filter, implemented in pure JS).
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,926 | 🐛 3,855 | 🌐 JavaScript | 📅 2026-08-25 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,076 | 🐛 399 | 🌐 TypeScript | 📅 2026-08-24 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 62,038 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-25 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,798 | 🐛 542 | 🌐 TypeScript | 📅 2026-08-25 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,943 | 🐛 423 | 🌐 JavaScript | 📅 2026-08-21 - React-based static site generator.
...
* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,141 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-25 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,490 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-25 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,780 | 🐛 38 | 🌐 JavaScript | 📅 2026-06-28 - It is a Next-Generation full text search library for Browser and Node.js.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,568 | 🐛 2,559 | 🌐 TypeScript | 📅 2026-08-25 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,633 | 🐛 624 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,589 | 🐛 1,981 | 🌐 TypeScript | 📅 2026-08-25 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,377 | 🐛 1,078 | 🌐 TypeScript | 📅 2026-08-16 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,473 | 🐛 172 | 🌐 JavaScript | 📅 2026-08-25 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,342 | 🐛 740 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,165 | 🐛 168 | 🌐 TypeScript | 📅 2026-08-25 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,185 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-24 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,205 | 🐛 198 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,551 | 🐛 401 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,341 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,074 | 🐛 421 | 🌐 TypeScript | 📅 2026-08-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,044 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,853 | 🐛 490 | 🌐 TypeScript | 📅 2026-08-25 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,723 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [braziljs/js-the-right-way](https://github.com/braziljs/js-the-right-way/) ⭐ 8,675 | 🐛 0 | 🌐 HTML | 📅 2026-07-29 - An easy-to-read, quick reference for JS best practices, accepted coding standards, and links around the Web.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 499,850 | 🐛 106 | 📅 2026-08-21
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,394 | 🐛 82 | 📅 2026-08-20
* [bayandin/awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,624 | 🐛 61 | 🌐 Ruby | 📅 2024-06-02
* [bolshchikov/js-must-watch](https://github.com/bolshchikov/js-must-watch) ⭐ 13,607 | 🐛 0 | 📅 2022-01-20
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,437 | 🐛 22 | 📅 2026-03-23
...
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,649 | 🐛 92 | 📅 2025-07-20
