...
* [Bit](https://github.com/teambit/bit) ⭐ 18,463 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-26 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,964 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-27 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,021 | 🐛 603 | 🌐 JavaScript | 📅 2026-08-26 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,306 | 🐛 602 | 🌐 JavaScript | 📅 2026-08-27 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,326 | 🐛 350 | 🌐 JavaScript | 📅 2026-08-27 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,538 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-27 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,671 | 🐛 252 | 🌐 TypeScript | 📅 2026-08-26 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,475 | 🐛 182 | 🌐 TypeScript | 📅 2026-08-27 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,906 | 🐛 265 | 🌐 JavaScript | 📅 2026-08-26 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
...
* [react testing library](https://github.com/kentcdodds/react-testing-library) ⭐ 19,646 | 🐛 83 | 🌐 JavaScript | 📅 2026-04-02 - Simple and complete React DOM testing utilities that encourage good testing practices.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,506 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-26 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,227 | 🐛 181 | 🌐 TypeScript | 📅 2026-08-27 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,827 | 🐛 284 | 🌐 TypeScript | 📅 2026-08-27 - Next-gen WebDriver test automation framework for Node.js.
...
* [taiko](https://github.com/getgauge/taiko) ⭐ 3,675 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-25 - A Node.js library with a simple API to automate Chromium based browsers.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,213 | 🐛 1,412 | 🌐 JavaScript | 📅 2026-08-26 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,288 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,487 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-25 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,416 | 🐛 14 | 🌐 Rust | 📅 2026-08-27 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,754 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,426 | 🐛 1,094 | 🌐 C++ | 📅 2026-08-27 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,004 | 🐛 1,142 | 🌐 TypeScript | 📅 2026-08-27 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,996 | 🐛 1,053 | 🌐 JavaScript | 📅 2026-08-27 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,814 | 🐛 390 | 🌐 JavaScript | 📅 2026-08-27 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
...
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,883 | 🐛 3 | 🌐 HTML | 📅 2026-08-25 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,166 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-26 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,627 | 🐛 834 | 🌐 TypeScript | 📅 2026-08-27 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,566 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-27 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,101 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-27 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [feathers](https://github.com/feathersjs/feathers) ⭐ 15,267 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-14 - A minimalist real-time JavaScript framework for tomorrow's apps.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,534 | 🐛 379 | 🌐 JavaScript | 📅 2026-08-26 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,227 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 8,116 | 🐛 146 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Remult](https://github.com/remult/remult) ⭐ 3,209 | 🐛 118 | 🌐 TypeScript | 📅 2026-08-26 - A CRUD framework for full-stack TypeScript.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 73,018 | 🐛 543 | 🌐 TypeScript | 📅 2026-08-27 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,072 | 🐛 141 | 🌐 JavaScript | 📅 2026-08-27 - simple, powerful publishing platform.
...
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,608 | 🐛 136 | 🌐 JavaScript | 📅 2026-08-26 - CMS with content editing and essential services.
...
* [marko](https://github.com/marko-js/marko) ⭐ 14,407 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-26 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,846 | 🐛 380 | 🌐 JavaScript | 📅 2026-08-27 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,567 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,669 | 🐛 583 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,160 | 🐛 1,537 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,412 | 🐛 468 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,987 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-27 - A framework for building 3D games with HTML 5 and WebGL.
...
* [paper.js](https://github.com/paperjs/paper.js) ⭐ 15,069 | 🐛 429 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting – Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
...
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,146 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-20 - A JavaScript library dedicated to graph drawing.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,388 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-21 - A next-generation declarative infographic visualization engine.
...
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,097 | 🐛 77 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,362 | 🐛 51 | 🌐 JavaScript | 📅 2026-08-26 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,030 | 🐛 76 | 🌐 JavaScript | 📅 2026-08-27 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,283 | 🐛 412 | 🌐 TypeScript | 📅 2026-08-17 - The JavaScript Rich Text editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,788 | 🐛 419 | 🌐 JavaScript | 📅 2026-08-26 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,290 | 🐛 118 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
...
* [diff2html](https://github.com/rtfpessoa/diff2html) ⭐ 3,399 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-08 - Git diff output parser and pretty HTML generator.
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,100 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-27 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,284 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,041 | 🐛 129 | 🌐 TypeScript | 📅 2026-08-17 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [moment](https://github.com/moment/moment) ⭐ 47,913 | 🐛 106 | 🌐 JavaScript | 📅 2026-08-23 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,642 | 🐛 1,000 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
...
* [Numeral-js](https://github.com/adamwdraper/Numeral-js) ⭐ 9,705 | 🐛 345 | 🌐 JavaScript | 📅 2026-02-15 - A JavaScript library for formatting and manipulating numbers.
...
* [pouchdb](https://github.com/pouchdb/pouchdb) ⭐ 17,600 | 🐛 185 | 🌐 JavaScript | 📅 2026-08-25 - Javascript db inspired by Apache CouchDB to run well within the browser.
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,551 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-24 - Dexie.js is a wrapper library for indexedDB.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,343 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,193 | 🐛 77 | 🌐 JavaScript | 📅 2026-08-27 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,216 | 🐛 129 | 🌐 TypeScript | 📅 2026-08-27 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,475 | 🐛 215 | 🌐 TypeScript | 📅 2026-08-23 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,968 | 🐛 1 | 🌐 Vue | 📅 2026-08-27 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 892 | 🐛 166 | 🌐 Rust | 📅 2026-08-27 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,788 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-11 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [worker-dom](https://github.com/ampproject/worker-dom) ⭐ 3,263 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-26 - An in-progress implementation of the DOM API intended to run within a Web Worker.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,984 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-27 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,752 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,738 | 🐛 488 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,645 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,679 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-27 - Open-source notification infrastructure for products.
...
* [toastify-js](https://github.com/apvarun/toastify-js) ⭐ 2,534 | 🐛 51 | 🌐 JavaScript | 📅 2024-08-19 - Pure JavaScript library for better notification messages.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,214 | 🐛 910 | 🌐 JavaScript | 📅 2026-08-24 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,898 | 🐛 242 | 🌐 TypeScript | 📅 2026-08-26 - Mobile touch slider and framework with hardware accelerated transitions.
...
* [slick](https://github.com/kenwheeler/slick) ⭐ 28,553 | 🐛 1,317 | 🌐 JavaScript | 📅 2026-08-01 - The last carousel you'll ever need.
...
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,397 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-21 - An extensible low level carousel for the web, written in TypeScript.
...
* [Ion.RangeSlider](https://github.com/IonDen/ion.rangeSlider) ⭐ 2,544 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-26 - Powerful and easily customizable range slider with many options and skin support.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,621 | 🐛 1,130 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,541 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-27 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [chosen](https://github.com/harvesthq/chosen) ⭐ 21,944 | 🐛 309 | 🌐 HTML | 📅 2024-12-02 - A library for making long, unwieldy select boxes more friendly.
...
* [dropzone](https://github.com/enyo/dropzone) ⭐ 18,378 | 🐛 149 | 🌐 JavaScript | 📅 2026-08-24 - Dropzone is an easy to use drag'n'drop library. It supports image previews and shows nice progress bars.
* [filepond](https://github.com/pqina/filepond) ⭐ 16,388 | 🐛 140 | 🌐 JavaScript | 📅 2026-08-27 - A JavaScript library that can upload anything you throw at it, optimizes images for faster uploads, and offers a great, accessible, silky smooth user experience.
...
* [fullPage](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,404 | 🐛 129 | 🌐 JavaScript | 📅 2026-03-17 - A simple and easy to use plugin to create fullscreen scrolling websites (also known as single page websites).
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,525 | 🐛 564 | 🌐 JavaScript | 📅 2026-08-24 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,611 | 🐛 1,657 | 🌐 JavaScript | 📅 2026-08-27 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,498 | 🐛 166 | 🌐 C | 📅 2026-08-20 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,867 | 🐛 668 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,900 | 🐛 93 | 🌐 TypeScript | 📅 2026-08-27 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [clappr](https://github.com/clappr/clappr) ⭐ 7,494 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-25 - An extensible media player for the web <http://clappr.io>
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 28,036 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,201 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [barbajs](https://github.com/barbajs/barba) ⭐ 12,976 | 🐛 15 | 🌐 TypeScript | 📅 2024-12-02 - It helps you create fluid and smooth transitions between your website's pages.
* [Effeckt.css](https://github.com/h5bp/Effeckt.css) ⚠️ Archived - A Performant Transitions and Animations Library.
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,966 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A new and improved version of particles.js with bug fixes and many new features.
...
* [pica](https://github.com/nodeca/pica) ⭐ 4,145 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-15 - High quality image resize (with fast Lanczos filter, implemented in pure JS).
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,988 | 🐛 774 | 🌐 TypeScript | 📅 2026-08-25 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,957 | 🐛 3,658 | 🌐 JavaScript | 📅 2026-08-27 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,102 | 🐛 393 | 🌐 TypeScript | 📅 2026-08-26 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 62,088 | 🐛 112 | 🌐 TypeScript | 📅 2026-08-27 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,803 | 🐛 545 | 🌐 TypeScript | 📅 2026-08-27 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,942 | 🐛 437 | 🌐 JavaScript | 📅 2026-08-27 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,469 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,276 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-26 - Static site generator for Deno.

## SDK

* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,146 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-27 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,493 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-27 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,781 | 🐛 38 | 🌐 JavaScript | 📅 2026-06-28 - It is a Next-Generation full text search library for Browser and Node.js.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,566 | 🐛 2,568 | 🌐 TypeScript | 📅 2026-08-27 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,631 | 🐛 609 | 🌐 TypeScript | 📅 2026-08-27 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,602 | 🐛 1,988 | 🌐 TypeScript | 📅 2026-08-27 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,378 | 🐛 1,078 | 🌐 TypeScript | 📅 2026-08-26 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,475 | 🐛 172 | 🌐 JavaScript | 📅 2026-08-25 MongoDB object modeling designed to work in an asynchronous environment.
...
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,171 | 🐛 168 | 🌐 TypeScript | 📅 2026-08-26 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,186 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-27 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,208 | 🐛 198 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,566 | 🐛 400 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,359 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
...
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,045 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-26 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,857 | 🐛 492 | 🌐 TypeScript | 📅 2026-08-27 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,741 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 500,364 | 🐛 105 | 📅 2026-08-21
