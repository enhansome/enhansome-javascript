...
* [Bit](https://github.com/teambit/bit) ⭐ 18,455 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-20 - Create, find and reuse components (React, Angular, Node etc.) across applications.

## Loaders

*Module or loading system for JavaScript.*

* [browserify](https://github.com/substack/node-browserify) ⭐ 14,698 | 🐛 380 | 🌐 JavaScript | 📅 2024-12-21 - Browser-side require() the node.js way.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,970 | 🐛 142 | 🌐 JavaScript | 📅 2026-08-20 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,020 | 🐛 601 | 🌐 JavaScript | 📅 2026-08-20 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,306 | 🐛 604 | 🌐 JavaScript | 📅 2026-08-20 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,322 | 🐛 349 | 🌐 JavaScript | 📅 2026-08-14 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,496 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-20 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,674 | 🐛 251 | 🌐 TypeScript | 📅 2026-08-12 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,469 | 🐛 184 | 🌐 TypeScript | 📅 2026-08-20 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,902 | 🐛 262 | 🌐 JavaScript | 📅 2026-08-19 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,832 | 🐛 72 | 🌐 JavaScript | 📅 2026-06-17 - 🚀 Futuristic JavaScript test runner
...
* [qunit](https://github.com/jquery/qunit) ⭐ 4,034 | 🐛 52 | 🌐 JavaScript | 📅 2026-06-28 - An easy-to-use JavaScript Unit Testing framework.
...
* [react testing library](https://github.com/kentcdodds/react-testing-library) ⭐ 19,640 | 🐛 82 | 🌐 JavaScript | 📅 2026-04-02 - Simple and complete React DOM testing utilities that encourage good testing practices.
...
* [chai](https://github.com/chaijs/chai) ⭐ 8,267 | 🐛 92 | 🌐 JavaScript | 📅 2026-08-17 - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework.
...
* [blanket](https://github.com/alex-seville/blanket) ⭐ 1,396 | 🐛 162 | 🌐 JavaScript | 📅 2022-12-06 - A simple code coverage library for JavaScript. Designed to be easy to install and use, for both browser and nodejs.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,472 | 🐛 265 | 🌐 TypeScript | 📅 2026-08-20 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,807 | 🐛 161 | 🌐 TypeScript | 📅 2026-08-20 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
* [phantomjs](https://github.com/ariya/phantomjs) ⚠️ Archived - Scriptable Headless WebKit.
* [karma](https://github.com/karma-runner/karma) ⭐ 11,961 | 🐛 402 | 🌐 JavaScript | 📅 2026-06-10 - Spectacular Test Runner for JavaScript.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,817 | 🐛 296 | 🌐 TypeScript | 📅 2026-08-19 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,208 | 🐛 1,419 | 🌐 JavaScript | 📅 2026-08-20 - Prettier is an opinionated code formatter.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,462 | 🐛 128 | 🌐 JavaScript | 📅 2026-08-20 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,364 | 🐛 3 | 🌐 Rust | 📅 2026-08-20 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,658 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-02 - High-standards, strict & opinionated code quality tool, aiming to keep only good parts of the language.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,251 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,369 | 🐛 1,058 | 🌐 C++ | 📅 2026-08-20 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,004 | 🐛 1,153 | 🌐 TypeScript | 📅 2026-08-19 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,980 | 🐛 1,115 | 🌐 JavaScript | 📅 2026-08-20 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,810 | 🐛 410 | 🌐 JavaScript | 📅 2026-08-20 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,824 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-20 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,150 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,615 | 🐛 834 | 🌐 TypeScript | 📅 2026-08-19 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,566 | 🐛 266 | 🌐 TypeScript | 📅 2026-08-20 - A JavaScript framework for creating ambitious web applications.
* [hyperapp](https://github.com/hyperapp/hyperapp) ⭐ 19,200 | 🐛 14 | 🌐 JavaScript | 📅 2025-03-20 - 1kb JavaScript library for building frontend applications.
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,095 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-13 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
* [Million](https://github.com/aidenybai/million) ⭐ 17,670 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-20 - <1kb compiler-focused virtual DOM. It's fast!
* [inferno](https://github.com/infernojs/inferno) ⭐ 16,452 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-19 - 🔥 An extremely fast, React-like JavaScript library for building modern user interfaces.
* [feathers](https://github.com/feathersjs/feathers) ⭐ 15,266 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-14 - A minimalist real-time JavaScript framework for tomorrow's apps.
* [riot](https://github.com/riot/riot) ⭐ 14,911 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-06 - React-like library, but with very small size.
* [mithril.js](https://github.com/lhorie/mithril.js) ⭐ 14,491 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13 - Mithril is a client-side MVC framework (Light-weight, Robust, Fast).
* [Blockly](https://github.com/google/blockly) ⭐ 13,523 | 🐛 335 | 🌐 JavaScript | 📅 2026-08-20 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,223 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [marionette](https://github.com/marionettejs/backbone.marionette) ⭐ 7,035 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-18 - A composite application library for Backbone.js that aims to simplify the construction of large scale JavaScript applications.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 72,978 | 🐛 549 | 🌐 TypeScript | 📅 2026-08-20 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,821 | 🐛 125 | 🌐 JavaScript | 📅 2026-08-20 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,960 | 🐛 143 | 🌐 TypeScript | 📅 2026-08-20 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,602 | 🐛 135 | 🌐 JavaScript | 📅 2026-08-19 - CMS with content editing and essential services.
...
* [mustache.js](https://github.com/janl/mustache.js) ⭐ 16,720 | 🐛 120 | 🌐 JavaScript | 📅 2024-06-14 - Minimal templating with {{mustaches}} in JavaScript.
* [marko](https://github.com/marko-js/marko) ⭐ 14,406 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-20 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
* [EJS](https://github.com/mde/ejs) ⭐ 8,116 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-10 - Effective JavaScript templating.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,634 | 🐛 377 | 🌐 JavaScript | 📅 2026-08-20 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,501 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,647 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,104 | 🐛 1,556 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,954 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-20 - A framework for building 3D games with HTML 5 and WebGL.
* [Frappe Charts](https://github.com/frappe/charts) ⭐ 15,082 | 🐛 145 | 🌐 JavaScript | 📅 2025-07-02 - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
...
* [G2](https://github.com/antvis/G2) ⭐ 12,592 | 🐛 182 | 🌐 TypeScript | 📅 2026-07-15 - A highly interactive data-driven visualization grammar for statistical charts.
* [G6](https://github.com/antvis/g6) ⭐ 12,262 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,140 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-20 - A JavaScript library dedicated to graph drawing.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,174 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-19 - A fully featured graph theory library.
...
* [c3](https://github.com/c3js/c3) ⭐ 9,347 | 🐛 771 | 🌐 JavaScript | 📅 2026-08-05 - D3-based reusable chart library.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,369 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-20 - A next-generation declarative infographic visualization engine.
...
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,354 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-20 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [vizzu](https://github.com/vizzuhq/vizzu-lib) ⭐ 2,020 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-20 - Library for animated data visualizations and data stories.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,023 | 🐛 119 | 🌐 JavaScript | 📅 2026-08-20 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [Jspreadsheet CE](https://github.com/jspreadsheet/ce) ⭐ 7,215 | 🐛 151 | 🌐 JavaScript | 📅 2026-04-10 - Jspreadsheet is a lightweight vanilla javascript plugin to create amazing web-based interactive tables and spreadsheets compatible with other spreadsheet software.
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,436 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-20 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
* [Frappe Datatable](https://github.com/frappe/datatable) ⭐ 1,330 | 🐛 62 | 🌐 JavaScript | 📅 2026-07-22 - Frappe DataTable is a simple, modern and interactive datatable library for displaying tabular data.

## Editors

* [quill](https://github.com/quilljs/quill) ⭐ 47,307 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
* [CodeMirror](https://github.com/codemirror/CodeMirror) ⚠️ Archived - In-browser code editor.
* [ace](https://github.com/ajaxorg/ace) ⭐ 27,140 | 🐛 139 | 🌐 JavaScript | 📅 2026-08-13 - Ace (Ajax.org Cloud9 Editor).
* [Draft.js](https://github.com/facebook/draft-js) ⚠️ Archived - A React framework for building text editors.
* [trix](https://github.com/basecamp/trix) ⭐ 20,001 | 🐛 184 | 🌐 JavaScript | 📅 2026-08-11 - A rich text editor for everyday writing. By Basecamp.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,274 | 🐛 412 | 🌐 TypeScript | 📅 2026-08-17 - The JavaScript Rich Text editor.
...
* [Trumbowyg](https://github.com/Alex-D/Trumbowyg) ⭐ 4,151 | 🐛 120 | 🌐 JavaScript | 📅 2026-06-20 - A lightweight and amazing WYSIWYG JavaScript editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,761 | 🐛 416 | 🌐 JavaScript | 📅 2026-08-19 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,276 | 🐛 119 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,542 | 🐛 224 | 🌐 JavaScript | 📅 2026-08-13 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,022 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-20 - Browser-native components for previewing files without server-side conversion.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,697 | 🐛 180 | 🌐 TypeScript | 📅 2026-08-08 - A reactive programming library for JavaScript.
* [MobX](https://github.com/mobxjs/mobx) ⭐ 28,203 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-20 - TFRP library for simple, scalable state management.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,040 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-17 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [moment](https://github.com/moment/moment) ⭐ 47,914 | 🐛 185 | 🌐 JavaScript | 📅 2026-08-19 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,632 | 🐛 995 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,443 | 🐛 179 | 🌐 JavaScript | 📅 2026-08-09 - Luxon is a library for working with dates and times in JavaScript.
...
* [moment-timezone](https://github.com/moment/moment-timezone) ⭐ 3,878 | 🐛 76 | 🌐 JavaScript | 📅 2026-08-19 - Timezone support for moment.js.
...
* [underscore.string](https://github.com/epeli/underscore.string) ⭐ 3,359 | 🐛 121 | 🌐 JavaScript | 📅 2026-01-30 - String manipulation extensions for Underscore.js JavaScript library.
...
* [localForage](https://github.com/mozilla/localForage) ⭐ 25,804 | 🐛 250 | 🌐 JavaScript | 📅 2024-07-30 - Offline storage, improved. Wraps IndexedDB, WebSQL, or localStorage using a simple but powerful API.
...
* [pouchdb](https://github.com/pouchdb/pouchdb) ⭐ 17,600 | 🐛 186 | 🌐 JavaScript | 📅 2026-07-27 - Javascript db inspired by Apache CouchDB to run well within the browser.
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,539 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-17 - Dexie.js is a wrapper library for indexedDB.
...
* [randomColor](https://github.com/davidmerfield/randomColor) ⭐ 6,125 | 🐛 16 | 🌐 JavaScript | 📅 2025-12-03 - A color generator for JavaScript.
...
* [color-space](https://github.com/colorjs/color-space) ⭐ 382 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-11 - Conversions between 162 color spaces (OKLCH, CAM16, Munsell, camera logs) with cited references.

## I18n And L10n

*Localization (l10n) and internationalization (i18n) JavaScript libraries.*

* [i18next](https://github.com/i18next/i18next) ⭐ 8,617 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-20 - internationalisation (i18n) with JavaScript the easy way.
...
* [async](https://github.com/caolan/async) ⭐ 28,137 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-07 - Async utilities for node and the browser.
...
* [speedy-router](https://github.com/anonrig/router) ⭐ 147 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-20 - The TanStack Router API rebuilt for faster navigations and SSR.

## Security

* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,319 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,194 | 🐛 74 | 🌐 JavaScript | 📅 2026-08-20 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,173 | 🐛 154 | 🌐 TypeScript | 📅 2026-08-20 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,459 | 🐛 215 | 🌐 TypeScript | 📅 2026-08-13 - React Hooks library for remote data fetching.
* [wretch](https://github.com/elbywan/wretch) ⭐ 5,179 | 🐛 10 | 🌐 TypeScript | 📅 2026-06-19 - A tiny wrapper built around fetch with an intuitive syntax.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,905 | 🐛 0 | 🌐 Vue | 📅 2026-08-20 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,997 | 🐛 62 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native JavaScript code with zero dependencies.
...
* [bowser](https://github.com/ded/bowser) ⭐ 5,747 | 🐛 95 | 🌐 JavaScript | 📅 2026-08-01 - a browser detector.

## Operating System

* [os.js](https://github.com/os-js/OS.js) ⭐ 7,080 | 🐛 20 | 🌐 JavaScript | 📅 2022-12-12 - An open-source web desktop platform with a window manager, application APIs, GUI toolkit, filesystem abstractions and much more.
...
* [partytown](https://github.com/BuilderIO/partytown) ⭐ 13,757 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-03 - Relocate resource intensive third-party scripts off of the main thread and into a web worker.
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,783 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-11 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,980 | 🐛 89 | 🌐 JavaScript | 📅 2026-08-19 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,720 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
* [PrismJS](https://github.com/PrismJS/prism) ⭐ 13,037 | 🐛 483 | 🌐 JavaScript | 📅 2026-06-29 - Lightweight, robust, elegant syntax highlighting.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,736 | 🐛 476 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,606 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,789 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-19 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,622 | 🐛 112 | 🌐 TypeScript | 📅 2026-08-20 - Open-source notification infrastructure for products.
* [toastr](https://github.com/CodeSeven/toastr) ⭐ 12,105 | 🐛 154 | 🌐 JavaScript | 📅 2023-02-27 - Simple JavaScript toast notifications.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,159 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,883 | 🐛 254 | 🌐 TypeScript | 📅 2026-08-06 - Mobile touch slider and framework with hardware accelerated transitions.
...
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,393 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-11 - An extensible low level carousel for the web, written in TypeScript.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,613 | 🐛 1,129 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
* [tui.calendar](https://github.com/nhn/tui.calendar) ⭐ 12,696 | 🐛 208 | 🌐 TypeScript | 📅 2024-06-24 - A JavaScript schedule calendar that is full featured. Now your service just got the customizable calendar.
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,533 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [chosen](https://github.com/harvesthq/chosen) ⭐ 21,949 | 🐛 309 | 🌐 HTML | 📅 2024-12-02 - A library for making long, unwieldy select boxes more friendly.
...
* [dropzone](https://github.com/enyo/dropzone) ⭐ 18,379 | 🐛 149 | 🌐 JavaScript | 📅 2024-07-15 - Dropzone is an easy to use drag'n'drop library. It supports image previews and shows nice progress bars.
...
* [SweetAlert2](https://github.com/sweetalert2/sweetalert2) ⭐ 18,101 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-20 - An awesome replacement for JavaScript's alert.
...
* [fullPage](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,409 | 🐛 127 | 🌐 JavaScript | 📅 2026-03-17 - A simple and easy to use plugin to create fullscreen scrolling websites (also known as single page websites).
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,598 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-10 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
* [Wasp](https://github.com/wasp-lang/wasp) ⭐ 18,692 | 🐛 842 | 🌐 TypeScript | 📅 2026-08-20 Wasp is a declarative domain-specific language for developing, building, and deploying modern Javascript full-stack web apps with less code.
* [Cerberus](https://github.com/TedGoas/Cerberus) ⭐ 5,128 | 🐛 13 | 🌐 HTML | 📅 2024-07-16 - A few simple, but solid patterns for responsive HTML emails. Even in Outlook.
...
* [Dragula](https://github.com/bevacqua/dragula/) ⭐ 22,139 | 🐛 159 | 🌐 JavaScript | 📅 2024-06-07 - Drag and drop so simple it hurts.
* [touchemulator](https://github.com/hammerjs/touchemulator) ⭐ 406 | 🐛 17 | 🌐 JavaScript | 📅 2022-11-17 - Emulate touch input on your desktop.

## Maps

* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,498 | 🐛 561 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,588 | 🐛 1,647 | 🌐 JavaScript | 📅 2026-08-20 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,475 | 🐛 166 | 🌐 C | 📅 2026-08-17 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,859 | 🐛 664 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,880 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-20 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [clappr](https://github.com/clappr/clappr) ⭐ 7,494 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 - An extensible media player for the web <http://clappr.io>
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,738 | 🐛 79 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
* [particles.js](https://github.com/VincentGarreau/particles.js) ⭐ 30,205 | 🐛 367 | 🌐 JavaScript | 📅 2024-03-28 - A lightweight JavaScript library for creating particles.
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,876 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,987 | 🐛 773 | 🌐 TypeScript | 📅 2026-08-16 - Turn ES6+ code into vanilla ES5 with no runtime.
* [es6features](https://github.com/lukehoban/es6features) ⭐ 29,033 | 🐛 38 | 📅 2023-01-27 - Overview of ECMAScript 6 features.
* [es6-cheatsheet](https://github.com/DrkSephy/es6-cheatsheet) ⭐ 13,325 | 🐛 7 | 🌐 JavaScript | 📅 2022-10-08 - ES2015 \[ES6] cheatsheet containing tips, tricks, best practices and code snippets.
...
* [es6-features](https://github.com/rse/es6-features) ⭐ 6,158 | 🐛 33 | 🌐 HTML | 📅 2024-06-20 - ECMAScript 6: Feature Overview & Comparison.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,880 | 🐛 4,063 | 🌐 JavaScript | 📅 2026-08-20 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,017 | 🐛 416 | 🌐 TypeScript | 📅 2026-08-20 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 61,889 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-20 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,770 | 🐛 535 | 🌐 TypeScript | 📅 2026-08-20 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,943 | 🐛 421 | 🌐 JavaScript | 📅 2026-08-20 - React-based static site generator.
...
* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,125 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-20 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,485 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-20 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,776 | 🐛 36 | 🌐 JavaScript | 📅 2026-06-28 - It is a Next-Generation full text search library for Browser and Node.js.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,575 | 🐛 2,543 | 🌐 TypeScript | 📅 2026-08-20 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,631 | 🐛 621 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,528 | 🐛 1,959 | 🌐 TypeScript | 📅 2026-08-19 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,372 | 🐛 1,081 | 🌐 TypeScript | 📅 2026-08-16 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,472 | 🐛 176 | 🌐 JavaScript | 📅 2026-08-20 MongoDB object modeling designed to work in an asynchronous environment.
...
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,139 | 🐛 173 | 🌐 TypeScript | 📅 2026-08-17 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,176 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-20 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,192 | 🐛 191 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
* [ws](https://github.com/websockets/ws) ⭐ 22,792 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-13 Simple to use, blazing fast and thoroughly tested WebSocket client and server for Node.js.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,525 | 🐛 405 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,313 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,056 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,033 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,846 | 🐛 491 | 🌐 TypeScript | 📅 2026-08-20 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [enum-plus](https://github.com/shijistar/enum-plus) ⭐ 202 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-20 - A drop-in enhancement for native TypeScript enums, adding display text, internationalization and full type safety.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,706 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 498,141 | 🐛 105 | 📅 2026-08-18
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,343 | 🐛 81 | 📅 2026-08-20
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,425 | 🐛 21 | 📅 2026-03-23
* [davidsonfellipe/awesome-wpo](https://github.com/davidsonfellipe/awesome-wpo) ⭐ 9,040 | 🐛 17 | 📅 2026-07-28
...
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,645 | 🐛 90 | 📅 2025-07-20
