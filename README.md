...
* [Bower](https://github.com/bower/bower) ⭐ 14,908 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-13 - A package manager for the web.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,470 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-01 - Create, find and reuse components (React, Angular, Node etc.) across applications.

## Loaders

*Module or loading system for JavaScript.*

* [browserify](https://github.com/substack/node-browserify) ⭐ 14,700 | 🐛 380 | 🌐 JavaScript | 📅 2024-12-21 - Browser-side require() the node.js way.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,960 | 🐛 136 | 🌐 JavaScript | 📅 2026-09-01 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,023 | 🐛 608 | 🌐 JavaScript | 📅 2026-08-30 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,306 | 🐛 608 | 🌐 JavaScript | 📅 2026-08-31 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,327 | 🐛 354 | 🌐 JavaScript | 📅 2026-08-27 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,747 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-01 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,671 | 🐛 252 | 🌐 TypeScript | 📅 2026-09-01 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,471 | 🐛 189 | 🌐 TypeScript | 📅 2026-09-01 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,906 | 🐛 266 | 🌐 JavaScript | 📅 2026-09-01 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
...
* [Supertest](https://github.com/visionmedia/supertest) ⭐ 14,397 | 🐛 190 | 🌐 JavaScript | 📅 2026-04-02 - A popular HTTP assertion library for testing REST APIs, often used with other testing frameworks like Mocha or Jest
* [Sinon.JS](https://github.com/sinonjs/sinon) ⭐ 9,758 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-05 - Test spies, stubs, and mocks for JavaScript.
* [chai](https://github.com/chaijs/chai) ⭐ 8,269 | 🐛 92 | 🌐 JavaScript | 📅 2026-08-31 - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,535 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-01 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,484 | 🐛 175 | 🌐 TypeScript | 📅 2026-09-01 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,832 | 🐛 294 | 🌐 TypeScript | 📅 2026-08-31 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,230 | 🐛 1,415 | 🌐 JavaScript | 📅 2026-09-01 - Prettier is an opinionated code formatter.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,496 | 🐛 134 | 🌐 JavaScript | 📅 2026-09-01 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,992 | 🐛 439 | 🌐 JavaScript | 📅 2026-08-31 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,437 | 🐛 8 | 🌐 Rust | 📅 2026-09-01 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 255 | 🐛 3 | 🌐 Go | 📅 2026-08-07 - Trace imports, identify circular dependencies, find unused code, clean node modules — all from a blazing-fast CLI.
...
* [vue](https://github.com/vuejs/vue) ⭐ 211,265 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,476 | 🐛 1,171 | 🌐 C++ | 📅 2026-09-01 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,020 | 🐛 1,142 | 🌐 TypeScript | 📅 2026-09-01 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 88,040 | 🐛 1,055 | 🌐 JavaScript | 📅 2026-09-01 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,809 | 🐛 333 | 🌐 JavaScript | 📅 2026-09-01 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,849 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-29 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,901 | 🐛 2 | 🌐 HTML | 📅 2026-08-31 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,181 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-26 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,635 | 🐛 833 | 🌐 TypeScript | 📅 2026-09-01 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,569 | 🐛 264 | 🌐 TypeScript | 📅 2026-09-01 - A JavaScript framework for creating ambitious web applications.
* [hyperapp](https://github.com/hyperapp/hyperapp) ⭐ 19,197 | 🐛 14 | 🌐 JavaScript | 📅 2025-03-20 - 1kb JavaScript library for building frontend applications.
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,104 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-27 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [mithril.js](https://github.com/lhorie/mithril.js) ⭐ 14,495 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13 - Mithril is a client-side MVC framework (Light-weight, Robust, Fast).
* [Blockly](https://github.com/google/blockly) ⭐ 13,546 | 🐛 382 | 🌐 JavaScript | 📅 2026-08-31 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,229 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
* [knockout](https://github.com/knockout/knockout) ⭐ 10,554 | 🐛 352 | 🌐 JavaScript | 📅 2026-03-25 - Knockout makes it easier to create rich, responsive UIs with JavaScript.
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 8,122 | 🐛 146 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 73,057 | 🐛 550 | 🌐 TypeScript | 📅 2026-09-01 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,095 | 🐛 141 | 🌐 JavaScript | 📅 2026-09-01 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,966 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-01 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,611 | 🐛 134 | 🌐 JavaScript | 📅 2026-09-01 - CMS with content editing and essential services.
...
* [marko](https://github.com/marko-js/marko) ⭐ 14,412 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-01 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 115,002 | 🐛 384 | 🌐 JavaScript | 📅 2026-09-01 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,588 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,675 | 🐛 586 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,210 | 🐛 1,522 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,418 | 🐛 469 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
* [recharts](https://github.com/recharts/recharts) ⭐ 27,532 | 🐛 441 | 🌐 TypeScript | 📅 2026-09-01 - Redefined chart library built with React and D3.
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,999 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-01 - A framework for building 3D games with HTML 5 and WebGL.
...
* [G2](https://github.com/antvis/G2) ⭐ 12,600 | 🐛 183 | 🌐 TypeScript | 📅 2026-08-31 - A highly interactive data-driven visualization grammar for statistical charts.
* [G6](https://github.com/antvis/g6) ⭐ 12,280 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,156 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-20 - A JavaScript library dedicated to graph drawing.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,193 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-01 - A fully featured graph theory library.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,514 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-21 - A next-generation declarative infographic visualization engine.
...
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,102 | 🐛 77 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,908 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,366 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-28 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,030 | 🐛 47 | 🌐 JavaScript | 📅 2026-09-01 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,439 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-01 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [quill](https://github.com/quilljs/quill) ⭐ 47,318 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
...
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,287 | 🐛 415 | 🌐 TypeScript | 📅 2026-09-01 - The JavaScript Rich Text editor.
* [medium-editor](https://github.com/yabwe/medium-editor) ⭐ 16,102 | 🐛 359 | 🌐 JavaScript | 📅 2024-10-24 - Medium.com WYSIWYG editor clone.
* [jsoneditor](https://github.com/josdejong/jsoneditor) ⭐ 12,264 | 🐛 233 | 🌐 JavaScript | 📅 2026-08-15 - A web-based tool to view, edit and format JSON.
...
* [bootstrap-wysihtml5](https://github.com/jhollingworth/bootstrap-wysihtml5) ⭐ 4,109 | 🐛 192 | 🌐 JavaScript | 📅 2020-04-14 - Simple, beautiful wysiwyg editor
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,807 | 🐛 412 | 🌐 JavaScript | 📅 2026-09-01 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,295 | 🐛 116 | 🌐 JavaScript | 📅 2026-08-28 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,558 | 🐛 215 | 🌐 JavaScript | 📅 2026-09-01 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,198 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-01 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,277 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,037 | 🐛 130 | 🌐 TypeScript | 📅 2026-08-27 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,663 | 🐛 1,315 | 🌐 JavaScript | 📅 2026-09-01 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 47,914 | 🐛 106 | 🌐 JavaScript | 📅 2026-08-23 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,643 | 🐛 1,004 | 🌐 TypeScript | 📅 2026-08-30 - Modern JavaScript date utility library.
...
* [colors](https://github.com/mrmrs/colors) ⭐ 9,411 | 🐛 16 | 🌐 CSS | 📅 2023-07-20 - Smarter defaults for colors on the web.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,625 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-01 - internationalisation (i18n) with JavaScript the easy way.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,351 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-29 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [pompelmi](https://github.com/pompelmi/pompelmi) ⭐ 673 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-23 - Fast file-upload malware scanning for Node.js.
...
* [axios](https://github.com/axios/axios) ⭐ 109,197 | 🐛 87 | 🌐 JavaScript | 📅 2026-09-01 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,242 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-01 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,476 | 🐛 219 | 🌐 TypeScript | 📅 2026-08-23 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,980 | 🐛 3 | 🌐 Vue | 📅 2026-09-01 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [tracking.js](https://github.com/eduardolundgren/tracking.js) ⭐ 9,464 | 🐛 227 | 🌐 JavaScript | 📅 2026-08-11 - A modern approach for Computer Vision on the web.
...
* [partytown](https://github.com/BuilderIO/partytown) ⭐ 13,767 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-25 - Relocate resource intensive third-party scripts off of the main thread and into a web worker.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,990 | 🐛 96 | 🌐 JavaScript | 📅 2026-08-30 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,768 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,738 | 🐛 493 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,656 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,808 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-01 - Guide your users through a tour of your app.
* [bootstrap-tour](https://github.com/sorich87/bootstrap-tour) ⭐ 4,406 | 🐛 193 | 🌐 CoffeeScript | 📅 2023-10-09 - Quick and easy product tours with Twitter Bootstrap Popovers.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,705 | 🐛 105 | 🌐 TypeScript | 📅 2026-09-01 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,241 | 🐛 911 | 🌐 JavaScript | 📅 2026-08-24 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,899 | 🐛 238 | 🌐 TypeScript | 📅 2026-08-28 - Mobile touch slider and framework with hardware accelerated transitions.
...
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,402 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-21 - An extensible low level carousel for the web, written in TypeScript.
...
* [Ion.RangeSlider](https://github.com/IonDen/ion.rangeSlider) ⭐ 2,544 | 🐛 84 | 🌐 JavaScript | 📅 2026-08-30 - Powerful and easily customizable range slider with many options and skin support.
...
* [typeahead.js](https://github.com/twitter/typeahead.js) ⭐ 16,439 | 🐛 506 | 🌐 JavaScript | 📅 2023-04-14 - A fast and fully-featured autocomplete library.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,621 | 🐛 1,131 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,546 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-31 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [chosen](https://github.com/harvesthq/chosen) ⭐ 21,941 | 🐛 309 | 🌐 HTML | 📅 2024-12-02 - A library for making long, unwieldy select boxes more friendly.
...
* [filepond](https://github.com/pqina/filepond) ⭐ 16,391 | 🐛 140 | 🌐 JavaScript | 📅 2026-08-28 - A JavaScript library that can upload anything you throw at it, optimizes images for faster uploads, and offers a great, accessible, silky smooth user experience.
...
* [SweetAlert2](https://github.com/sweetalert2/sweetalert2) ⭐ 18,102 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-20 - An awesome replacement for JavaScript's alert.
...
* [lightGallery](https://github.com/sachinchoolur/lightGallery) ⭐ 7,053 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-07 - A customizable, modular, responsive, lightbox gallery plugin for jQuery.
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,855 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-30 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,607 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-01 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,547 | 🐛 567 | 🌐 JavaScript | 📅 2026-09-01 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,635 | 🐛 1,649 | 🌐 JavaScript | 📅 2026-09-01 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,515 | 🐛 164 | 🌐 C | 📅 2026-09-01 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,871 | 🐛 671 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,913 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-01 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [clappr](https://github.com/clappr/clappr) ⭐ 7,495 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-01 - An extensible media player for the web <http://clappr.io>
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,767 | 🐛 80 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 28,165 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,974 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-31 - A new and improved version of particles.js with bug fixes and many new features.
...
* [bounce.js](https://github.com/tictail/bounce.js) ⭐ 6,159 | 🐛 12 | 🌐 CSS | 📅 2020-09-03 - Create tasty CSS3 powered animations in no time.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,987 | 🐛 778 | 🌐 TypeScript | 📅 2026-08-31 - Turn ES6+ code into vanilla ES5 with no runtime.
* [es6features](https://github.com/lukehoban/es6features) ⭐ 29,032 | 🐛 38 | 📅 2023-01-27 - Overview of ECMAScript 6 features.
* [es6-cheatsheet](https://github.com/DrkSephy/es6-cheatsheet) ⭐ 13,319 | 🐛 7 | 🌐 JavaScript | 📅 2022-10-08 - ES2015 \[ES6] cheatsheet containing tips, tricks, best practices and code snippets.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 142,061 | 🐛 3,520 | 🌐 JavaScript | 📅 2026-09-01 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,145 | 🐛 398 | 🌐 TypeScript | 📅 2026-09-01 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 62,217 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-01 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,806 | 🐛 543 | 🌐 TypeScript | 📅 2026-09-01 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,943 | 🐛 438 | 🌐 JavaScript | 📅 2026-08-29 - React-based static site generator.
...
* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,157 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-01 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,499 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-01 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,789 | 🐛 38 | 🌐 JavaScript | 📅 2026-06-28 - It is a Next-Generation full text search library for Browser and Node.js.
...
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,643 | 🐛 619 | 🌐 TypeScript | 📅 2026-09-01 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,652 | 🐛 1,997 | 🌐 TypeScript | 📅 2026-09-01 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,373 | 🐛 1,079 | 🌐 TypeScript | 📅 2026-09-01 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,476 | 🐛 169 | 🌐 JavaScript | 📅 2026-08-30 MongoDB object modeling designed to work in an asynchronous environment.
...
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,189 | 🐛 170 | 🌐 TypeScript | 📅 2026-08-31 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,196 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-01 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,206 | 🐛 203 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
* [ws](https://github.com/websockets/ws) ⭐ 22,795 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-13 Simple to use, blazing fast and thoroughly tested WebSocket client and server for Node.js.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,587 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,397 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,098 | 🐛 423 | 🌐 TypeScript | 📅 2026-08-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,052 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-28 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,863 | 🐛 486 | 🌐 TypeScript | 📅 2026-09-01 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [enum-plus](https://github.com/shijistar/enum-plus) ⭐ 205 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01 - A drop-in enhancement for native TypeScript enums, adding display text, internationalization and full type safety.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,769 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
* [Clean Code JavaScript](https://github.com/ryanmcdermott/clean-code-javascript) ⭐ 94,755 | 🐛 123 | 🌐 JavaScript | 📅 2024-07-29 - Clean Code concepts adapted for JavaScript.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 501,992 | 🐛 105 | 📅 2026-08-21
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,460 | 🐛 89 | 📅 2026-08-20
* [bayandin/awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,638 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02
* [bolshchikov/js-must-watch](https://github.com/bolshchikov/js-must-watch) ⭐ 13,605 | 🐛 0 | 📅 2022-01-20
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,450 | 🐛 24 | 📅 2026-03-23
