...
* [Bit](https://github.com/teambit/bit) ⭐ 18,457 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-19 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,969 | 🐛 139 | 🌐 JavaScript | 📅 2026-08-19 - Packs CommonJs/AMD modules for the browser.
...
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,305 | 🐛 604 | 🌐 JavaScript | 📅 2026-08-16 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,321 | 🐛 349 | 🌐 JavaScript | 📅 2026-08-14 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,492 | 🐛 142 | 🌐 TypeScript | 📅 2026-08-19 - TypeScript-first schema validation with built-in static type inference.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,468 | 🐛 180 | 🌐 TypeScript | 📅 2026-08-19 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,902 | 🐛 261 | 🌐 JavaScript | 📅 2026-08-19 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,832 | 🐛 72 | 🌐 JavaScript | 📅 2026-06-17 - 🚀 Futuristic JavaScript test runner
* [jasmine](https://github.com/jasmine/jasmine) ⭐ 15,823 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-18 - DOM-less simple JavaScript testing framework.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,465 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-19 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,745 | 🐛 163 | 🌐 TypeScript | 📅 2026-08-19 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,817 | 🐛 294 | 🌐 TypeScript | 📅 2026-08-19 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,204 | 🐛 1,418 | 🌐 JavaScript | 📅 2026-08-19 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,277 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,992 | 🐛 436 | 🌐 JavaScript | 📅 2026-08-17 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,354 | 🐛 2 | 🌐 Rust | 📅 2026-08-19 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,236 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,365 | 🐛 1,054 | 🌐 C++ | 📅 2026-08-19 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,006 | 🐛 1,138 | 🌐 TypeScript | 📅 2026-08-19 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,979 | 🐛 1,132 | 🌐 JavaScript | 📅 2026-08-19 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
...
* [preact](https://github.com/developit/preact) ⭐ 38,824 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-17 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,145 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,610 | 🐛 834 | 🌐 TypeScript | 📅 2026-08-19 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,565 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-19 - A JavaScript framework for creating ambitious web applications.
...
* [inferno](https://github.com/infernojs/inferno) ⭐ 16,451 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-19 - 🔥 An extremely fast, React-like JavaScript library for building modern user interfaces.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,522 | 🐛 338 | 🌐 JavaScript | 📅 2026-08-19 - A library that adds a visual code editor to web and mobile apps by Google.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 72,965 | 🐛 547 | 🌐 TypeScript | 📅 2026-08-19 - Open source Node.js Headless CMS to easily build customisable APIs.
...
* [Factor](https://github.com/fiction-com/factor) ⭐ 1,464 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-16 - The Javascript CMS
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,613 | 🐛 372 | 🌐 JavaScript | 📅 2026-08-19 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,496 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,643 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,095 | 🐛 1,555 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,394 | 🐛 468 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
* [recharts](https://github.com/recharts/recharts) ⭐ 27,509 | 🐛 436 | 🌐 TypeScript | 📅 2026-08-19 - Redefined chart library built with React and D3.
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,947 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-14 - A framework for building 3D games with HTML 5 and WebGL.
...
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,139 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-18 - A JavaScript library dedicated to graph drawing.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,362 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-19 - A next-generation declarative infographic visualization engine.
...
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,353 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-19 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,023 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-19 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [quill](https://github.com/quilljs/quill) ⭐ 47,304 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
...
* [trix](https://github.com/basecamp/trix) ⭐ 19,999 | 🐛 184 | 🌐 JavaScript | 📅 2026-08-11 - A rich text editor for everyday writing. By Basecamp.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,755 | 🐛 414 | 🌐 JavaScript | 📅 2026-08-19 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,277 | 🐛 119 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,541 | 🐛 224 | 🌐 JavaScript | 📅 2026-08-13 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,013 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-19 - Browser-native components for previewing files without server-side conversion.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,697 | 🐛 179 | 🌐 TypeScript | 📅 2026-08-08 - A reactive programming library for JavaScript.
* [MobX](https://github.com/mobxjs/mobx) ⭐ 28,203 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-19 - TFRP library for simple, scalable state management.
...
* [moment](https://github.com/moment/moment) ⭐ 47,914 | 🐛 190 | 🌐 JavaScript | 📅 2026-08-19 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,629 | 🐛 995 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,442 | 🐛 179 | 🌐 JavaScript | 📅 2026-08-09 - Luxon is a library for working with dates and times in JavaScript.
...
* [moment-timezone](https://github.com/moment/moment-timezone) ⭐ 3,877 | 🐛 75 | 🌐 JavaScript | 📅 2026-08-19 - Timezone support for moment.js.
...
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,537 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-17 - Dexie.js is a wrapper library for indexedDB.
...
* [axios](https://github.com/axios/axios) ⭐ 109,199 | 🐛 70 | 🌐 JavaScript | 📅 2026-08-19 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,165 | 🐛 175 | 🌐 TypeScript | 📅 2026-08-19 - Hooks for fetching, caching and updating asynchronous data in React.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,902 | 🐛 0 | 🌐 Vue | 📅 2026-08-19 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,782 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-11 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,603 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,784 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-17 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,616 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-19 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,152 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,884 | 🐛 254 | 🌐 TypeScript | 📅 2026-08-06 - Mobile touch slider and framework with hardware accelerated transitions.
...
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,392 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-11 - An extensible low level carousel for the web, written in TypeScript.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,612 | 🐛 1,129 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [rellax](https://github.com/dixonandmoe/rellax) ⭐ 7,135 | 🐛 76 | 🌐 HTML | 📅 2024-08-24 - Buttery smooth, super lightweight, vanilla javascript parallax library.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,495 | 🐛 561 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,583 | 🐛 1,646 | 🌐 JavaScript | 📅 2026-08-19 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,473 | 🐛 165 | 🌐 C | 📅 2026-08-17 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,877 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-19 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,736 | 🐛 79 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,839 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,199 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [barbajs](https://github.com/barbajs/barba) ⭐ 12,968 | 🐛 15 | 🌐 TypeScript | 📅 2024-12-02 - It helps you create fluid and smooth transitions between your website's pages.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,986 | 🐛 771 | 🌐 TypeScript | 📅 2026-08-16 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,868 | 🐛 4,091 | 🌐 JavaScript | 📅 2026-08-19 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 65,999 | 🐛 432 | 🌐 TypeScript | 📅 2026-08-13 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 61,864 | 🐛 133 | 🌐 TypeScript | 📅 2026-08-19 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,763 | 🐛 537 | 🌐 TypeScript | 📅 2026-08-19 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,942 | 🐛 422 | 🌐 JavaScript | 📅 2026-08-19 - React-based static site generator.
...
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,629 | 🐛 621 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,519 | 🐛 1,957 | 🌐 TypeScript | 📅 2026-08-19 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,471 | 🐛 173 | 🌐 JavaScript | 📅 2026-08-19 MongoDB object modeling designed to work in an asynchronous environment.
...
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,176 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-19 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,191 | 🐛 191 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
...
* [KaibanJS](https://github.com/kaiban-ai/KaibanJS) ⭐ 1,470 | 🐛 78 | 🌐 TypeScript | 📅 2026-05-15 - KaibanJS is an open-source framework browser-compatibility of orchestration of multi-agent ai systems using a Kanban-inspired architecture.

## Misc

* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,526 | 🐛 405 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,300 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,053 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,031 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,845 | 🐛 491 | 🌐 TypeScript | 📅 2026-08-19 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [enum-plus](https://github.com/shijistar/enum-plus) ⭐ 202 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-19 - A drop-in enhancement for native TypeScript enums, adding display text, internationalization and full type safety.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,712 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
* [Clean Code JavaScript](https://github.com/ryanmcdermott/clean-code-javascript) ⭐ 94,757 | 🐛 123 | 🌐 JavaScript | 📅 2024-07-29 - Clean Code concepts adapted for JavaScript.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 497,730 | 🐛 102 | 📅 2026-08-18
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,335 | 🐛 82 | 📅 2026-07-20
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,421 | 🐛 21 | 📅 2026-03-23
* [davidsonfellipe/awesome-wpo](https://github.com/davidsonfellipe/awesome-wpo) ⭐ 9,037 | 🐛 17 | 📅 2026-07-28
