...
* [Bower](https://github.com/bower/bower) ⭐ 14,911 | 🐛 15 | 🌐 JavaScript | 📅 2024-10-13 - A package manager for the web.
...
* [jspm](https://github.com/jspm/jspm-cli) ⭐ 3,867 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-17 - Frictionless browser package management.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,462 | 🐛 90 | 🌐 TypeScript | 📅 2026-08-26 - Create, find and reuse components (React, Angular, Node etc.) across applications.

## Loaders

*Module or loading system for JavaScript.*

* [browserify](https://github.com/substack/node-browserify) ⭐ 14,701 | 🐛 380 | 🌐 JavaScript | 📅 2024-12-21 - Browser-side require() the node.js way.
...
* [script.js](https://github.com/ded/script.js) ⭐ 2,923 | 🐛 51 | 🌐 JavaScript | 📅 2020-04-14 - Asynchronous JavaScript loader and dependency manager.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,962 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-26 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,019 | 🐛 603 | 🌐 JavaScript | 📅 2026-08-26 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,306 | 🐛 602 | 🌐 JavaScript | 📅 2026-08-25 - Next-generation ES6 module bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,326 | 🐛 348 | 🌐 JavaScript | 📅 2026-08-26 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,530 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-26 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,671 | 🐛 252 | 🌐 TypeScript | 📅 2026-08-25 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,475 | 🐛 183 | 🌐 TypeScript | 📅 2026-08-25 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,905 | 🐛 265 | 🌐 JavaScript | 📅 2026-08-25 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,830 | 🐛 72 | 🌐 JavaScript | 📅 2026-06-17 - 🚀 Futuristic JavaScript test runner
* [jasmine](https://github.com/jasmine/jasmine) ⭐ 15,823 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-20 - DOM-less simple JavaScript testing framework.
...
* [react testing library](https://github.com/kentcdodds/react-testing-library) ⭐ 19,645 | 🐛 83 | 🌐 JavaScript | 📅 2026-04-02 - Simple and complete React DOM testing utilities that encourage good testing practices.
* [Supertest](https://github.com/visionmedia/supertest) ⭐ 14,396 | 🐛 190 | 🌐 JavaScript | 📅 2026-04-02 - A popular HTTP assertion library for testing REST APIs, often used with other testing frameworks like Mocha or Jest
* [Sinon.JS](https://github.com/sinonjs/sinon) ⭐ 9,758 | 🐛 59 | 🌐 JavaScript | 📅 2026-08-05 - Test spies, stubs, and mocks for JavaScript.
* [chai](https://github.com/chaijs/chai) ⭐ 8,269 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-24 - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework.
...
* [blanket](https://github.com/alex-seville/blanket) ⭐ 1,395 | 🐛 162 | 🌐 JavaScript | 📅 2022-12-06 - A simple code coverage library for JavaScript. Designed to be easy to install and use, for both browser and nodejs.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,498 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-26 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,161 | 🐛 180 | 🌐 TypeScript | 📅 2026-08-26 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,826 | 🐛 284 | 🌐 TypeScript | 📅 2026-08-26 - Next-gen WebDriver test automation framework for Node.js.
...
* [taiko](https://github.com/getgauge/taiko) ⭐ 3,674 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-25 - A Node.js library with a simple API to automate Chromium based browsers.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,213 | 🐛 1,413 | 🌐 JavaScript | 📅 2026-08-26 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,286 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,484 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-25 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
* [JSHint](https://github.com/jshint/jshint/) ⭐ 9,073 | 🐛 465 | 🌐 JavaScript | 📅 2025-02-13 - JSHint is a tool that helps to detect errors and potential problems in your JavaScript code.
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,993 | 🐛 438 | 🌐 JavaScript | 📅 2026-08-17 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,412 | 🐛 9 | 🌐 Rust | 📅 2026-08-26 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [jsinspect](https://github.com/danielstjules/jsinspect) ⭐ 3,582 | 🐛 25 | 🌐 JavaScript | 📅 2024-03-20 - Detect copy-pasted and structurally similar code.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,682 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,410 | 🐛 1,098 | 🌐 C++ | 📅 2026-08-26 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,000 | 🐛 1,132 | 🌐 TypeScript | 📅 2026-08-26 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,991 | 🐛 1,053 | 🌐 JavaScript | 📅 2026-08-26 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,813 | 🐛 388 | 🌐 JavaScript | 📅 2026-08-26 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,834 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-26 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,881 | 🐛 3 | 🌐 HTML | 📅 2026-08-25 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,165 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-26 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,626 | 🐛 834 | 🌐 TypeScript | 📅 2026-08-26 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,566 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-26 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,101 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-21 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [feathers](https://github.com/feathersjs/feathers) ⭐ 15,267 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-14 - A minimalist real-time JavaScript framework for tomorrow's apps.
* [riot](https://github.com/riot/riot) ⭐ 14,914 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-06 - React-like library, but with very small size.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,532 | 🐛 334 | 🌐 JavaScript | 📅 2026-08-25 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,226 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 8,114 | 🐛 146 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Drawflow](https://github.com/jerosoler/Drawflow) ⭐ 6,106 | 🐛 272 | 🌐 JavaScript | 📅 2024-10-19 - This allow you to create data flows easily and quickly.
* [ractive](https://github.com/ractivejs/ractive) ⭐ 5,913 | 🐛 74 | 🌐 JavaScript | 📅 2024-05-22 - Next-generation DOM manipulation.
* [derby](https://github.com/derbyjs/derby) ⭐ 4,704 | 🐛 23 | 🌐 TypeScript | 📅 2024-10-24 - MVC framework making it easy to write realtime, collaborative applications that run in both Node.js and browsers.
...
* [Remult](https://github.com/remult/remult) ⭐ 3,208 | 🐛 118 | 🌐 TypeScript | 📅 2026-08-24 - A CRUD framework for full-stack TypeScript.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 73,016 | 🐛 545 | 🌐 TypeScript | 📅 2026-08-26 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 55,064 | 🐛 141 | 🌐 JavaScript | 📅 2026-08-26 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,963 | 🐛 137 | 🌐 TypeScript | 📅 2026-08-26 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,607 | 🐛 135 | 🌐 JavaScript | 📅 2026-08-25 - CMS with content editing and essential services.
...
* [handlebars.js](https://github.com/handlebars-lang/handlebars.js) ⭐ 18,670 | 🐛 113 | 🌐 JavaScript | 📅 2026-06-24 - An extension to the Mustache templating language.
* [mustache.js](https://github.com/janl/mustache.js) ⭐ 16,724 | 🐛 120 | 🌐 JavaScript | 📅 2024-06-14 - Minimal templating with {{mustaches}} in JavaScript.
* [marko](https://github.com/marko-js/marko) ⭐ 14,407 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-26 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
* [EJS](https://github.com/mde/ejs) ⭐ 8,121 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-10 - Effective JavaScript templating.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,806 | 🐛 380 | 🌐 JavaScript | 📅 2026-08-26 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,556 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,665 | 🐛 584 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,155 | 🐛 1,538 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,411 | 🐛 468 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,986 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-26 - A framework for building 3D games with HTML 5 and WebGL.
* [Frappe Charts](https://github.com/frappe/charts) ⭐ 15,078 | 🐛 146 | 🌐 JavaScript | 📅 2025-07-02 - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
* [paper.js](https://github.com/paperjs/paper.js) ⭐ 15,068 | 🐛 429 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting – Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
* [G2](https://github.com/antvis/G2) ⭐ 12,595 | 🐛 182 | 🌐 TypeScript | 📅 2026-07-15 - A highly interactive data-driven visualization grammar for statistical charts.
* [G6](https://github.com/antvis/g6) ⭐ 12,272 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,148 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-20 - A JavaScript library dedicated to graph drawing.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,188 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-25 - A fully featured graph theory library.
...
* [c3](https://github.com/c3js/c3) ⭐ 9,348 | 🐛 771 | 🌐 JavaScript | 📅 2026-08-05 - D3-based reusable chart library.
* [two.js](https://github.com/jonobr1/two.js) ⭐ 8,652 | 🐛 36 | 🌐 JavaScript | 📅 2026-08-24 - A renderer agnostic two-dimensional drawing api for the web.
...
* [nvd3](https://github.com/novus/nvd3) ⭐ 7,225 | 🐛 565 | 🌐 JavaScript | 📅 2023-09-15 - Build re-usable charts and chart components for d3.js.
...
* [morris.js](https://github.com/morrisjs/morris.js) ⭐ 6,879 | 🐛 323 | 🌐 CoffeeScript | 📅 2021-10-07 - Pretty time-series line graphs.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,385 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-21 - A next-generation declarative infographic visualization engine.
* [heatmap.js](https://github.com/pa7/heatmap.js) ⭐ 6,378 | 🐛 164 | 🌐 JavaScript | 📅 2023-10-31 - JavaScript Library for HTML5 canvas based heatmaps.
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,096 | 🐛 77 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,361 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-26 - Diagramming library to create static diagrams or fully interactive diagramming tools.
* [epoch](https://github.com/epochjs/epoch) ⭐ 4,949 | 🐛 69 | 🌐 HTML | 📅 2019-02-14 - A general purpose real-time charting library.
...
* [d3-cloud](https://github.com/jasondavies/d3-cloud) ⭐ 3,950 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-09 - Create word clouds in JavaScript.
...
* [vizzu](https://github.com/vizzuhq/vizzu-lib) ⭐ 2,024 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-20 - Library for animated data visualizations and data stories.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,028 | 🐛 82 | 🌐 JavaScript | 📅 2026-08-26 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,440 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-24 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
* [Frappe Datatable](https://github.com/frappe/datatable) ⭐ 1,331 | 🐛 62 | 🌐 JavaScript | 📅 2026-07-22 - Frappe DataTable is a simple, modern and interactive datatable library for displaying tabular data.

## Editors

* [quill](https://github.com/quilljs/quill) ⭐ 47,319 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
* [CodeMirror](https://github.com/codemirror/CodeMirror) ⚠️ Archived - In-browser code editor.
* [ace](https://github.com/ajaxorg/ace) ⭐ 27,143 | 🐛 140 | 🌐 JavaScript | 📅 2026-08-13 - Ace (Ajax.org Cloud9 Editor).
* [Draft.js](https://github.com/facebook/draft-js) ⚠️ Archived - A React framework for building text editors.
* [trix](https://github.com/basecamp/trix) ⭐ 20,004 | 🐛 185 | 🌐 JavaScript | 📅 2026-08-21 - A rich text editor for everyday writing. By Basecamp.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,280 | 🐛 412 | 🌐 TypeScript | 📅 2026-08-17 - The JavaScript Rich Text editor.
...
* [Squire](https://github.com/neilj/Squire) ⭐ 4,908 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-26 - HTML5 rich text editor.
...
* [Trumbowyg](https://github.com/Alex-D/Trumbowyg) ⭐ 4,145 | 🐛 120 | 🌐 JavaScript | 📅 2026-06-20 - A lightweight and amazing WYSIWYG JavaScript editor.
* [bootstrap-wysihtml5](https://github.com/jhollingworth/bootstrap-wysihtml5) ⭐ 4,110 | 🐛 192 | 🌐 JavaScript | 📅 2020-04-14 - Simple, beautiful wysiwyg editor
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,785 | 🐛 417 | 🌐 JavaScript | 📅 2026-08-26 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,287 | 🐛 119 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,550 | 🐛 215 | 🌐 JavaScript | 📅 2026-08-24 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
* [diff2html](https://github.com/rtfpessoa/diff2html) ⭐ 3,397 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-08 - Git diff output parser and pretty HTML generator.
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 2,082 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-26 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,283 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
* [underscore](https://github.com/jashkenas/underscore) ⭐ 27,329 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript's utility \_ belt.
* [ramda](https://github.com/ramda/ramda) ⭐ 24,056 | 🐛 146 | 🌐 JavaScript | 📅 2026-07-26 - A practical functional library for JavaScript programmers.
...
* [rambda](https://github.com/selfrefactor/rambda) ⭐ 1,754 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-13 - Faster and smaller alternative to *Ramda*.
* [mout](https://github.com/mout/mout) ⭐ 1,285 | 🐛 21 | 🌐 JavaScript | 📅 2023-10-24 - Modular JavaScript Utilities.
* [fxts](https://github.com/marpple/FxTS) ⭐ 1,166 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-08 - Lazy evaluation and concurrency.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,701 | 🐛 180 | 🌐 TypeScript | 📅 2026-08-08 - A reactive programming library for JavaScript.
* [MobX](https://github.com/mobxjs/mobx) ⭐ 28,206 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-24 - TFRP library for simple, scalable state management.
* [Bacon](https://github.com/baconjs/bacon.js) ⭐ 6,456 | 🐛 86 | 🌐 TypeScript | 📅 2025-04-18 - FRP (functional reactive programming) library for JavaScript.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,040 | 🐛 128 | 🌐 TypeScript | 📅 2026-08-17 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [buckets](https://github.com/mauriciosantos/Buckets-JS) ⭐ 1,254 | 🐛 8 | 🌐 JavaScript | 📅 2020-12-21 - A complete, fully tested and documented data structure library written in JavaScript.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,665 | 🐛 1,303 | 🌐 JavaScript | 📅 2026-08-18 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 47,915 | 🐛 106 | 🌐 JavaScript | 📅 2026-08-23 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,645 | 🐛 999 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,445 | 🐛 180 | 🌐 JavaScript | 📅 2026-08-09 - Luxon is a library for working with dates and times in JavaScript.
...
* [tempo](https://github.com/formkit/tempo) ⭐ 2,589 | 🐛 13 | 🌐 TypeScript | 📅 2026-07-01 - Parsing, formatting, and timezones — Tempo is a small tree-shakable library for native Date objects.
...
* [query-string](https://github.com/sindresorhus/query-string) ⭐ 6,903 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-06 - Parse and stringify URL query strings.
...
* [Numeral-js](https://github.com/adamwdraper/Numeral-js) ⭐ 9,706 | 🐛 345 | 🌐 JavaScript | 📅 2026-02-15 - A JavaScript library for formatting and manipulating numbers.
...
* [Fraction.js](https://github.com/infusion/Fraction.js) ⭐ 690 | 🐛 5 | 🌐 JavaScript | 📅 2025-09-26 - A rational number library for JavaScript.
...
* [localForage](https://github.com/mozilla/localForage) ⭐ 25,808 | 🐛 250 | 🌐 JavaScript | 📅 2024-07-30 - Offline storage, improved. Wraps IndexedDB, WebSQL, or localStorage using a simple but powerful API.
* [js-cookie](https://github.com/js-cookie/js-cookie) ⭐ 22,591 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-10 - A simple, lightweight JavaScript API for handling browser cookies.
* [pouchdb](https://github.com/pouchdb/pouchdb) ⭐ 17,599 | 🐛 185 | 🌐 JavaScript | 📅 2026-08-25 - Javascript db inspired by Apache CouchDB to run well within the browser.
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,550 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-24 - Dexie.js is a wrapper library for indexedDB.
...
* [Hoodie](https://github.com/hoodiehq/hoodie) ⭐ 4,458 | 🐛 98 | 🌐 JavaScript | 📅 2024-07-27 - Offline First backend to work in browser without internet connectivity.
...
* [chroma.js](https://github.com/gka/chroma.js) ⭐ 10,574 | 🐛 76 | 🌐 JavaScript | 📅 2026-06-01 - JavaScript library for all kinds of color manipulations.
...
* [TinyColor](https://github.com/bgrins/TinyColor) ⭐ 5,245 | 🐛 106 | 🌐 JavaScript | 📅 2024-06-26 - Fast, small color manipulation and conversion for JavaScript.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,622 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-20 - internationalisation (i18n) with JavaScript the easy way.
...
* [async](https://github.com/caolan/async) ⭐ 28,136 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-07 - Async utilities for node and the browser.
* [Bluebird](https://github.com/petkaantonov/bluebird/) ⭐ 20,490 | 🐛 131 | 🌐 JavaScript | 📅 2024-11-07 - fully featured promise library with focus on innovative features and performance.
* [q](https://github.com/kriskowal/q) ⚠️ Archived - A tool for making and composing asynchronous promises in JavaScript.
* [when](https://github.com/cujojs/when) ⭐ 3,422 | 🐛 67 | 🌐 JavaScript | 📅 2022-04-10 - A solid, fast Promises/A+ and when() implementation, plus other async goodies.
...
* [page.js](https://github.com/visionmedia/page.js) ⭐ 7,678 | 🐛 126 | 🌐 JavaScript | 📅 2023-06-27 - Micro client-side router inspired by the Express router (\~1200 bytes).
...
* [speedy-router](https://github.com/anonrig/router) ⭐ 150 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-21 - The TanStack Router API rebuilt for faster navigations and SSR.

## Security

* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,337 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
* [js-xss](https://github.com/leizongmin/js-xss) ⭐ 5,313 | 🐛 69 | 🌐 HTML | 📅 2026-05-06 - Sanitize untrusted HTML (to prevent XSS) with a configuration specified by a Whitelist.
...
* [log](https://github.com/adamschwartz/log) ⭐ 3,008 | 🐛 9 | 🌐 HTML | 📅 2023-04-08 - Console.log with style.
* [loglevel](https://github.com/pimterry/loglevel) ⭐ 2,747 | 🐛 19 | 🌐 JavaScript | 📅 2025-03-20 - Minimal lightweight logging for JavaScript, adding reliable log level methods to wrap any available console.log methods.
...
* [axios](https://github.com/axios/axios) ⭐ 109,191 | 🐛 78 | 🌐 JavaScript | 📅 2026-08-26 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,207 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-26 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,472 | 🐛 215 | 🌐 TypeScript | 📅 2026-08-23 - React Hooks library for remote data fetching.
* [wretch](https://github.com/elbywan/wretch) ⭐ 5,177 | 🐛 10 | 🌐 TypeScript | 📅 2026-06-19 - A tiny wrapper built around fetch with an intuitive syntax.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,967 | 🐛 2 | 🌐 Vue | 📅 2026-08-26 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [tracking.js](https://github.com/eduardolundgren/tracking.js) ⭐ 9,465 | 🐛 227 | 🌐 JavaScript | 📅 2026-08-11 - A modern approach for Computer Vision on the web.
...
* [bowser](https://github.com/ded/bowser) ⭐ 5,750 | 🐛 95 | 🌐 JavaScript | 📅 2026-08-01 - a browser detector.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 890 | 🐛 167 | 🌐 Rust | 📅 2026-08-26 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [partytown](https://github.com/BuilderIO/partytown) ⭐ 13,765 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-25 - Relocate resource intensive third-party scripts off of the main thread and into a web worker.
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,785 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-11 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [worker-dom](https://github.com/ampproject/worker-dom) ⭐ 3,263 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-20 - An in-progress implementation of the DOM API intended to run within a Web Worker.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,985 | 🐛 91 | 🌐 JavaScript | 📅 2026-08-24 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,745 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
* [PrismJS](https://github.com/PrismJS/prism) ⭐ 13,038 | 🐛 485 | 🌐 JavaScript | 📅 2026-06-29 - Lightweight, robust, elegant syntax highlighting.
...
* [pace](https://github.com/HubSpot/pace) ⭐ 15,600 | 🐛 278 | 🌐 CSS | 📅 2024-02-26 - Automatically add a progress bar to your site.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,737 | 🐛 488 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
* [jquery-validation](https://github.com/jzaefferer/jquery-validation) ⭐ 10,316 | 🐛 41 | 🌐 JavaScript | 📅 2026-06-29 - jQuery Validation Plugin.
* [is.js](https://github.com/arasatasaygin/is.js) ⭐ 9,067 | 🐛 47 | 🌐 JavaScript | 📅 2022-01-11 - Check types, regexps, presence, time and more.
* [Parsley.js](https://github.com/guillaumepotier/Parsley.js) ⭐ 8,979 | 🐛 71 | 🌐 JavaScript | 📅 2026-05-26 - Validate your forms, frontend, without writing a single line of JavaScript.
...
* [keymaster](https://github.com/madrobby/keymaster) ⭐ 6,510 | 🐛 82 | 🌐 JavaScript | 📅 2024-07-29 - A simple micro-library for defining and dispatching keyboard shortcuts.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,642 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
* [intro.js](https://github.com/usablica/intro.js) ⭐ 23,455 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-07 - A better way for new feature introduction and step-by-step users guide for your website and project.
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,795 | 🐛 34 | 🌐 JavaScript | 📅 2026-08-25 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,674 | 🐛 102 | 🌐 TypeScript | 📅 2026-08-26 - Open-source notification infrastructure for products.
* [toastr](https://github.com/CodeSeven/toastr) ⭐ 12,103 | 🐛 154 | 🌐 JavaScript | 📅 2023-02-27 - Simple JavaScript toast notifications.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,199 | 🐛 909 | 🌐 JavaScript | 📅 2026-08-24 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,895 | 🐛 238 | 🌐 TypeScript | 📅 2026-08-26 - Mobile touch slider and framework with hardware accelerated transitions.
* [impress.js](https://github.com/impress/impress.js) ⭐ 38,167 | 🐛 59 | 🌐 JavaScript | 📅 2026-07-23 - It's a presentation framework based on the power of CSS3 transforms and transitions in modern browsers and inspired by the idea behind prezi.com.
* [slick](https://github.com/kenwheeler/slick) ⭐ 28,555 | 🐛 1,317 | 🌐 JavaScript | 📅 2026-08-01 - The last carousel you'll ever need.
* [PhotoSwipe](https://github.com/dimsemenov/PhotoSwipe) ⭐ 25,242 | 🐛 170 | 🌐 JavaScript | 📅 2025-12-04 - JavaScript image gallery for mobile and desktop, modular, framework independent.
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,395 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-21 - An extensible low level carousel for the web, written in TypeScript.
...
* [Ion.RangeSlider](https://github.com/IonDen/ion.rangeSlider) ⭐ 2,544 | 🐛 94 | 🌐 JavaScript | 📅 2026-08-25 - Powerful and easily customizable range slider with many options and skin support.
...
* [typeahead.js](https://github.com/twitter/typeahead.js) ⭐ 16,441 | 🐛 506 | 🌐 JavaScript | 📅 2023-04-14 - A fast and fully-featured autocomplete library.
...
* [At.js](https://github.com/ichord/At.js) ⭐ 5,241 | 🐛 156 | 🌐 CoffeeScript | 📅 2021-11-18 - Add GitHub like mentions autocomplete to your application.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,620 | 🐛 1,130 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
* [tui.calendar](https://github.com/nhn/tui.calendar) ⭐ 12,702 | 🐛 208 | 🌐 TypeScript | 📅 2024-06-24 - A JavaScript schedule calendar that is full featured. Now your service just got the customizable calendar.
...
* [Date Range Picker](https://github.com/dangrossman/daterangepicker) ⭐ 10,977 | 🐛 120 | 🌐 JavaScript | 📅 2024-08-09 - creates a dropdown menu from which a user can select a range of dates.
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,539 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [select2](https://github.com/select2/select2) ⭐ 25,909 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-24 - a jQuery based replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results.
* [chosen](https://github.com/harvesthq/chosen) ⭐ 21,945 | 🐛 309 | 🌐 HTML | 📅 2024-12-02 - A library for making long, unwieldy select boxes more friendly.
...
* [dropzone](https://github.com/enyo/dropzone) ⭐ 18,377 | 🐛 149 | 🌐 JavaScript | 📅 2026-08-24 - Dropzone is an easy to use drag'n'drop library. It supports image previews and shows nice progress bars.
* [filepond](https://github.com/pqina/filepond) ⭐ 16,389 | 🐛 140 | 🌐 JavaScript | 📅 2026-07-13 - A JavaScript library that can upload anything you throw at it, optimizes images for faster uploads, and offers a great, accessible, silky smooth user experience.
...
* [plupload](https://github.com/moxiecode/plupload) ⭐ 5,617 | 🐛 207 | 🌐 JavaScript | 📅 2024-07-18 - A JavaScript API for dealing with file uploads it supports features like multiple file selection, file type filtering, request chunking, client side image scaling and it uses different runtimes to achieve this such as HTML 5, Silverlight and Flash.
...
* [analytics](https://github.com/davidwells/analytics) ⭐ 2,662 | 🐛 112 | 🌐 JavaScript | 📅 2026-06-27 - A lightweight, extendable analytics library designed to work with any third-party analytics provider to track page views, custom events, & identify users.
...
* [hint.css](https://github.com/chinchang/hint.css) ⭐ 8,433 | 🐛 54 | 🌐 CSS | 📅 2024-10-17 - A tooltip library in CSS for your lovely websites.
...
* [SweetAlert](https://github.com/t4t5/sweetalert) ⭐ 22,260 | 🐛 199 | 🌐 TypeScript | 📅 2023-04-15 - An awesome replacement for JavaScript's alert.
* [SweetAlert2](https://github.com/sweetalert2/sweetalert2) ⭐ 18,103 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-20 - An awesome replacement for JavaScript's alert.
* [Magnific-Popup](https://github.com/dimsemenov/Magnific-Popup) ⭐ 11,314 | 🐛 678 | 🌐 JavaScript | 📅 2024-06-08 - Light and responsive lightbox script with focus on performance.
...
* [lightGallery](https://github.com/sachinchoolur/lightGallery) ⭐ 7,049 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-07 - A customizable, modular, responsive, lightbox gallery plugin for jQuery.
...
* [fullPage](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,402 | 🐛 129 | 🌐 JavaScript | 📅 2026-03-17 - A simple and easy to use plugin to create fullscreen scrolling websites (also known as single page websites).
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,848 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-30 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [rellax](https://github.com/dixonandmoe/rellax) ⭐ 7,134 | 🐛 76 | 🌐 HTML | 📅 2024-08-24 - Buttery smooth, super lightweight, vanilla javascript parallax library.
...
* [Slideout](https://github.com/mango/slideout) ⭐ 7,873 | 🐛 72 | 🌐 JavaScript | 📅 2020-09-20 - A responsive touch slideout navigation menu for mobile web apps.
...
* [flexboxgrid](https://github.com/kristoferjoseph/flexboxgrid/) ⭐ 9,306 | 🐛 62 | 🌐 HTML | 📅 2020-10-01 - Grid based on CSS3 flexbox.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,602 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-20 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
...
* [Cerberus](https://github.com/TedGoas/Cerberus) ⭐ 5,129 | 🐛 13 | 🌐 HTML | 📅 2024-07-16 - A few simple, but solid patterns for responsive HTML emails. Even in Outlook.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,523 | 🐛 564 | 🌐 JavaScript | 📅 2026-08-24 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,605 | 🐛 1,655 | 🌐 JavaScript | 📅 2026-08-26 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,493 | 🐛 166 | 🌐 C | 📅 2026-08-20 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,868 | 🐛 668 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,900 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-25 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
* [mediaelement](https://github.com/johndyer/mediaelement) ⭐ 8,300 | 🐛 228 | 🌐 JavaScript | 📅 2026-05-12 - HTML5 <audio> or <video> player with Flash and Silverlight shims that mimics the HTML5 MediaElement API, enabling a consistent UI in all browsers. <http://www.mediaelementjs.com/>
* [clappr](https://github.com/clappr/clappr) ⭐ 7,495 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-25 - An extensible media player for the web <http://clappr.io>
...
* [ractive-player](https://github.com/ysulyma/ractive-player) ⭐ 814 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-19 - A library for making interactive videos in React.js.
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,753 | 🐛 79 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 28,012 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,201 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [barbajs](https://github.com/barbajs/barba) ⭐ 12,974 | 🐛 15 | 🌐 TypeScript | 📅 2024-12-02 - It helps you create fluid and smooth transitions between your website's pages.
* [Effeckt.css](https://github.com/h5bp/Effeckt.css) ⚠️ Archived - A Performant Transitions and Animations Library.
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,965 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A new and improved version of particles.js with bug fixes and many new features.
...
* [smoothState.js](https://github.com/miguel-perez/smoothState.js) ⭐ 4,368 | 🐛 127 | 🌐 CSS | 📅 2021-11-23 - Unobtrusive page transitions with jQuery.
* [textillate](https://github.com/jschr/textillate) ⭐ 3,656 | 🐛 68 | 🌐 JavaScript | 📅 2021-08-04 - A simple plugin for CSS3 text animations.
...
* [pica](https://github.com/nodeca/pica) ⭐ 4,144 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-15 - High quality image resize (with fast Lanczos filter, implemented in pure JS).
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,986 | 🐛 773 | 🌐 TypeScript | 📅 2026-08-25 - Turn ES6+ code into vanilla ES5 with no runtime.
* [es6features](https://github.com/lukehoban/es6features) ⭐ 29,032 | 🐛 38 | 📅 2023-01-27 - Overview of ECMAScript 6 features.
* [es6-cheatsheet](https://github.com/DrkSephy/es6-cheatsheet) ⭐ 13,324 | 🐛 7 | 🌐 JavaScript | 📅 2022-10-08 - ES2015 \[ES6] cheatsheet containing tips, tricks, best practices and code snippets.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,933 | 🐛 3,739 | 🌐 JavaScript | 📅 2026-08-26 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,092 | 🐛 393 | 🌐 TypeScript | 📅 2026-08-26 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 62,069 | 🐛 108 | 🌐 TypeScript | 📅 2026-08-26 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,802 | 🐛 544 | 🌐 TypeScript | 📅 2026-08-26 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 425 | 🌐 JavaScript | 📅 2026-08-21 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,469 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,276 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-24 - Static site generator for Deno.

## SDK

* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,143 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-26 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,493 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-26 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,782 | 🐛 38 | 🌐 JavaScript | 📅 2026-06-28 - It is a Next-Generation full text search library for Browser and Node.js.
* [lunr](https://github.com/olivernn/lunr.js) ⭐ 9,199 | 🐛 130 | 🌐 JavaScript | 📅 2024-07-31 - Library for use in the browser and It indexes JSON documents and provides a simple search interface for retrieving documents that best match text queries.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,559 | 🐛 2,570 | 🌐 TypeScript | 📅 2026-08-26 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,632 | 🐛 610 | 🌐 TypeScript | 📅 2026-08-26 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,593 | 🐛 1,983 | 🌐 TypeScript | 📅 2026-08-26 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,377 | 🐛 1,078 | 🌐 TypeScript | 📅 2026-08-26 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,473 | 🐛 171 | 🌐 JavaScript | 📅 2026-08-25 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,342 | 🐛 741 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,169 | 🐛 168 | 🌐 TypeScript | 📅 2026-08-26 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,184 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-26 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 63,206 | 🐛 199 | 🌐 TypeScript | 📅 2026-07-24 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,562 | 🐛 401 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,351 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,080 | 🐛 421 | 🌐 TypeScript | 📅 2026-08-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,045 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-26 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,854 | 🐛 490 | 🌐 TypeScript | 📅 2026-08-26 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [enum-plus](https://github.com/shijistar/enum-plus) ⭐ 204 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-24 - A drop-in enhancement for native TypeScript enums, adding display text, internationalization and full type safety.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,730 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
* [Clean Code JavaScript](https://github.com/ryanmcdermott/clean-code-javascript) ⭐ 94,766 | 🐛 124 | 🌐 JavaScript | 📅 2024-07-29 - Clean Code concepts adapted for JavaScript.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 500,140 | 🐛 105 | 📅 2026-08-21
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 74,402 | 🐛 82 | 📅 2026-08-20
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,438 | 🐛 22 | 📅 2026-03-23
* [davidsonfellipe/awesome-wpo](https://github.com/davidsonfellipe/awesome-wpo) ⭐ 9,052 | 🐛 20 | 📅 2026-07-28
...
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,649 | 🐛 91 | 📅 2025-07-20
