...
* [Bit](https://github.com/teambit/bit) ⭐ 18,455 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-15 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,980 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-15 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,024 | 🐛 601 | 🌐 JavaScript | 📅 2026-08-12 - Blazing fast, zero configuration web application bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,320 | 🐛 348 | 🌐 JavaScript | 📅 2026-08-14 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,463 | 🐛 188 | 🌐 TypeScript | 📅 2026-08-15 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,674 | 🐛 250 | 🌐 TypeScript | 📅 2026-08-12 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,468 | 🐛 184 | 🌐 TypeScript | 📅 2026-08-15 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,904 | 🐛 256 | 🌐 JavaScript | 📅 2026-08-15 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,459 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-14 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,542 | 🐛 144 | 🌐 TypeScript | 📅 2026-08-15 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,817 | 🐛 353 | 🌐 TypeScript | 📅 2026-08-15 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,201 | 🐛 1,427 | 🌐 JavaScript | 📅 2026-08-15 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,272 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,458 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-13 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,986 | 🐛 433 | 🌐 JavaScript | 📅 2026-08-11 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,335 | 🐛 9 | 🌐 Rust | 📅 2026-08-15 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [react-native](https://github.com/facebook/react-native) ⭐ 126,353 | 🐛 1,052 | 🌐 C++ | 📅 2026-08-15 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 101,007 | 🐛 1,169 | 🌐 TypeScript | 📅 2026-08-14 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,954 | 🐛 1,123 | 🌐 JavaScript | 📅 2026-08-14 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
...
* [backbone](https://github.com/jashkenas/backbone) ⭐ 28,102 | 🐛 64 | 🌐 JavaScript | 📅 2026-07-29 - Give your JS App some Backbone with Models, Views, Collections, and Events.
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,131 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,605 | 🐛 832 | 🌐 TypeScript | 📅 2026-08-15 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,569 | 🐛 259 | 🌐 TypeScript | 📅 2026-08-15 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 19,084 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-13 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [feathers](https://github.com/feathersjs/feathers) ⭐ 15,262 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-14 - A minimalist real-time JavaScript framework for tomorrow's apps.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,519 | 🐛 345 | 🌐 JavaScript | 📅 2026-08-15 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,165 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 8,105 | 🐛 146 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 72,925 | 🐛 540 | 🌐 TypeScript | 📅 2026-08-14 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,777 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-15 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,939 | 🐛 142 | 🌐 TypeScript | 📅 2026-08-11 - powerful CMS and web app framework.
...
* [Pug](https://github.com/pugjs/pug) ⭐ 21,854 | 🐛 333 | 🌐 JavaScript | 📅 2026-03-13 - Robust, elegant, feature rich template engine for nodejs. (formerly known as Jade)
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,523 | 🐛 372 | 🌐 JavaScript | 📅 2026-08-15 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,458 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,646 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,078 | 🐛 1,560 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,385 | 🐛 466 | 🌐 TypeScript | 📅 2026-08-08 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,931 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-14 - A framework for building 3D games with HTML 5 and WebGL.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,248 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,135 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-14 - A JavaScript library dedicated to graph drawing.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,162 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-14 - A fully featured graph theory library.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,304 | 🐛 22 | 🌐 TypeScript | 📅 2026-06-01 - A next-generation declarative infographic visualization engine.
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,085 | 🐛 74 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
...
* [G2Plot](https://github.com/antvis/G2Plot) ⭐ 2,654 | 🐛 461 | 🌐 TypeScript | 📅 2026-07-31 - An interactive and responsive charting library. Based on the grammar of graphics.
...
* [TimelineJS v3](https://github.com/NUKnightLab/TimelineJS3) ⭐ 3,208 | 🐛 231 | 🌐 JavaScript | 📅 2026-08-11 - A Storytelling Timeline built in JavaScript.
...
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,434 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-15 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [quill](https://github.com/quilljs/quill) ⭐ 47,297 | 🐛 658 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
...
* [trix](https://github.com/basecamp/trix) ⭐ 19,994 | 🐛 184 | 🌐 JavaScript | 📅 2026-08-11 - A rich text editor for everyday writing. By Basecamp.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,271 | 🐛 418 | 🌐 TypeScript | 📅 2026-08-15 - The JavaScript Rich Text editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,734 | 🐛 419 | 🌐 JavaScript | 📅 2026-08-15 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,275 | 🐛 119 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,542 | 🐛 223 | 🌐 JavaScript | 📅 2026-08-13 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
...
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 1,982 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-13 - Browser-native components for previewing files without server-side conversion.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,708 | 🐛 179 | 🌐 TypeScript | 📅 2026-08-08 - A reactive programming library for JavaScript.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,041 | 🐛 130 | 🌐 TypeScript | 📅 2026-08-14 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,664 | 🐛 1,297 | 🌐 JavaScript | 📅 2026-08-15 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 47,917 | 🐛 206 | 🌐 JavaScript | 📅 2026-08-15 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,623 | 🐛 990 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,440 | 🐛 178 | 🌐 JavaScript | 📅 2026-08-09 - Luxon is a library for working with dates and times in JavaScript.
...
* [tempo](https://github.com/formkit/tempo) ⭐ 2,589 | 🐛 12 | 🌐 TypeScript | 📅 2026-07-01 - Parsing, formatting, and timezones — Tempo is a small tree-shakable library for native Date objects.
...
* [js-cookie](https://github.com/js-cookie/js-cookie) ⭐ 22,601 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-10 - A simple, lightweight JavaScript API for handling browser cookies.
...
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,537 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-14 - Dexie.js is a wrapper library for indexedDB.
...
* [Hoodie](https://github.com/hoodiehq/hoodie) ⭐ 4,460 | 🐛 97 | 🌐 JavaScript | 📅 2024-07-27 - Offline First backend to work in browser without internet connectivity.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,306 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,216 | 🐛 64 | 🌐 JavaScript | 📅 2026-08-13 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,140 | 🐛 237 | 🌐 TypeScript | 📅 2026-08-13 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,456 | 🐛 212 | 🌐 TypeScript | 📅 2026-08-13 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,888 | 🐛 0 | 🌐 Vue | 📅 2026-08-14 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [os.js](https://github.com/os-js/OS.js) ⭐ 7,076 | 🐛 20 | 🌐 JavaScript | 📅 2022-12-12 - An open-source web desktop platform with a window manager, application APIs, GUI toolkit, filesystem abstractions and much more.

## Benchmark

* [benchmark.js](https://github.com/bestiejs/benchmark.js) ⚠️ Archived - A benchmarking library. As used on jsPerf.com.
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 159 | 🌐 Rust | 📅 2026-08-15 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,979 | 🐛 92 | 🌐 JavaScript | 📅 2026-08-14 - JavaScript syntax highlighter.
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,707 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,591 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
* [intro.js](https://github.com/usablica/intro.js) ⭐ 23,478 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-07 - A better way for new feature introduction and step-by-step users guide for your website and project.
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,780 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-14 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,562 | 🐛 106 | 🌐 TypeScript | 📅 2026-08-14 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,129 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,878 | 🐛 253 | 🌐 TypeScript | 📅 2026-08-06 - Mobile touch slider and framework with hardware accelerated transitions.
* [impress.js](https://github.com/impress/impress.js) ⭐ 38,193 | 🐛 59 | 🌐 JavaScript | 📅 2026-07-23 - It's a presentation framework based on the power of CSS3 transforms and transitions in modern browsers and inspired by the idea behind prezi.com.
...
* [typeahead.js](https://github.com/twitter/typeahead.js) ⭐ 16,443 | 🐛 507 | 🌐 JavaScript | 📅 2023-04-14 - A fast and fully-featured autocomplete library.
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,526 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-14 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [chosen](https://github.com/harvesthq/chosen) ⭐ 21,961 | 🐛 309 | 🌐 HTML | 📅 2024-12-02 - A library for making long, unwieldy select boxes more friendly.
...
* [SweetAlert2](https://github.com/sweetalert2/sweetalert2) ⭐ 18,099 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-20 - An awesome replacement for JavaScript's alert.
...
* [fullPage](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,412 | 🐛 127 | 🌐 JavaScript | 📅 2026-03-17 - A simple and easy to use plugin to create fullscreen scrolling websites (also known as single page websites).
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,593 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-10 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
* [Wasp](https://github.com/wasp-lang/wasp) ⭐ 18,687 | 🐛 842 | 🌐 TypeScript | 📅 2026-08-15 Wasp is a declarative domain-specific language for developing, building, and deploying modern Javascript full-stack web apps with less code.
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,571 | 🐛 1,639 | 🌐 JavaScript | 📅 2026-08-14 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,464 | 🐛 165 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,852 | 🐛 663 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,876 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-15 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [clappr](https://github.com/clappr/clappr) ⭐ 7,492 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 - An extensible media player for the web <http://clappr.io>
...
* [animate.css](https://github.com/daneden/animate.css) ⭐ 82,744 | 🐛 79 | 🌐 CSS | 📅 2024-07-29 - A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,722 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,202 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [barbajs](https://github.com/barbajs/barba) ⭐ 12,965 | 🐛 15 | 🌐 TypeScript | 📅 2024-12-02 - It helps you create fluid and smooth transitions between your website's pages.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,983 | 🐛 770 | 🌐 TypeScript | 📅 2026-08-14 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,779 | 🐛 4,231 | 🌐 JavaScript | 📅 2026-08-15 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 65,925 | 🐛 427 | 🌐 TypeScript | 📅 2026-08-13 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 61,795 | 🐛 117 | 🌐 TypeScript | 📅 2026-08-15 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,757 | 🐛 536 | 🌐 TypeScript | 📅 2026-08-15 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 420 | 🌐 JavaScript | 📅 2026-08-15 - React-based static site generator.
...
* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,118 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-15 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,483 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-15 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,628 | 🐛 614 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,486 | 🐛 1,951 | 🌐 TypeScript | 📅 2026-08-12 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,376 | 🐛 1,075 | 🌐 TypeScript | 📅 2026-08-14 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,472 | 🐛 173 | 🌐 JavaScript | 📅 2026-08-14 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,343 | 🐛 735 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,132 | 🐛 169 | 🌐 TypeScript | 📅 2026-08-14 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,170 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-15 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,463 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,269 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,039 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,025 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,838 | 🐛 502 | 🌐 TypeScript | 📅 2026-08-14 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,664 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 496,030 | 🐛 100 | 📅 2026-06-30
...
* [davidsonfellipe/awesome-wpo](https://github.com/davidsonfellipe/awesome-wpo) ⭐ 9,025 | 🐛 15 | 📅 2026-07-28
