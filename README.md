...
* [jspm](https://github.com/jspm/jspm-cli) ⭐ 3,871 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-17 - Frictionless browser package management.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,456 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-17 - Create, find and reuse components (React, Angular, Node etc.) across applications.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,968 | 🐛 145 | 🌐 JavaScript | 📅 2026-08-17 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,022 | 🐛 600 | 🌐 JavaScript | 📅 2026-08-17 - Blazing fast, zero configuration web application bundler.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,320 | 🐛 350 | 🌐 JavaScript | 📅 2026-08-14 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 43,476 | 🐛 163 | 🌐 TypeScript | 📅 2026-08-17 - TypeScript-first schema validation with built-in static type inference.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,468 | 🐛 183 | 🌐 TypeScript | 📅 2026-08-17 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,903 | 🐛 257 | 🌐 JavaScript | 📅 2026-08-17 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,833 | 🐛 72 | 🌐 JavaScript | 📅 2026-06-17 - 🚀 Futuristic JavaScript test runner
* [jasmine](https://github.com/jasmine/jasmine) ⭐ 15,824 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-16 - DOM-less simple JavaScript testing framework.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,908 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-12 - Automated browser testing for the modern web development stack.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 95,461 | 🐛 262 | 🌐 TypeScript | 📅 2026-08-17 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,630 | 🐛 159 | 🌐 TypeScript | 📅 2026-08-17 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
* [phantomjs](https://github.com/ariya/phantomjs) ⚠️ Archived - Scriptable Headless WebKit.
* [nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,959 | 🐛 333 | 🌐 JavaScript | 📅 2026-05-25 - UI automated testing framework based on node.js and selenium webdriver.
* [karma](https://github.com/karma-runner/karma) ⭐ 11,958 | 🐛 402 | 🌐 JavaScript | 📅 2026-06-10 - Spectacular Test Runner for JavaScript.
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,817 | 🐛 352 | 🌐 TypeScript | 📅 2026-08-17 - Next-gen WebDriver test automation framework for Node.js.
...
* [intern](https://github.com/theintern/intern) ⭐ 4,345 | 🐛 142 | 🌐 TypeScript | 📅 2023-03-14 - A next-generation code testing stack for JavaScript.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 52,204 | 🐛 1,423 | 🌐 JavaScript | 📅 2026-08-17 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 35,276 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 27,456 | 🐛 128 | 🌐 JavaScript | 📅 2026-08-17 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,987 | 🐛 435 | 🌐 JavaScript | 📅 2026-08-11 - Npm cli and library to format JS code.
* [jscs](https://github.com/jscs-dev/node-jscs) ⚠️ Archived - JavaScript Code Style checker.
* [fallow](https://github.com/fallow-rs/fallow) ⭐ 4,344 | 🐛 2 | 🌐 Rust | 📅 2026-08-17 - Finds dead code, duplication, circular dependencies, and complexity hotspots in JavaScript and TypeScript projects.
...
* [vue](https://github.com/vuejs/vue) ⭐ 210,164 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 126,351 | 🐛 1,051 | 🌐 C++ | 📅 2026-08-17 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 100,982 | 🐛 1,176 | 🌐 TypeScript | 📅 2026-08-14 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 87,946 | 🐛 1,135 | 🌐 JavaScript | 📅 2026-08-16 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,812 | 🐛 411 | 🌐 JavaScript | 📅 2026-08-17 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,822 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-17 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,862 | 🐛 5 | 🌐 HTML | 📅 2026-08-17 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,135 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-11 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,604 | 🐛 834 | 🌐 TypeScript | 📅 2026-08-17 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,569 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-17 - A JavaScript framework for creating ambitious web applications.
...
* [inferno](https://github.com/infernojs/inferno) ⭐ 16,452 | 🐛 40 | 🌐 JavaScript | 📅 2026-06-12 - 🔥 An extremely fast, React-like JavaScript library for building modern user interfaces.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,520 | 🐛 345 | 🌐 JavaScript | 📅 2026-08-17 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 12,215 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24 - A modular framework for visual programming allows to create node based editor in browser.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 8,109 | 🐛 146 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 72,949 | 🐛 547 | 🌐 TypeScript | 📅 2026-08-17 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 54,792 | 🐛 133 | 🌐 JavaScript | 📅 2026-08-17 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,944 | 🐛 147 | 🌐 TypeScript | 📅 2026-08-17 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,599 | 🐛 137 | 🌐 JavaScript | 📅 2026-08-17 - CMS with content editing and essential services.
...
* [mustache.js](https://github.com/janl/mustache.js) ⭐ 16,721 | 🐛 120 | 🌐 JavaScript | 📅 2024-06-14 - Minimal templating with {{mustaches}} in JavaScript.
* [marko](https://github.com/marko-js/marko) ⭐ 14,406 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-17 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 114,571 | 🐛 369 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript 3D library.
* [d3](https://github.com/d3/d3) ⭐ 113,480 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 - A JavaScript visualization library for HTML and SVG.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,644 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 67,088 | 🐛 1,558 | 🌐 TypeScript | 📅 2026-08-04 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 31,388 | 🐛 467 | 🌐 TypeScript | 📅 2026-08-08 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
* [recharts](https://github.com/recharts/recharts) ⭐ 27,505 | 🐛 439 | 🌐 TypeScript | 📅 2026-08-17 - Redefined chart library built with React and D3.
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,938 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-14 - A framework for building 3D games with HTML 5 and WebGL.
* [Frappe Charts](https://github.com/frappe/charts) ⭐ 15,085 | 🐛 145 | 🌐 JavaScript | 📅 2025-07-02 - GitHub-inspired simple and modern SVG charts for the web with zero dependencies.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,255 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - A graph visualization engine.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,139 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-17 - A JavaScript library dedicated to graph drawing.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 11,168 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-14 - A fully featured graph theory library.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 6,352 | 🐛 22 | 🌐 TypeScript | 📅 2026-06-01 - A next-generation declarative infographic visualization engine.
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 6,087 | 🐛 74 | 🌐 JavaScript | 📅 2026-06-18 - A simple, interactive, modern gantt chart library for the web.
* [flot](https://github.com/flot/flot) ⭐ 5,909 | 🐛 630 | 🌐 JavaScript | 📅 2023-11-08 - Attractive JavaScript charts for jQuery.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,352 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-14 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [vizzu](https://github.com/vizzuhq/vizzu-lib) ⭐ 2,018 | 🐛 3 | 🌐 JavaScript | 📅 2026-04-20 - Library for animated data visualizations and data stories.
...
* [TimelineJS v3](https://github.com/NUKnightLab/TimelineJS3) ⭐ 3,209 | 🐛 231 | 🌐 JavaScript | 📅 2026-08-11 - A Storytelling Timeline built in JavaScript.

## Spreadsheet

* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 22,018 | 🐛 137 | 🌐 JavaScript | 📅 2026-08-17 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,435 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-17 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [quill](https://github.com/quilljs/quill) ⭐ 47,302 | 🐛 659 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
...
* [trix](https://github.com/basecamp/trix) ⭐ 19,997 | 🐛 184 | 🌐 JavaScript | 📅 2026-08-11 - A rich text editor for everyday writing. By Basecamp.
...
* [Squire](https://github.com/neilj/Squire) ⭐ 4,906 | 🐛 57 | 🌐 TypeScript | 📅 2026-06-09 - HTML5 rich text editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 53,741 | 🐛 417 | 🌐 JavaScript | 📅 2026-08-16 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,274 | 🐛 120 | 🌐 JavaScript | 📅 2026-08-09 - JavaScript PDF generation.
...
* [diff2html](https://github.com/rtfpessoa/diff2html) ⭐ 3,394 | 🐛 34 | 🌐 TypeScript | 📅 2026-05-08 - Git diff output parser and pretty HTML generator.
* [File Viewer](https://github.com/flyfish-dev/file-viewer) ⭐ 1,996 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-17 - Browser-native components for previewing files without server-side conversion.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,293 | 🐛 106 | 🌐 JavaScript | 📅 2026-07-03 - A utility library delivering consistency, customization, performance, & extras.
* [underscore](https://github.com/jashkenas/underscore) ⭐ 27,334 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript's utility \_ belt.
* [ramda](https://github.com/ramda/ramda) ⭐ 24,058 | 🐛 146 | 🌐 JavaScript | 📅 2026-07-26 - A practical functional library for JavaScript programmers.
...
* [MobX](https://github.com/mobxjs/mobx) ⭐ 28,201 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-17 - TFRP library for simple, scalable state management.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,665 | 🐛 1,298 | 🌐 JavaScript | 📅 2026-08-17 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 47,918 | 🐛 207 | 🌐 JavaScript | 📅 2026-08-16 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,624 | 🐛 994 | 🌐 TypeScript | 📅 2026-08-10 - Modern JavaScript date utility library.
...
* [moment-timezone](https://github.com/moment/moment-timezone) ⭐ 3,878 | 🐛 75 | 🌐 JavaScript | 📅 2026-07-19 - Timezone support for moment.js.
...
* [js-cookie](https://github.com/js-cookie/js-cookie) ⭐ 22,596 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-10 - A simple, lightweight JavaScript API for handling browser cookies.
...
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,538 | 🐛 594 | 🌐 TypeScript | 📅 2026-08-17 - Dexie.js is a wrapper library for indexedDB.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,616 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-09 - internationalisation (i18n) with JavaScript the easy way.
...
* [async](https://github.com/caolan/async) ⭐ 28,140 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-07 - Async utilities for node and the browser.
* [Bluebird](https://github.com/petkaantonov/bluebird/) ⭐ 20,493 | 🐛 131 | 🌐 JavaScript | 📅 2024-11-07 - fully featured promise library with focus on innovative features and performance.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,309 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-16 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [axios](https://github.com/axios/axios) ⭐ 109,204 | 🐛 67 | 🌐 JavaScript | 📅 2026-08-13 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 50,149 | 🐛 219 | 🌐 TypeScript | 📅 2026-08-17 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,457 | 🐛 215 | 🌐 TypeScript | 📅 2026-08-13 - React Hooks library for remote data fetching.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,895 | 🐛 1 | 🌐 Vue | 📅 2026-08-17 - Streaming Markdown renderer for AI chat interfaces across Vue, React, Svelte and Angular.
...
* [ConvNetJS](https://github.com/karpathy/convnetjs) ⭐ 11,196 | 🐛 76 | 🌐 JavaScript | 📅 2023-01-07 - Deep Learning in JavaScript. Train Convolutional Neural Networks (or ordinary ones) in your browser.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 887 | 🐛 163 | 🌐 Rust | 📅 2026-08-17 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [partytown](https://github.com/BuilderIO/partytown) ⭐ 13,753 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-03 - Relocate resource intensive third-party scripts off of the main thread and into a web worker.
...
* [shiki](https://github.com/shikijs/shiki) ⭐ 13,711 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-10 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,739 | 🐛 474 | 🌐 JavaScript | 📅 2026-08-15 - String validation and sanitization.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 26,596 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,779 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-17 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 39,596 | 🐛 108 | 🌐 TypeScript | 📅 2026-08-17 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 72,138 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - A framework for easily creating beautiful presentations using HTML.
...
* [typeahead.js](https://github.com/twitter/typeahead.js) ⭐ 16,442 | 🐛 507 | 🌐 JavaScript | 📅 2023-04-14 - A fast and fully-featured autocomplete library.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,608 | 🐛 1,129 | 🌐 TypeScript | 📅 2026-07-24 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [select2](https://github.com/select2/select2) ⭐ 25,912 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-15 - a jQuery based replacement for select boxes. It supports searching, remote data sets, and infinite scrolling of results.
...
* [fullPage](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,411 | 🐛 127 | 🌐 JavaScript | 📅 2026-03-17 - A simple and easy to use plugin to create fullscreen scrolling websites (also known as single page websites).
...
* [Slideout](https://github.com/mango/slideout) ⭐ 7,875 | 🐛 72 | 🌐 JavaScript | 📅 2020-09-20 - A responsive touch slideout navigation menu for mobile web apps.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,595 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-10 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,484 | 🐛 560 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,574 | 🐛 1,639 | 🌐 JavaScript | 📅 2026-08-15 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 6,467 | 🐛 166 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,863 | 🐛 664 | 🌐 JavaScript | 📅 2026-08-03 - Video.js - open source HTML5 & Flash video player.
* [flv.js](https://github.com/bilibili/flv.js) ⭐ 23,196 | 🐛 449 | 🌐 JavaScript | 📅 2024-07-07 - An HTML5 Flash Video (FLV) Player written in pure JavaScript without Flash.
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,875 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-17 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 27,784 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - High-performance HTML5 animations that work in all major browsers.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,954 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A new and improved version of particles.js with bug fixes and many new features.
...
* [pica](https://github.com/nodeca/pica) ⭐ 4,140 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-15 - High quality image resize (with fast Lanczos filter, implemented in pure JS).
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,985 | 🐛 770 | 🌐 TypeScript | 📅 2026-08-16 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 141,796 | 🐛 4,173 | 🌐 JavaScript | 📅 2026-08-17 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 65,942 | 🐛 430 | 🌐 TypeScript | 📅 2026-08-13 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 61,826 | 🐛 129 | 🌐 TypeScript | 📅 2026-08-17 - The web framework for content-driven websites.
* [Nuxt](https://github.com/nuxt/nuxt) ⭐ 60,762 | 🐛 542 | 🌐 TypeScript | 📅 2026-08-17 - The Intuitive Vue Framework.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,944 | 🐛 420 | 🌐 JavaScript | 📅 2026-08-15 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,472 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,274 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-10 - Static site generator for Deno.

## SDK

* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 11,122 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-17 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,483 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-17 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,576 | 🐛 2,537 | 🌐 TypeScript | 📅 2026-08-17 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,632 | 🐛 615 | 🌐 TypeScript | 📅 2026-08-13 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,504 | 🐛 1,955 | 🌐 TypeScript | 📅 2026-08-17 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,375 | 🐛 1,074 | 🌐 TypeScript | 📅 2026-08-16 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,473 | 🐛 173 | 🌐 JavaScript | 📅 2026-08-14 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,342 | 🐛 735 | 🌐 JavaScript | 📅 2026-06-26 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 14,133 | 🐛 170 | 🌐 TypeScript | 📅 2026-08-17 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,171 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-17 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,497 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 28,283 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-09 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,046 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [ky](https://github.com/sindresorhus/ky) ⭐ 17,028 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-06 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,840 | 🐛 490 | 🌐 TypeScript | 📅 2026-08-17 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [enum-plus](https://github.com/shijistar/enum-plus) ⭐ 202 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - A drop-in enhancement for native TypeScript enums, adding display text, internationalization and full type safety.
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,686 | 🐛 2 | 📅 2026-02-15 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 496,863 | 🐛 100 | 📅 2026-06-30
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 11,423 | 🐛 19 | 📅 2026-03-23
